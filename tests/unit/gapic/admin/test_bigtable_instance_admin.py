...
from google.cloud.bigtable.admin.services.bigtable_instance_admin import transports
...
def test_bigtable_instance_admin_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.bigtable.admin.services.bigtable_instance_admin.transports.BigtableInstanceAdminGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_bigtable_instance_admin_base_transport():
    ...
    with mock.patch(
        "google.cloud.bigtable.admin.services.bigtable_instance_admin.transports.BigtableInstanceAdminTransport.__init__"
    ) as Transport:
...
def test_bigtable_instance_admin_base_transport_with_credentials_file():
    ...
    with mock.patch.object(
        ...
        "google.cloud.bigtable.admin.services.bigtable_instance_admin.transports.BigtableInstanceAdminTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None
