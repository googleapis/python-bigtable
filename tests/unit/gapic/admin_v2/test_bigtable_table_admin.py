...
from google.cloud.bigtable.admin_v2.services.bigtable_table_admin import pagers
...
from google.cloud.bigtable.admin_v2.types import table as gba_table
...
def test_base_bigtable_table_admin_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.bigtable.admin_v2.services.bigtable_table_admin.transports.BigtableTableAdminGrpcTransport.__init__"
    ) as grpc_transport:
...
def test__modify_column_families(request_type, transport: str = "grpc"):
    client = BaseBigtableTableAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
        ...
        response = client._modify_column_families(request)
...
def test__modify_column_families_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = BaseBigtableTableAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
    ...
    with mock.patch.object(
        ...
        client._modify_column_families(request=request)
        call.assert_called()
        _, args, _ = call.mock_calls[0]
...
def test__modify_column_families_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = BaseBigtableTableAdminClient(
        ...
        request = {}
        client._modify_column_families(request)
...
@pytest.mark.asyncio
async def test__modify_column_families_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        request = {}
        await client._modify_column_families(request)
...
@pytest.mark.asyncio
async def test__modify_column_families_async(
    transport: str = "grpc_asyncio",
    ...
    with mock.patch.object(
        ...
        response = await client._modify_column_families(request)
...
@pytest.mark.asyncio
async def test__modify_column_families_async_from_dict():
    await test__modify_column_families_async(request_type=dict)


def test__modify_column_families_field_headers():
    client = BaseBigtableTableAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test__modify_column_families_field_headers_async():
    client = BaseBigtableTableAdminAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test__modify_column_families_flattened():
    client = BaseBigtableTableAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
    ...
    with mock.patch.object(
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        client._modify_column_families(
            name="name_value",
            modifications=[
...
def test__modify_column_families_flattened_error():
    client = BaseBigtableTableAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test__modify_column_families_flattened_async():
    client = BaseBigtableTableAdminAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    with mock.patch.object(
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        response = await client._modify_column_families(
            name="name_value",
            modifications=[
                bigtable_table_admin.ModifyColumnFamiliesRequest.Modification(
                    id="id_value"
...
@pytest.mark.asyncio
async def test__modify_column_families_flattened_error_async():
    client = BaseBigtableTableAdminAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    # fields is an error.
    with pytest.raises(ValueError):
        await client._modify_column_families(
            bigtable_table_admin.ModifyColumnFamiliesRequest(),
            name="name_value",
            modifications=[
                bigtable_table_admin.ModifyColumnFamiliesRequest.Modification(
...
def test__snapshot_table(request_type, transport: str = "grpc"):
    client = BaseBigtableTableAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(type(client.transport.snapshot_table), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name="operations/spam")
        response = client._snapshot_table(request)
...
def test__snapshot_table_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = BaseBigtableTableAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
    ...
    with mock.patch.object(type(client.transport.snapshot_table), "__call__") as call:
        ...
        client._snapshot_table(request=request)
        call.assert_called()
        _, args, _ = call.mock_calls[0]
...
def test__snapshot_table_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = BaseBigtableTableAdminClient(
        ...
        request = {}
        client._snapshot_table(request)
...
@pytest.mark.asyncio
async def test__snapshot_table_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        request = {}
        await client._snapshot_table(request)
...
@pytest.mark.asyncio
async def test__snapshot_table_async(
    transport: str = "grpc_asyncio",
    ...
    with mock.patch.object(type(client.transport.snapshot_table), "__call__") as call:
        ...
        response = await client._snapshot_table(request)
...
@pytest.mark.asyncio
async def test__snapshot_table_async_from_dict():
    await test__snapshot_table_async(request_type=dict)


def test__snapshot_table_field_headers():
    client = BaseBigtableTableAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test__snapshot_table_field_headers_async():
    client = BaseBigtableTableAdminAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test__snapshot_table_flattened():
    client = BaseBigtableTableAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
def test__snapshot_table_flattened_error():
    client = BaseBigtableTableAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test__snapshot_table_flattened_async():
    client = BaseBigtableTableAdminAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    with mock.patch.object(type(client.transport.snapshot_table), "__call__") as call:
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        response = await client._snapshot_table(
            name="name_value",
            cluster="cluster_value",
            snapshot_id="snapshot_id_value",
            description="description_value",
...
@pytest.mark.asyncio
async def test__snapshot_table_flattened_error_async():
    client = BaseBigtableTableAdminAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test__get_snapshot(request_type, transport: str = "grpc"):
    client = BaseBigtableTableAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(type(client.transport.get_snapshot), "__call__") as call:
        ...
        response = client._get_snapshot(request)
...
def test__get_snapshot_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = BaseBigtableTableAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
    ...
    with mock.patch.object(type(client.transport.get_snapshot), "__call__") as call:
        ...
        client._get_snapshot(request=request)
        call.assert_called()
        _, args, _ = call.mock_calls[0]
...
def test__get_snapshot_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = BaseBigtableTableAdminClient(
...
@pytest.mark.asyncio
async def test__get_snapshot_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        request = {}
        await client._get_snapshot(request)
...
@pytest.mark.asyncio
async def test__get_snapshot_async(
    transport: str = "grpc_asyncio",
    ...
    with mock.patch.object(type(client.transport.get_snapshot), "__call__") as call:
        ...
        response = await client._get_snapshot(request)
...
@pytest.mark.asyncio
async def test__get_snapshot_async_from_dict():
    await test__get_snapshot_async(request_type=dict)


def test__get_snapshot_field_headers():
    client = BaseBigtableTableAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test__get_snapshot_field_headers_async():
    client = BaseBigtableTableAdminAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test__get_snapshot_flattened():
    client = BaseBigtableTableAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
def test__get_snapshot_flattened_error():
    client = BaseBigtableTableAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test__get_snapshot_flattened_async():
    client = BaseBigtableTableAdminAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    with mock.patch.object(type(client.transport.get_snapshot), "__call__") as call:
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        response = await client._get_snapshot(
            name="name_value",
        )
...
@pytest.mark.asyncio
async def test__get_snapshot_flattened_error_async():
    client = BaseBigtableTableAdminAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test__list_snapshots(request_type, transport: str = "grpc"):
    client = BaseBigtableTableAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(type(client.transport.list_snapshots), "__call__") as call:
        ...
        response = client._list_snapshots(request)
...
def test__list_snapshots_non_empty_request_with_auto_populated_field():
    ...
    with mock.patch.object(type(client.transport.list_snapshots), "__call__") as call:
        ...
        client._list_snapshots(request=request)
        call.assert_called()
        _, args, _ = call.mock_calls[0]
...
def test__list_snapshots_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = BaseBigtableTableAdminClient(
...
@pytest.mark.asyncio
async def test__list_snapshots_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        request = {}
        await client._list_snapshots(request)
...
@pytest.mark.asyncio
async def test__list_snapshots_async(
    transport: str = "grpc_asyncio",
    ...
    with mock.patch.object(type(client.transport.list_snapshots), "__call__") as call:
        ...
        response = await client._list_snapshots(request)
...
@pytest.mark.asyncio
async def test__list_snapshots_async_from_dict():
    await test__list_snapshots_async(request_type=dict)


def test__list_snapshots_field_headers():
    client = BaseBigtableTableAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test__list_snapshots_field_headers_async():
    client = BaseBigtableTableAdminAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test__list_snapshots_flattened():
    client = BaseBigtableTableAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
def test__list_snapshots_flattened_error():
    client = BaseBigtableTableAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test__list_snapshots_flattened_async():
    client = BaseBigtableTableAdminAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    with mock.patch.object(type(client.transport.list_snapshots), "__call__") as call:
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        response = await client._list_snapshots(
            parent="parent_value",
        )
...
@pytest.mark.asyncio
async def test__list_snapshots_flattened_error_async():
    client = BaseBigtableTableAdminAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    # fields is an error.
    with pytest.raises(ValueError):
        await client._list_snapshots(
            bigtable_table_admin.ListSnapshotsRequest(),
            parent="parent_value",
        )


def test__list_snapshots_pager(transport_name: str = "grpc"):
    client = BaseBigtableTableAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport_name,
    )
    ...
    with mock.patch.object(type(client.transport.list_snapshots), "__call__") as call:
        ...
        pager = client._list_snapshots(request={}, retry=retry, timeout=timeout)
...
def test__list_snapshots_pages(transport_name: str = "grpc"):
    client = BaseBigtableTableAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport_name,
    )
    ...
    with mock.patch.object(type(client.transport.list_snapshots), "__call__") as call:
        ...
        pages = list(client._list_snapshots(request={}).pages)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token


@pytest.mark.asyncio
async def test__list_snapshots_async_pager():
    client = BaseBigtableTableAdminAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    with mock.patch.object(
        ...
        async_pager = await client._list_snapshots(
            request={},
        )
        assert async_pager.next_page_token == "abc"
        responses = []
...
@pytest.mark.asyncio
async def test__list_snapshots_async_pages():
    client = BaseBigtableTableAdminAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test__delete_snapshot(request_type, transport: str = "grpc"):
    client = BaseBigtableTableAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(type(client.transport.delete_snapshot), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = None
        response = client._delete_snapshot(request)
...
def test__delete_snapshot_non_empty_request_with_auto_populated_field():
    ...
    with mock.patch.object(type(client.transport.delete_snapshot), "__call__") as call:
        ...
        client._delete_snapshot(request=request)
        call.assert_called()
        _, args, _ = call.mock_calls[0]
...
def test__delete_snapshot_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = BaseBigtableTableAdminClient(
        ...
        request = {}
        client._delete_snapshot(request)
...
@pytest.mark.asyncio
async def test__delete_snapshot_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        request = {}
        await client._delete_snapshot(request)
...
@pytest.mark.asyncio
async def test__delete_snapshot_async(
    transport: str = "grpc_asyncio",
    ...
    with mock.patch.object(type(client.transport.delete_snapshot), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(None)
        response = await client._delete_snapshot(request)
...
@pytest.mark.asyncio
async def test__delete_snapshot_async_from_dict():
    await test__delete_snapshot_async(request_type=dict)


def test__delete_snapshot_field_headers():
    client = BaseBigtableTableAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test__delete_snapshot_field_headers_async():
    client = BaseBigtableTableAdminAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test__delete_snapshot_flattened():
    client = BaseBigtableTableAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
def test__delete_snapshot_flattened_error():
    client = BaseBigtableTableAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test__delete_snapshot_flattened_async():
    client = BaseBigtableTableAdminAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    with mock.patch.object(type(client.transport.delete_snapshot), "__call__") as call:
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        response = await client._delete_snapshot(
            name="name_value",
        )
...
@pytest.mark.asyncio
async def test__delete_snapshot_flattened_error_async():
    client = BaseBigtableTableAdminAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test__modify_column_families_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = BaseBigtableTableAdminClient(
...
def test__modify_column_families_rest_unset_required_fields():
    transport = transports.BigtableTableAdminRestTransport(
        credentials=ga_credentials.AnonymousCredentials
    )
...
def test__modify_column_families_rest_flattened():
    client = BaseBigtableTableAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        client._modify_column_families(**mock_args)
...
def test__modify_column_families_rest_flattened_error(transport: str = "rest"):
    client = BaseBigtableTableAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test__snapshot_table_rest_required_fields(
    request_type=bigtable_table_admin.SnapshotTableRequest,
):
    transport_class = transports.BigtableTableAdminRestTransport
...
def test__snapshot_table_rest_unset_required_fields():
    transport = transports.BigtableTableAdminRestTransport(
        credentials=ga_credentials.AnonymousCredentials
    )
...
def test__snapshot_table_rest_flattened():
    client = BaseBigtableTableAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        client._snapshot_table(**mock_args)
...
def test__snapshot_table_rest_flattened_error(transport: str = "rest"):
    client = BaseBigtableTableAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test__get_snapshot_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = BaseBigtableTableAdminClient(
...
def test__get_snapshot_rest_required_fields(
    request_type=bigtable_table_admin.GetSnapshotRequest,
):
    transport_class = transports.BigtableTableAdminRestTransport
...
def test__get_snapshot_rest_unset_required_fields():
    transport = transports.BigtableTableAdminRestTransport(
        credentials=ga_credentials.AnonymousCredentials
    )
...
def test__get_snapshot_rest_flattened():
    client = BaseBigtableTableAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        client._get_snapshot(**mock_args)
...
def test__get_snapshot_rest_flattened_error(transport: str = "rest"):
    client = BaseBigtableTableAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test__list_snapshots_rest_required_fields(
    request_type=bigtable_table_admin.ListSnapshotsRequest,
):
    transport_class = transports.BigtableTableAdminRestTransport
...
def test__list_snapshots_rest_unset_required_fields():
    transport = transports.BigtableTableAdminRestTransport(
        credentials=ga_credentials.AnonymousCredentials
    )
...
def test__list_snapshots_rest_flattened():
    client = BaseBigtableTableAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        client._list_snapshots(**mock_args)
...
def test__list_snapshots_rest_flattened_error(transport: str = "rest"):
    client = BaseBigtableTableAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test__list_snapshots_rest_pager(transport: str = "rest"):
    client = BaseBigtableTableAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        pager = client._list_snapshots(request=sample_request)

        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, table.Snapshot) for i in results)

        pages = list(client._list_snapshots(request=sample_request).pages)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token


def test__delete_snapshot_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = BaseBigtableTableAdminClient(
...
def test__delete_snapshot_rest_required_fields(
    request_type=bigtable_table_admin.DeleteSnapshotRequest,
):
    transport_class = transports.BigtableTableAdminRestTransport
...
def test__delete_snapshot_rest_unset_required_fields():
    transport = transports.BigtableTableAdminRestTransport(
        credentials=ga_credentials.AnonymousCredentials
    )
...
def test__delete_snapshot_rest_flattened():
    client = BaseBigtableTableAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        client._delete_snapshot(**mock_args)
...
def test__delete_snapshot_rest_flattened_error(transport: str = "rest"):
    client = BaseBigtableTableAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test__modify_column_families_empty_call_grpc():
    client = BaseBigtableTableAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
        ...
        call.return_value = table.Table()
        client._modify_column_families(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test__snapshot_table_empty_call_grpc():
    client = BaseBigtableTableAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.snapshot_table), "__call__") as call:
        call.return_value = operations_pb2.Operation(name="operations/op")
        client._snapshot_table(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test__get_snapshot_empty_call_grpc():
    client = BaseBigtableTableAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.get_snapshot), "__call__") as call:
        call.return_value = table.Snapshot()
        client._get_snapshot(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test__list_snapshots_empty_call_grpc():
    client = BaseBigtableTableAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.list_snapshots), "__call__") as call:
        call.return_value = bigtable_table_admin.ListSnapshotsResponse()
        client._list_snapshots(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test__delete_snapshot_empty_call_grpc():
    client = BaseBigtableTableAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.delete_snapshot), "__call__") as call:
        call.return_value = None
        client._delete_snapshot(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test__modify_column_families_empty_call_grpc_asyncio():
    client = BaseBigtableTableAdminAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client._modify_column_families(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test__snapshot_table_empty_call_grpc_asyncio():
    client = BaseBigtableTableAdminAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.snapshot_table), "__call__") as call:
        ...
        await client._snapshot_table(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test__get_snapshot_empty_call_grpc_asyncio():
    client = BaseBigtableTableAdminAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.get_snapshot), "__call__") as call:
        ...
        await client._get_snapshot(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test__list_snapshots_empty_call_grpc_asyncio():
    client = BaseBigtableTableAdminAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.list_snapshots), "__call__") as call:
        ...
        await client._list_snapshots(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test__delete_snapshot_empty_call_grpc_asyncio():
    client = BaseBigtableTableAdminAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.delete_snapshot), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(None)
        await client._delete_snapshot(request=None)
...
def test__modify_column_families_rest_call_success(request_type):
    client = BaseBigtableTableAdminClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"
    )
...
@pytest.mark.parametrize("null_interceptor", [True, False])
def test__modify_column_families_rest_interceptors(null_interceptor):
    transport = transports.BigtableTableAdminRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None
        if null_interceptor
...
def test__snapshot_table_rest_bad_request(
    request_type=bigtable_table_admin.SnapshotTableRequest,
):
    client = BaseBigtableTableAdminClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"
...
def test__snapshot_table_rest_call_success(request_type):
    client = BaseBigtableTableAdminClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"
    )
...
@pytest.mark.parametrize("null_interceptor", [True, False])
def test__snapshot_table_rest_interceptors(null_interceptor):
    transport = transports.BigtableTableAdminRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None
        if null_interceptor
...
def test__get_snapshot_rest_bad_request(
    request_type=bigtable_table_admin.GetSnapshotRequest,
):
    client = BaseBigtableTableAdminClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"
...
def test__get_snapshot_rest_call_success(request_type):
    client = BaseBigtableTableAdminClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"
    )
...
@pytest.mark.parametrize("null_interceptor", [True, False])
def test__get_snapshot_rest_interceptors(null_interceptor):
    transport = transports.BigtableTableAdminRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None
        if null_interceptor
...
def test__list_snapshots_rest_bad_request(
    request_type=bigtable_table_admin.ListSnapshotsRequest,
):
    client = BaseBigtableTableAdminClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"
...
def test__list_snapshots_rest_call_success(request_type):
    client = BaseBigtableTableAdminClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"
    )
...
@pytest.mark.parametrize("null_interceptor", [True, False])
def test__list_snapshots_rest_interceptors(null_interceptor):
    transport = transports.BigtableTableAdminRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None
        if null_interceptor
...
def test__delete_snapshot_rest_bad_request(
    request_type=bigtable_table_admin.DeleteSnapshotRequest,
):
    client = BaseBigtableTableAdminClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"
...
def test__delete_snapshot_rest_call_success(request_type):
    client = BaseBigtableTableAdminClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"
    )
...
@pytest.mark.parametrize("null_interceptor", [True, False])
def test__delete_snapshot_rest_interceptors(null_interceptor):
    transport = transports.BigtableTableAdminRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None
        if null_interceptor
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test__modify_column_families_empty_call_rest():
    client = BaseBigtableTableAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test__snapshot_table_empty_call_rest():
    client = BaseBigtableTableAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test__get_snapshot_empty_call_rest():
    client = BaseBigtableTableAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test__list_snapshots_empty_call_rest():
    client = BaseBigtableTableAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test__delete_snapshot_empty_call_rest():
    client = BaseBigtableTableAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_bigtable_table_admin_base_transport():
    ...
    with mock.patch(
        "google.cloud.bigtable.admin_v2.services.bigtable_table_admin.transports.BigtableTableAdminTransport.__init__"
    ) as Transport:
...
def test_bigtable_table_admin_base_transport_with_credentials_file():
    ...
    with mock.patch.object(
        ...
        "google.cloud.bigtable.admin_v2.services.bigtable_table_admin.transports.BigtableTableAdminTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None
