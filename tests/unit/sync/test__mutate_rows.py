...
class TestMutateRowsOperation:
    ...
    def test_mutate_rows_operation(self):
        ...
        with mock.patch.object(instance, "_operation", mock.Mock()) as attempt_mock:
    ...
    def test_mutate_rows_exception_retryable_eventually_pass(self, exc_type):
        ...
        num_retries = 2
        with mock.patch.object(
            _MutateRowsOperation_Sync_Concrete, "_run_attempt", mock.Mock()
        ) as attempt_mock:
    ...
    def test_run_attempt_single_entry_success(self):
        ...
        instance = self._make_one(
            mutation_entries=mutations, per_request_timeout=expected_timeout
        )
