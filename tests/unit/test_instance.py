...
class TestInstance(unittest.TestCase):
    ...
    def _restore_table_helper(self, backup_name=None):
        ...
        client = mock.Mock(project=self.PROJECT, instance_admin_client=instance_api)
        instance = self._make_one(self.INSTANCE_ID, client=client)
        ...
        if backup_name:
            future = instance.restore_table(self.TABLE_ID, backup_name=self.BACKUP_NAME)
        else:
            future = instance.restore_table(
    ...
    def test_restore_table_w_backup_id(self):
        self._restore_table_helper()

    def test_restore_table_w_backup_name(self):
        self._restore_table_helper(backup_name=self.BACKUP_NAME)
