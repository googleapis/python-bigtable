...
def test_admin_overlay_object_imports(module):
    # Simulate from <top level admin package> import <class> dynamically using importlib
    mod = importlib.import_module(module)

    # Check that the import aliasing works as expected for overlay/autogenerated clients/types.
    classes_to_modules = {
        "BigtableTableAdminClient": "google.cloud.bigtable.admin.overlay.services.bigtable_table_admin.client",
        "BigtableInstanceAdminClient": "google.cloud.bigtable.admin.services.bigtable_instance_admin.client",
        "RestoreTableOperation": "google.cloud.bigtable.admin.overlay.types.restore_table",
        "BigtableInstanceAdminClient": "google.cloud.bigtable.admin.services.bigtable_instance_admin.client",
        "RestoreTableRequest": "google.cloud.bigtable.admin.types.bigtable_table_admin",
    }
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            "google.cloud.bigtable.admin.services.bigtable_table_admin.transports",
        ),
        (
            "google.cloud.bigtable_admin_v2.overlay.services.bigtable_table_admin.client",
            "google.cloud.bigtable.admin.overlay.services.bigtable_table_admin.client",
        ),
        (
            "google.cloud.bigtable_admin_v2.overlay.types.async_consistency",
            "google.cloud.bigtable.admin.overlay.types.async_consistency",
        ),
    ],
)
def test_admin_shim_import_aliasing_subpackages(alias, actual):
    # Simulates "import <alias>" dynamically using importlib
    assert importlib.import_module(alias) == importlib.import_module(actual)

    # Simulates "from google.cloud.bigtable_admin_v2.<subpackage> import <module>"
    package, module = alias.rsplit(".", 1)
    assert importlib.import_module(
        f".{module}", package=package
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            "google.cloud.bigtable.admin.services.bigtable_instance_admin.async_client",
        ),
        (
        ...
        (
            ...
            "google.cloud.bigtable.admin.overlay.types.restore_table",
        ),
    ],
)
def test_admin_shim_services_types_subpackage_aliasing(
    ...
    # Simulate both from google.cloud.bigtable_admin_v2.<subpackage> import <class>
    # and import google.cloud.bigtable_admin_v2.<subpackage> dynamically using importlib
