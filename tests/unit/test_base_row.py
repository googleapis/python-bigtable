...
class TestBaseDirectRow(unittest.TestCase):
    @staticmethod
    def _get_target_class():
        from google.cloud.bigtable.base_row import BaseDirectRow

        return BaseDirectRow
...
class TestBaseConditionalRow(unittest.TestCase):
    @staticmethod
    def _get_target_class():
        from google.cloud.bigtable.base_row import BaseConditionalRow

        return BaseConditionalRow
...
class TestBaseAppendRow(unittest.TestCase):
    @staticmethod
    def _get_target_class():
        from google.cloud.bigtable.base_row import BaseAppendRow

        return BaseAppendRow
