...
for library in get_staging_dirs(bigtable_default_version, "bigtable"):
    s.move(library / "google/cloud/bigtable_v2", exclude=["**/gapic_version.py"])
    s.move(library / "tests")
    s.move(library / "scripts")

for library in get_staging_dirs(bigtable_admin_default_version, "bigtable_admin"):
    s.move(library / "google/cloud/bigtable_admin", exclude=["**/gapic_version.py"])
    s.move(library / "google/cloud/bigtable_admin_v2", exclude=["**/gapic_version.py"])
    s.move(library / "tests")
    s.move(library / "scripts")
