...
# Override the oneof_message.py in the autogenerated directory with whatever is
# handwritten in overlay.
s.move(
    "google/cloud/bigtable/admin_v2/overlay/types/oneof_message.py",
    "google/cloud/bigtable/admin_v2/types",
)
