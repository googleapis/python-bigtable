...
class PooledMultiCallable:
    def __init__(
        self, channel_pool: "PooledChannel", call_fn_name: str, *args, **kwargs
    ):
        self._init_args = args
        self._init_kwargs = kwargs
        self.next_channel_fn = channel_pool.next_channel
        self.call_fn_name = call_fn_name
        self._stubs: dict[aio.Channel, Callable] = {}

    def __call__(self, *args, **kwargs) -> aio.Call:
        channel = self.next_channel_fn()
        if channel not in self._stubs:
            self._stubs[channel] = getattr(channel, self.call_fn_name)(
                *self._init_args, **self._init_kwargs
            )
        return self._stubs[channel](*args, **kwargs)
...
class PooledChannel(aio.Channel):
    ...
    def unary_unary(self, *args, **kwargs) -> grpc.aio.UnaryUnaryMultiCallable:
        return PooledMultiCallable(self, "unary_unary", *args, **kwargs)

    def unary_stream(self, *args, **kwargs) -> grpc.aio.UnaryStreamMultiCallable:
        return PooledMultiCallable(self, "unary_stream", *args, **kwargs)

    def stream_unary(self, *args, **kwargs) -> grpc.aio.StreamUnaryMultiCallable:
        return PooledMultiCallable(self, "stream_unary", *args, **kwargs)

    def stream_stream(self, *args, **kwargs) -> grpc.aio.StreamStreamMultiCallable:
        return PooledMultiCallable(self, "stream_stream", *args, **kwargs)
