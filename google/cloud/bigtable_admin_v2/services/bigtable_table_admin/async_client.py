...
class BaseBigtableTableAdminAsyncClient:
    ...
    async def _create_schema_bundle(
        self,
        request: Optional[
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_create_schema_bundle():
                ...
                # Make the request
                operation = client._create_schema_bundle(request=request)
    ...
    async def _update_schema_bundle(
        self,
        request: Optional[
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_update_schema_bundle():
                ...
                # Make the request
                operation = client._update_schema_bundle(request=request)
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_get_schema_bundle():
                ...
                # Make the request
                response = await client._get_schema_bundle(request=request)
    ...
    async def _list_schema_bundles(
        self,
        request: Optional[
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_list_schema_bundles():
                ...
                # Make the request
                page_result = client._list_schema_bundles(request=request)
    ...
    async def _delete_schema_bundle(
        self,
        request: Optional[
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_delete_schema_bundle():
                ...
                # Make the request
                await client._delete_schema_bundle(request=request)
