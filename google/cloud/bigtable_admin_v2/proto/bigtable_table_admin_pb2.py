...
_CREATETABLEREQUEST.fields_by_name['table'].message_type = google_dot_cloud_dot_bigtable__admin__v2_dot_proto_dot_table__pb2._TABLE
...
_LISTTABLESREQUEST.fields_by_name['view'].enum_type = google_dot_cloud_dot_bigtable__admin__v2_dot_proto_dot_table__pb2._TABLE_VIEW
_LISTTABLESRESPONSE.fields_by_name['tables'].message_type = google_dot_cloud_dot_bigtable__admin__v2_dot_proto_dot_table__pb2._TABLE
_GETTABLEREQUEST.fields_by_name['view'].enum_type = google_dot_cloud_dot_bigtable__admin__v2_dot_proto_dot_table__pb2._TABLE_VIEW
_MODIFYCOLUMNFAMILIESREQUEST_MODIFICATION.fields_by_name['create'].message_type = google_dot_cloud_dot_bigtable__admin__v2_dot_proto_dot_table__pb2._COLUMNFAMILY
_MODIFYCOLUMNFAMILIESREQUEST_MODIFICATION.fields_by_name['update'].message_type = google_dot_cloud_dot_bigtable__admin__v2_dot_proto_dot_table__pb2._COLUMNFAMILY
...
_LISTSNAPSHOTSRESPONSE.fields_by_name['snapshots'].message_type = google_dot_cloud_dot_bigtable__admin__v2_dot_proto_dot_table__pb2._SNAPSHOT
...
_CREATEBACKUPREQUEST.fields_by_name['backup'].message_type = google_dot_cloud_dot_bigtable__admin__v2_dot_proto_dot_table__pb2._BACKUP
...
_UPDATEBACKUPREQUEST.fields_by_name['backup'].message_type = google_dot_cloud_dot_bigtable__admin__v2_dot_proto_dot_table__pb2._BACKUP
_UPDATEBACKUPREQUEST.fields_by_name['update_mask'].message_type = google_dot_protobuf_dot_field__mask__pb2._FIELDMASK
_LISTBACKUPSRESPONSE.fields_by_name['backups'].message_type = google_dot_cloud_dot_bigtable__admin__v2_dot_proto_dot_table__pb2._BACKUP
...
_RESTORETABLEMETADATA.fields_by_name['source_type'].enum_type = google_dot_cloud_dot_bigtable__admin__v2_dot_proto_dot_table__pb2._RESTORESOURCETYPE
_RESTORETABLEMETADATA.fields_by_name['backup_info'].message_type = google_dot_cloud_dot_bigtable__admin__v2_dot_proto_dot_table__pb2._BACKUPINFO
_RESTORETABLEMETADATA.fields_by_name['progress'].message_type = google_dot_cloud_dot_bigtable__admin__v2_dot_proto_dot_common__pb2._OPERATIONPROGRESS
...
_OPTIMIZERESTOREDTABLEMETADATA.fields_by_name['progress'].message_type = google_dot_cloud_dot_bigtable__admin__v2_dot_proto_dot_common__pb2._OPERATIONPROGRESS
