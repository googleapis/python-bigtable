...
class _CheckConsistencyPollingFuture(polling.PollingFuture):
    ...
    **This class should not be instantiated by users** and should only be instantiated by the admin
    client's
    :meth:`google.cloud.bigtable.admin.overlay.services.bigtable_table_admin.BigtableTableAdminClient.wait_for_consistency`
    or
    :meth:`google.cloud.bigtable.admin.overlay.services.bigtable_table_admin.BigtableTableAdminClient.wait_for_replication`
    methods.
    ...
    Args:
        check_consistency_call(Callable[
            ...
            <google.cloud.bigtable.admin.overlay.services.bigtable_table_admin.BigtableTableAdminClient.check_consistency>`
