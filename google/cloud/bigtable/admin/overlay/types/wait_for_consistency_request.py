...
class WaitForConsistencyRequest(proto.Message):
    ...
    :class:`google.cloud.bigtable.admin.overlay.services.bigtable_table_admin.client.BigtableTableAdminClient`
    and :class:`google.cloud.bigtable.admin.overlay.services.bigtable_table_admin.async_client.BigtableTableAdmiAsyncClient`.
