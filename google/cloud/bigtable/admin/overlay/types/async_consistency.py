...
class _AsyncCheckConsistencyPollingFuture(async_future.AsyncFuture):
    ...
    **This class should not be instantiated by users** and should only be instantiated by the admin
    client's
    :meth:`google.cloud.bigtable.admin.overlay.services.bigtable_table_admin.AsyncBigtableTableAdminClient.wait_for_consistency`
    or
    :meth:`google.cloud.bigtable.admin.overlay.services.bigtable_table_admin.AsyncBigtableTableAdminClient.wait_for_replication`
    methods.
    ...
    Args:
        check_consistency_call(Callable[
            ...
            <google.cloud.bigtable.admin.overlay.services.bigtable_table_admin.AsyncBigtableTableAdminClient.check_consistency>`
        ...
        default_retry(Optional[google.api_core.retry.Retry]): The `retry` parameter passed in to either
            ...
            <google.cloud.bigtable.admin.overlay.services.bigtable_table_admin.BigtableTableAdminClient.wait_for_consistency>`
            or :meth:`wait_for_replication
            <google.cloud.bigtable.admin.overlay.services.bigtable_table_admin.BigtableTableAdminClient.wait_for_replication>`
