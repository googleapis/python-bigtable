...
from google.cloud.bigtable.admin.types import OptimizeRestoredTableMetadata
...
class RestoreTableOperation(operation.Operation):
    ...
    **This class should not be instantiated by users** and should only be instantiated by the admin
    ...
    <google.cloud.bigtable.admin.overlay.services.bigtable_table_admin.BigtableTableAdminClient.restore_table>`
    method.
    ...
    def optimize_restored_table_operation(self) -> Optional[operation.Operation]:
        ...
        <google.cloud.bigtable.admin.types.bigtable_table_admin.OptimizeRestoredTableMetadata>`
