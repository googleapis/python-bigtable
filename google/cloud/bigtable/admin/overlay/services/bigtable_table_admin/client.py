...
class BigtableTableAdminClient(base_client.BaseBigtableTableAdminClient):
    ...
    def restore_table(
        ...
        *,
        ...
        Additionally, the returned :class:`long-running-operation <google.cloud.bigtable.admin.overlay.types.restore_table.RestoreTableOperation>`
        provides a method, :meth:`google.cloud.bigtable.admin.overlay.types.restore_table.RestoreTableOperation.optimize_restore_table_operation` that
