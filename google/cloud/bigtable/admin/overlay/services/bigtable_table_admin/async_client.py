...
from google.cloud.bigtable.admin.services.bigtable_table_admin import (
    async_client as base_client,
)
from google.cloud.bigtable.admin.services.bigtable_table_admin.transports.base import (
...
class BigtableTableAdminAsyncClient(base_client.BaseBigtableTableAdminAsyncClient):
    ...
    async def restore_table(
        ...
        *,
        ...
        :class:`RestoreTableMetadata <google.cloud.bigtable.admin.types.RestoreTableMetadata>`.
        The :meth:`response <google.api_core.operation.Operation.result>` type is
        :class:`google.cloud.bigtable.admin.types.Table`, if successful.

        Additionally, the returned :class:`long-running-operation <google.cloud.bigtable.admin.overlay.types.async_restore_table.AsyncRestoreTableOperation>`
        provides a method, :meth:`google.cloud.bigtable.admin.overlay.types.async_restore_table.AsyncRestoreTableOperation.optimize_restore_table_operation` that
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_wait_for_consistency():
                ...
                # Initialize request argument(s)
                request = admin.WaitForConsistencyRequest(
                    name="name_value",
                )
        ...
        Args:
            request (Union[google.cloud.bigtable.admin.overlay.types.WaitForConsistencyRequest, dict]):
                The request object.
            name (str):
