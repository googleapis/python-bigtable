...
class ListTablesPager:
    ...
    :class:`google.cloud.bigtable.admin_v2.types.ListTablesResponse` object, and
    ...
    All the usual :class:`google.cloud.bigtable.admin_v2.types.ListTablesResponse`
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            response (google.cloud.bigtable.admin_v2.types.ListTablesResponse):
...
class ListAuthorizedViewsPager:
    ...
    This class thinly wraps an initial
    :class:`google.cloud.bigtable.admin_v2.types.ListAuthorizedViewsResponse` object, and
    provides an ``__iter__`` method to iterate through its
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            method (Callable): The method that was originally called, and
                which instantiated this pager.
            request (google.cloud.bigtable.admin_v2.types.ListAuthorizedViewsRequest):
                The initial request object.
...
class ListSnapshotsPager:
    ...
    This class thinly wraps an initial
    :class:`google.cloud.bigtable.admin_v2.types.ListSnapshotsResponse` object, and
    provides an ``__iter__`` method to iterate through its
    ``snapshots`` field.
    ...
    All the usual :class:`google.cloud.bigtable.admin_v2.types.ListSnapshotsResponse`
    attributes are available on the pager. If multiple requests are made, only
    the most recent response is retained, and thus used for attribute lookup.
    """
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            method (Callable): The method that was originally called, and
                which instantiated this pager.
            request (google.cloud.bigtable.admin_v2.types.ListSnapshotsRequest):
                The initial request object.
            response (google.cloud.bigtable.admin_v2.types.ListSnapshotsResponse):
                The initial response object.
            retry (google.api_core.retry.Retry): Designation of what errors,
                if any, should be retried.
            timeout (float): The timeout for this request.
...
class ListBackupsPager:
    ...
    This class thinly wraps an initial
    :class:`google.cloud.bigtable.admin_v2.types.ListBackupsResponse` object, and
    provides an ``__iter__`` method to iterate through its
    ``backups`` field.
    ...
    All the usual :class:`google.cloud.bigtable.admin_v2.types.ListBackupsResponse`
    attributes are available on the pager. If multiple requests are made, only
    the most recent response is retained, and thus used for attribute lookup.
    """
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            method (Callable): The method that was originally called, and
                which instantiated this pager.
            request (google.cloud.bigtable.admin_v2.types.ListBackupsRequest):
                The initial request object.
            response (google.cloud.bigtable.admin_v2.types.ListBackupsResponse):
                The initial response object.
            retry (google.api_core.retry.Retry): Designation of what errors,
                if any, should be retried.
            timeout (float): The timeout for this request.
...
class ListSchemaBundlesPager:
    ...
    This class thinly wraps an initial
    :class:`google.cloud.bigtable.admin_v2.types.ListSchemaBundlesResponse` object, and
    provides an ``__iter__`` method to iterate through its
    ...
    All the usual :class:`google.cloud.bigtable.admin_v2.types.ListSchemaBundlesResponse`
    attributes are available on the pager. If multiple requests are made, only
    the most recent response is retained, and thus used for attribute lookup.
    """
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            method (Callable): The method that was originally called, and
                which instantiated this pager.
            request (google.cloud.bigtable.admin_v2.types.ListSchemaBundlesRequest):
                The initial request object.
            response (google.cloud.bigtable.admin_v2.types.ListSchemaBundlesResponse):
                The initial response object.
            retry (google.api_core.retry.Retry): Designation of what errors,
                if any, should be retried.
            timeout (float): The timeout for this request.
