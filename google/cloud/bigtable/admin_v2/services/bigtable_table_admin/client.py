...
class BaseBigtableTableAdminClient(metaclass=BaseBigtableTableAdminClientMeta):
    ...
    def create_table(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.bigtable.admin_v2.types.CreateTableRequest, dict]):
            ...
            table_id (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            table (google.cloud.bigtable.admin_v2.types.Table):
    ...
    def create_table_from_snapshot(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.bigtable.admin_v2.types.CreateTableFromSnapshotRequest, dict]):
                The request object. Request message for
    ...
    def list_tables(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.bigtable.admin_v2.types.ListTablesRequest, dict]):
                The request object. Request message for
        ...
        Returns:
            google.cloud.bigtable.admin_v2.services.bigtable_table_admin.pagers.ListTablesPager:
    ...
    def get_table(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.bigtable.admin_v2.types.GetTableRequest, dict]):
                The request object. Request message for
    ...
    def update_table(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.bigtable.admin_v2.types.UpdateTableRequest, dict]):
    ...
    def delete_table(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.bigtable.admin_v2.types.DeleteTableRequest, dict]):
                The request object. Request message for
    ...
    def undelete_table(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.bigtable.admin_v2.types.UndeleteTableRequest, dict]):
                The request object. Request message for
    ...
    def create_authorized_view(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.bigtable.admin_v2.types.CreateAuthorizedViewRequest, dict]):
                The request object. The request for
            ...
            parent (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            authorized_view (google.cloud.bigtable.admin_v2.types.AuthorizedView):
    ...
    def list_authorized_views(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.bigtable.admin_v2.types.ListAuthorizedViewsRequest, dict]):
                The request object. Request message for
        ...
        Returns:
            google.cloud.bigtable.admin_v2.services.bigtable_table_admin.pagers.ListAuthorizedViewsPager:
                Response message for
                   [google.bigtable.admin.v2.BigtableTableAdmin.ListAuthorizedViews][google.bigtable.admin.v2.BigtableTableAdmin.ListAuthorizedViews]
    ...
    def get_authorized_view(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.bigtable.admin_v2.types.GetAuthorizedViewRequest, dict]):
                The request object. Request message for
    ...
    def update_authorized_view(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.bigtable.admin_v2.types.UpdateAuthorizedViewRequest, dict]):
                The request object. The request for
    ...
    def delete_authorized_view(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.bigtable.admin_v2.types.DeleteAuthorizedViewRequest, dict]):
                The request object. Request message for
    ...
    def modify_column_families(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.bigtable.admin_v2.types.ModifyColumnFamiliesRequest, dict]):
                The request object. Request message for
            ...
            name (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            modifications (MutableSequence[google.cloud.bigtable.admin_v2.types.ModifyColumnFamiliesRequest.Modification]):
    ...
    def drop_row_range(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.bigtable.admin_v2.types.DropRowRangeRequest, dict]):
                The request object. Request message for
    ...
    def snapshot_table(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.bigtable.admin_v2.types.SnapshotTableRequest, dict]):
                The request object. Request message for
    ...
    def get_snapshot(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.bigtable.admin_v2.types.GetSnapshotRequest, dict]):
                The request object. Request message for
    ...
    def list_snapshots(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.bigtable.admin_v2.types.ListSnapshotsRequest, dict]):
                The request object. Request message for
        ...
        Returns:
            google.cloud.bigtable.admin_v2.services.bigtable_table_admin.pagers.ListSnapshotsPager:
                Response message for
                   [google.bigtable.admin.v2.BigtableTableAdmin.ListSnapshots][google.bigtable.admin.v2.BigtableTableAdmin.ListSnapshots]
    ...
    def delete_snapshot(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.bigtable.admin_v2.types.DeleteSnapshotRequest, dict]):
                The request object. Request message for
    ...
    def create_backup(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.bigtable.admin_v2.types.CreateBackupRequest, dict]):
                The request object. The request for
            ...
            backup_id (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            backup (google.cloud.bigtable.admin_v2.types.Backup):
    ...
    def get_backup(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.bigtable.admin_v2.types.GetBackupRequest, dict]):
                The request object. The request for
    ...
    def update_backup(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.bigtable.admin_v2.types.UpdateBackupRequest, dict]):
                The request object. The request for
    ...
    def delete_backup(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.bigtable.admin_v2.types.DeleteBackupRequest, dict]):
                The request object. The request for
    ...
    def list_backups(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.bigtable.admin_v2.types.ListBackupsRequest, dict]):
                The request object. The request for
        ...
        Returns:
            google.cloud.bigtable.admin_v2.services.bigtable_table_admin.pagers.ListBackupsPager:
                The response for
                   [ListBackups][google.bigtable.admin.v2.BigtableTableAdmin.ListBackups].
    ...
    def copy_backup(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.bigtable.admin_v2.types.CopyBackupRequest, dict]):
                The request object. The request for
    ...
    def create_schema_bundle(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.bigtable.admin_v2.types.CreateSchemaBundleRequest, dict]):
                The request object. The request for
            ...
            schema_bundle_id (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            schema_bundle (google.cloud.bigtable.admin_v2.types.SchemaBundle):
    ...
    def update_schema_bundle(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.bigtable.admin_v2.types.UpdateSchemaBundleRequest, dict]):
                The request object. The request for
    ...
    def get_schema_bundle(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.bigtable.admin_v2.types.GetSchemaBundleRequest, dict]):
                The request object. The request for
    ...
    def list_schema_bundles(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.bigtable.admin_v2.types.ListSchemaBundlesRequest, dict]):
                The request object. The request for
        ...
        Returns:
            google.cloud.bigtable.admin_v2.services.bigtable_table_admin.pagers.ListSchemaBundlesPager:
                The response for
                   [ListSchemaBundles][google.bigtable.admin.v2.BigtableTableAdmin.ListSchemaBundles].
    ...
    def delete_schema_bundle(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.bigtable.admin_v2.types.DeleteSchemaBundleRequest, dict]):
                The request object. The request for
