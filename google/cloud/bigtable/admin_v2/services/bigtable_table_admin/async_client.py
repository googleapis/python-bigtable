...
from google.cloud.bigtable.admin_v2 import gapic_version as package_version
...
class BaseBigtableTableAdminAsyncClient:
    ...
    async def create_table(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.bigtable.admin_v2.types.CreateTableRequest, dict]]):
            ...
            table_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            table (:class:`google.cloud.bigtable.admin_v2.types.Table`):
    ...
    async def create_table_from_snapshot(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.bigtable.admin_v2.types.CreateTableFromSnapshotRequest, dict]]):
                The request object. Request message for
    ...
    async def list_tables(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.bigtable.admin_v2.types.ListTablesRequest, dict]]):
                The request object. Request message for
        ...
        Returns:
            google.cloud.bigtable.admin_v2.services.bigtable_table_admin.pagers.ListTablesAsyncPager:
    ...
    async def get_table(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.bigtable.admin_v2.types.GetTableRequest, dict]]):
                The request object. Request message for
    ...
    async def update_table(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.bigtable.admin_v2.types.UpdateTableRequest, dict]]):
    ...
    async def delete_table(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.bigtable.admin_v2.types.DeleteTableRequest, dict]]):
                The request object. Request message for
    ...
    async def undelete_table(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.bigtable.admin_v2.types.UndeleteTableRequest, dict]]):
                The request object. Request message for
    ...
    async def create_authorized_view(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.bigtable.admin_v2.types.CreateAuthorizedViewRequest, dict]]):
                The request object. The request for
            ...
            parent (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            authorized_view (:class:`google.cloud.bigtable.admin_v2.types.AuthorizedView`):
        ...
        Returns:
            google.api_core.operation_async.AsyncOperation:
                ...
                The result type for the operation will be :class:`google.cloud.bigtable.admin_v2.types.AuthorizedView` AuthorizedViews represent subsets of a particular Cloud Bigtable table. Users
    ...
    async def list_authorized_views(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.bigtable.admin_v2.types.ListAuthorizedViewsRequest, dict]]):
                The request object. Request message for
        ...
        Returns:
            google.cloud.bigtable.admin_v2.services.bigtable_table_admin.pagers.ListAuthorizedViewsAsyncPager:
                Response message for
                   [google.bigtable.admin.v2.BigtableTableAdmin.ListAuthorizedViews][google.bigtable.admin.v2.BigtableTableAdmin.ListAuthorizedViews]
    ...
    async def get_authorized_view(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.bigtable.admin_v2.types.GetAuthorizedViewRequest, dict]]):
                The request object. Request message for
        ...
        Returns:
            google.cloud.bigtable.admin_v2.types.AuthorizedView:
    ...
    async def update_authorized_view(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.bigtable.admin_v2.types.UpdateAuthorizedViewRequest, dict]]):
                The request object. The request for
    ...
    async def delete_authorized_view(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.bigtable.admin_v2.types.DeleteAuthorizedViewRequest, dict]]):
                The request object. Request message for
    ...
    async def modify_column_families(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.bigtable.admin_v2.types.ModifyColumnFamiliesRequest, dict]]):
                The request object. Request message for
            ...
            name (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            modifications (:class:`MutableSequence[google.cloud.bigtable.admin_v2.types.ModifyColumnFamiliesRequest.Modification]`):
    ...
    async def drop_row_range(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.bigtable.admin_v2.types.DropRowRangeRequest, dict]]):
                The request object. Request message for
    ...
    async def generate_consistency_token(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.bigtable.admin_v2.types.GenerateConsistencyTokenRequest, dict]]):
                The request object. Request message for
        ...
        Returns:
            google.cloud.bigtable.admin_v2.types.GenerateConsistencyTokenResponse:
                Response message for
                   [google.bigtable.admin.v2.BigtableTableAdmin.GenerateConsistencyToken][google.bigtable.admin.v2.BigtableTableAdmin.GenerateConsistencyToken]
    ...
    async def check_consistency(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.bigtable.admin_v2.types.CheckConsistencyRequest, dict]]):
                The request object. Request message for
    ...
    async def snapshot_table(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.bigtable.admin_v2.types.SnapshotTableRequest, dict]]):
                The request object. Request message for
        ...
        Returns:
            google.api_core.operation_async.AsyncOperation:
                ...
                The result type for the operation will be :class:`google.cloud.bigtable.admin_v2.types.Snapshot` A snapshot of a table at a particular time. A snapshot can be used as a
    ...
    async def get_snapshot(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.bigtable.admin_v2.types.GetSnapshotRequest, dict]]):
                The request object. Request message for
        ...
        Returns:
            google.cloud.bigtable.admin_v2.types.Snapshot:
    ...
    async def list_snapshots(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.bigtable.admin_v2.types.ListSnapshotsRequest, dict]]):
                The request object. Request message for
        ...
        Returns:
            google.cloud.bigtable.admin_v2.services.bigtable_table_admin.pagers.ListSnapshotsAsyncPager:
                Response message for
                   [google.bigtable.admin.v2.BigtableTableAdmin.ListSnapshots][google.bigtable.admin.v2.BigtableTableAdmin.ListSnapshots]
    ...
    async def delete_snapshot(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.bigtable.admin_v2.types.DeleteSnapshotRequest, dict]]):
                The request object. Request message for
    ...
    async def create_backup(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.bigtable.admin_v2.types.CreateBackupRequest, dict]]):
                The request object. The request for
            ...
            backup_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            backup (:class:`google.cloud.bigtable.admin_v2.types.Backup`):
        ...
        Returns:
            google.api_core.operation_async.AsyncOperation:
                ...
                :class:`google.cloud.bigtable.admin_v2.types.Backup` A
    ...
    async def get_backup(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.bigtable.admin_v2.types.GetBackupRequest, dict]]):
                The request object. The request for
        ...
        Returns:
            google.cloud.bigtable.admin_v2.types.Backup:
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_update_backup():
                ...
                request = admin_v2.UpdateBackupRequest(
                    backup=backup,
                )
        ...
        Args:
            request (Optional[Union[google.cloud.bigtable.admin_v2.types.UpdateBackupRequest, dict]]):
                The request object. The request for
    ...
    async def delete_backup(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.bigtable.admin_v2.types.DeleteBackupRequest, dict]]):
                The request object. The request for
    ...
    async def list_backups(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.bigtable.admin_v2.types.ListBackupsRequest, dict]]):
                The request object. The request for
        ...
        Returns:
            google.cloud.bigtable.admin_v2.services.bigtable_table_admin.pagers.ListBackupsAsyncPager:
                The response for
                   [ListBackups][google.bigtable.admin.v2.BigtableTableAdmin.ListBackups].
    ...
    async def _restore_table(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.bigtable.admin_v2.types.RestoreTableRequest, dict]]):
                The request object. The request for
    ...
    async def copy_backup(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.bigtable.admin_v2.types.CopyBackupRequest, dict]]):
                The request object. The request for
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_create_schema_bundle():
                ...
                # Initialize request argument(s)
                schema_bundle = admin_v2.SchemaBundle()
                schema_bundle.proto_schema.proto_descriptors = b'proto_descriptors_blob'

                request = admin_v2.CreateSchemaBundleRequest(
                    parent="parent_value",
        ...
        Args:
            request (Optional[Union[google.cloud.bigtable.admin_v2.types.CreateSchemaBundleRequest, dict]]):
                The request object. The request for
            ...
            schema_bundle_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            schema_bundle (:class:`google.cloud.bigtable.admin_v2.types.SchemaBundle`):
        ...
        Returns:
            google.api_core.operation_async.AsyncOperation:
                ...
                The result type for the operation will be
                :class:`google.cloud.bigtable.admin_v2.types.SchemaBundle`
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_update_schema_bundle():
                ...
                request = admin_v2.UpdateSchemaBundleRequest(
                    schema_bundle=schema_bundle,
                )
        ...
        Args:
            request (Optional[Union[google.cloud.bigtable.admin_v2.types.UpdateSchemaBundleRequest, dict]]):
                The request object. The request for
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_get_schema_bundle():
                ...
                # Initialize request argument(s)
                request = admin_v2.GetSchemaBundleRequest(
                    name="name_value",
                )
        ...
        Args:
            request (Optional[Union[google.cloud.bigtable.admin_v2.types.GetSchemaBundleRequest, dict]]):
                The request object. The request for
        ...
        Returns:
            google.cloud.bigtable.admin_v2.types.SchemaBundle:
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_list_schema_bundles():
                ...
                # Initialize request argument(s)
                request = admin_v2.ListSchemaBundlesRequest(
                    parent="parent_value",
                )
        ...
        Args:
            request (Optional[Union[google.cloud.bigtable.admin_v2.types.ListSchemaBundlesRequest, dict]]):
                The request object. The request for
        ...
        Returns:
            google.cloud.bigtable.admin_v2.services.bigtable_table_admin.pagers.ListSchemaBundlesAsyncPager:
                The response for
                   [ListSchemaBundles][google.bigtable.admin.v2.BigtableTableAdmin.ListSchemaBundles].
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_delete_schema_bundle():
                ...
                # Initialize request argument(s)
                request = admin_v2.DeleteSchemaBundleRequest(
                    name="name_value",
                )
        ...
        Args:
            request (Optional[Union[google.cloud.bigtable.admin_v2.types.DeleteSchemaBundleRequest, dict]]):
                The request object. The request for
