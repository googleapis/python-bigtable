...
class BaseBigtableTableAdminAsyncClient:
    ...
    async def _modify_column_families(
        self,
        request: Optional[
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_modify_column_families():
                ...
                # Make the request
                response = await client._modify_column_families(request=request)
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_snapshot_table():
                ...
                # Make the request
                operation = client._snapshot_table(request=request)
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_get_snapshot():
                ...
                # Make the request
                response = await client._get_snapshot(request=request)
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_list_snapshots():
                ...
                # Make the request
                page_result = client._list_snapshots(request=request)
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_delete_snapshot():
                ...
                # Make the request
                await client._delete_snapshot(request=request)
