...
class ListAppProfilesPager:
    ...
    :class:`google.cloud.bigtable.admin_v2.types.ListAppProfilesResponse` object, and
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            request (google.cloud.bigtable.admin_v2.types.ListAppProfilesRequest):
...
class ListHotTabletsPager:
    ...
    This class thinly wraps an initial
    :class:`google.cloud.bigtable.admin_v2.types.ListHotTabletsResponse` object, and
    provides an ``__iter__`` method to iterate through its
    ``hot_tablets`` field.
    ...
    All the usual :class:`google.cloud.bigtable.admin_v2.types.ListHotTabletsResponse`
    attributes are available on the pager. If multiple requests are made, only
    the most recent response is retained, and thus used for attribute lookup.
    """
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            method (Callable): The method that was originally called, and
                which instantiated this pager.
            request (google.cloud.bigtable.admin_v2.types.ListHotTabletsRequest):
                The initial request object.
            response (google.cloud.bigtable.admin_v2.types.ListHotTabletsResponse):
                The initial response object.
            retry (google.api_core.retry.Retry): Designation of what errors,
                if any, should be retried.
            timeout (float): The timeout for this request.
...
class ListLogicalViewsPager:
    ...
    This class thinly wraps an initial
    :class:`google.cloud.bigtable.admin_v2.types.ListLogicalViewsResponse` object, and
    provides an ``__iter__`` method to iterate through its
    ``logical_views`` field.
    ...
    All the usual :class:`google.cloud.bigtable.admin_v2.types.ListLogicalViewsResponse`
    attributes are available on the pager. If multiple requests are made, only
    the most recent response is retained, and thus used for attribute lookup.
    """
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            method (Callable): The method that was originally called, and
                which instantiated this pager.
            request (google.cloud.bigtable.admin_v2.types.ListLogicalViewsRequest):
                The initial request object.
            response (google.cloud.bigtable.admin_v2.types.ListLogicalViewsResponse):
                The initial response object.
            retry (google.api_core.retry.Retry): Designation of what errors,
                if any, should be retried.
            timeout (float): The timeout for this request.
...
class ListMaterializedViewsPager:
    ...
    This class thinly wraps an initial
    :class:`google.cloud.bigtable.admin_v2.types.ListMaterializedViewsResponse` object, and
    provides an ``__iter__`` method to iterate through its
    ...
    All the usual :class:`google.cloud.bigtable.admin_v2.types.ListMaterializedViewsResponse`
    attributes are available on the pager. If multiple requests are made, only
    the most recent response is retained, and thus used for attribute lookup.
    """
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            method (Callable): The method that was originally called, and
                which instantiated this pager.
            request (google.cloud.bigtable.admin_v2.types.ListMaterializedViewsRequest):
                The initial request object.
            response (google.cloud.bigtable.admin_v2.types.ListMaterializedViewsResponse):
                The initial response object.
            retry (google.api_core.retry.Retry): Designation of what errors,
                if any, should be retried.
            timeout (float): The timeout for this request.
