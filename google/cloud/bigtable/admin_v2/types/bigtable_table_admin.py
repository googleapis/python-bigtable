...
class RestoreTableMetadata(proto.Message):
    ...
    Attributes:
        ...
        progress (google.cloud.bigtable.admin_v2.types.OperationProgress):
            The progress of the
            [RestoreTable][google.bigtable.admin.v2.BigtableTableAdmin.RestoreTable]
            operation.
    """
...
class CreateTableRequest(proto.Message):
    ...
    Attributes:
        ...
        initial_splits (MutableSequence[google.cloud.bigtable.admin_v2.types.CreateTableRequest.Split]):
...
class ListTablesRequest(proto.Message):
    ...
    Attributes:
        parent (str):
            ...
            ``projects/{project}/instances/{instance}``.
        view (google.cloud.bigtable.admin_v2.types.Table.View):
...
class ListTablesResponse(proto.Message):
    ...
    Attributes:
        tables (MutableSequence[google.cloud.bigtable.admin_v2.types.Table]):
...
class ListSnapshotsResponse(proto.Message):
    ...
    Attributes:
        snapshots (MutableSequence[google.cloud.bigtable.admin_v2.types.Snapshot]):
...
class SnapshotTableMetadata(proto.Message):
    ...
    Attributes:
        original_request (google.cloud.bigtable.admin_v2.types.SnapshotTableRequest):
...
class CreateTableFromSnapshotMetadata(proto.Message):
    ...
    Attributes:
        original_request (google.cloud.bigtable.admin_v2.types.CreateTableFromSnapshotRequest):
            The request that prompted the initiation of
...
class ListBackupsResponse(proto.Message):
    ...
    Attributes:
        backups (MutableSequence[google.cloud.bigtable.admin_v2.types.Backup]):
...
class CopyBackupMetadata(proto.Message):
    ...
    Attributes:
        name (str):
            ...
            ``projects/<project>/instances/<instance>/clusters/<cluster>/backups/<backup>``.
        source_backup_info (google.cloud.bigtable.admin_v2.types.BackupInfo):
...
class CreateAuthorizedViewMetadata(proto.Message):
    ...
    Attributes:
        original_request (google.cloud.bigtable.admin_v2.types.CreateAuthorizedViewRequest):
            The request that prompted the initiation of
...
class ListAuthorizedViewsRequest(proto.Message):
    ...
    Attributes:
        ...
        page_token (str):
            ...
            previous call.
        view (google.cloud.bigtable.admin_v2.types.AuthorizedView.ResponseView):
...
class ListAuthorizedViewsResponse(proto.Message):
    ...
    Attributes:
        authorized_views (MutableSequence[google.cloud.bigtable.admin_v2.types.AuthorizedView]):
...
class UpdateAuthorizedViewMetadata(proto.Message):
    ...
    Attributes:
        original_request (google.cloud.bigtable.admin_v2.types.UpdateAuthorizedViewRequest):
            The request that prompted the initiation of
...
class ListSchemaBundlesResponse(proto.Message):
    ...
    Attributes:
        schema_bundles (MutableSequence[google.cloud.bigtable.admin_v2.types.SchemaBundle]):
