...
class ListInstancesResponse(proto.Message):
    ...
    Attributes:
        instances (MutableSequence[google.cloud.bigtable.admin_v2.types.Instance]):
...
class ListClustersResponse(proto.Message):
    ...
    Attributes:
        clusters (MutableSequence[google.cloud.bigtable.admin_v2.types.Cluster]):
...
class UpdateInstanceMetadata(proto.Message):
    ...
    Attributes:
        original_request (google.cloud.bigtable.admin_v2.types.PartialUpdateInstanceRequest):
            The request that prompted the initiation of
...
class CreateClusterMetadata(proto.Message):
    ...
    Attributes:
        original_request (google.cloud.bigtable.admin_v2.types.CreateClusterRequest):
            The request that prompted the initiation of
        ...
        finish_time (google.protobuf.timestamp_pb2.Timestamp):
            The time at which the operation failed or was
            completed successfully.
        tables (MutableMapping[str, google.cloud.bigtable.admin_v2.types.CreateClusterMetadata.TableProgress]):
    ...
    class TableProgress(proto.Message):
        ...
        Attributes:
            ...
            state (google.cloud.bigtable.admin_v2.types.CreateClusterMetadata.TableProgress.State):
...
class UpdateClusterMetadata(proto.Message):
    ...
    Attributes:
        original_request (google.cloud.bigtable.admin_v2.types.Cluster):
            The request that prompted the initiation of
...
class PartialUpdateClusterMetadata(proto.Message):
    ...
    Attributes:
        ...
        finish_time (google.protobuf.timestamp_pb2.Timestamp):
            The time at which the operation failed or was
            completed successfully.
        original_request (google.cloud.bigtable.admin_v2.types.PartialUpdateClusterRequest):
...
class ListAppProfilesResponse(proto.Message):
    ...
    Attributes:
        app_profiles (MutableSequence[google.cloud.bigtable.admin_v2.types.AppProfile]):
...
class ListHotTabletsResponse(proto.Message):
    ...
    Attributes:
        hot_tablets (MutableSequence[google.cloud.bigtable.admin_v2.types.HotTablet]):
...
class ListLogicalViewsResponse(proto.Message):
    ...
    Attributes:
        logical_views (MutableSequence[google.cloud.bigtable.admin_v2.types.LogicalView]):
...
class UpdateLogicalViewMetadata(proto.Message):
    ...
    Attributes:
        original_request (google.cloud.bigtable.admin_v2.types.UpdateLogicalViewRequest):
            The request that prompted the initiation of
...
class CreateMaterializedViewMetadata(proto.Message):
    ...
    Attributes:
        original_request (google.cloud.bigtable.admin_v2.types.CreateMaterializedViewRequest):
            The request that prompted the initiation of
...
class ListMaterializedViewsResponse(proto.Message):
    ...
    Attributes:
        materialized_views (MutableSequence[google.cloud.bigtable.admin_v2.types.MaterializedView]):
...
class UpdateMaterializedViewMetadata(proto.Message):
    ...
    Attributes:
        original_request (google.cloud.bigtable.admin_v2.types.UpdateMaterializedViewRequest):
            The request that prompted the initiation of
