...
class Instance(proto.Message):
    ...
    Attributes:
        ...
        display_name (str):
            ...
            avoid confusion.
        state (google.cloud.bigtable.admin_v2.types.Instance.State):
...
class Cluster(proto.Message):
    ...
    Attributes:
        ...
        state (google.cloud.bigtable.admin_v2.types.Cluster.State):
            Output only. The current state of the
            cluster.
        serve_nodes (int):
        ...
        node_scaling_factor (google.cloud.bigtable.admin_v2.types.Cluster.NodeScalingFactor):
            Immutable. The node scaling factor of this
            cluster.
        cluster_config (google.cloud.bigtable.admin_v2.types.Cluster.ClusterConfig):
            Configuration for this cluster.

            This field is a member of `oneof`_ ``config``.
        default_storage_type (google.cloud.bigtable.admin_v2.types.StorageType):
            Immutable. The type of storage used by this
            cluster to serve its parent instance's tables,
            unless explicitly overridden.
        encryption_config (google.cloud.bigtable.admin_v2.types.Cluster.EncryptionConfig):
    ...
    class ClusterAutoscalingConfig(proto.Message):
        ...
        Attributes:
            autoscaling_limits (google.cloud.bigtable.admin_v2.types.AutoscalingLimits):
                Required. Autoscaling limits for this
                cluster.
            autoscaling_targets (google.cloud.bigtable.admin_v2.types.AutoscalingTargets):
...
class AppProfile(proto.Message):
    ...
    Attributes:
        ...
        description (str):
            ...
            this AppProfile.
        multi_cluster_routing_use_any (google.cloud.bigtable.admin_v2.types.AppProfile.MultiClusterRoutingUseAny):
            Use a multi-cluster routing policy.

            This field is a member of `oneof`_ ``routing_policy``.
        single_cluster_routing (google.cloud.bigtable.admin_v2.types.AppProfile.SingleClusterRouting):
            Use a single-cluster routing policy.

            This field is a member of `oneof`_ ``routing_policy``.
        priority (google.cloud.bigtable.admin_v2.types.AppProfile.Priority):
        ...
        standard_isolation (google.cloud.bigtable.admin_v2.types.AppProfile.StandardIsolation):
            The standard options used for isolating this
            app profile's traffic from other use cases.

            This field is a member of `oneof`_ ``isolation``.
        data_boost_isolation_read_only (google.cloud.bigtable.admin_v2.types.AppProfile.DataBoostIsolationReadOnly):
    ...
    class MultiClusterRoutingUseAny(proto.Message):
        ...
        Attributes:
            cluster_ids (MutableSequence[str]):
                ...
                eligible.
            row_affinity (google.cloud.bigtable.admin_v2.types.AppProfile.MultiClusterRoutingUseAny.RowAffinity):
    ...
    class DataBoostIsolationReadOnly(proto.Message):
        ...
        Attributes:
            compute_billing_owner (google.cloud.bigtable.admin_v2.types.AppProfile.DataBoostIsolationReadOnly.ComputeBillingOwner):
