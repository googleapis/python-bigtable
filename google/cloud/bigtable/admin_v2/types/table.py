...
class RestoreInfo(proto.Message):
    ...
    Attributes:
        ...
        backup_info (google.cloud.bigtable.admin_v2.types.BackupInfo):
...
class Table(proto.Message):
    ...
    Attributes:
        name (str):
            ...
            ``FULL``
        cluster_states (MutableMapping[str, google.cloud.bigtable.admin_v2.types.Table.ClusterState]):
        ...
        column_families (MutableMapping[str, google.cloud.bigtable.admin_v2.types.ColumnFamily]):
            ...
            ``FULL``
        granularity (google.cloud.bigtable.admin_v2.types.Table.TimestampGranularity):
            ...
            ``SCHEMA_VIEW``, ``FULL``.
        restore_info (google.cloud.bigtable.admin_v2.types.RestoreInfo):
        ...
        deletion_protection (bool):
            ...
            through Data APIs.
        automated_backup_policy (google.cloud.bigtable.admin_v2.types.Table.AutomatedBackupPolicy):
        ...
        row_key_schema (google.cloud.bigtable.admin_v2.types.Type.Struct):
    ...
    class ClusterState(proto.Message):
        ...
        Attributes:
            replication_state (google.cloud.bigtable.admin_v2.types.Table.ClusterState.ReplicationState):
                Output only. The state of replication for the
                table in this cluster.
            encryption_info (MutableSequence[google.cloud.bigtable.admin_v2.types.EncryptionInfo]):
...
class AuthorizedView(proto.Message):
    ...
    Attributes:
        ...
        subset_view (google.cloud.bigtable.admin_v2.types.AuthorizedView.SubsetView):
    ...
    class SubsetView(proto.Message):
        ...
        Attributes:
            ...
            family_subsets (MutableMapping[str, google.cloud.bigtable.admin_v2.types.AuthorizedView.FamilySubsets]):
...
class ColumnFamily(proto.Message):
    ...
    Attributes:
        gc_rule (google.cloud.bigtable.admin_v2.types.GcRule):
...
class GcRule(oneof_message.OneofMessage):
    ...
    Attributes:
        ...
        max_age (google.protobuf.duration_pb2.Duration):
            ...
            This field is a member of `oneof`_ ``rule``.
        intersection (google.cloud.bigtable.admin_v2.types.GcRule.Intersection):
            Delete cells that would be deleted by every
            nested rule.

            This field is a member of `oneof`_ ``rule``.
        union (google.cloud.bigtable.admin_v2.types.GcRule.Union):
    ...
    class Intersection(proto.Message):
        ...
        Attributes:
            rules (MutableSequence[google.cloud.bigtable.admin_v2.types.GcRule]):
...
class EncryptionInfo(proto.Message):
    ...
    Attributes:
        encryption_type (google.cloud.bigtable.admin_v2.types.EncryptionInfo.EncryptionType):
...
class Snapshot(proto.Message):
    ...
    Attributes:
        ...
        source_table (google.cloud.bigtable.admin_v2.types.Table):
        ...
        state (google.cloud.bigtable.admin_v2.types.Snapshot.State):
...
class Backup(proto.Message):
    ...
    Attributes:
        ...
        state (google.cloud.bigtable.admin_v2.types.Backup.State):
            Output only. The current state of the backup.
        encryption_info (google.cloud.bigtable.admin_v2.types.EncryptionInfo):
            Output only. The encryption information for
            the backup.
        backup_type (google.cloud.bigtable.admin_v2.types.Backup.BackupType):
...
class SchemaBundle(proto.Message):
    ...
    Attributes:
        ...
        proto_schema (google.cloud.bigtable.admin_v2.types.ProtoSchema):
