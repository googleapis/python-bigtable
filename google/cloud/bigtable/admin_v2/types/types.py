...
class Type(proto.Message):
    ...
    Attributes:
        bytes_type (google.cloud.bigtable.admin_v2.types.Type.Bytes):
            Bytes

            This field is a member of `oneof`_ ``kind``.
        string_type (google.cloud.bigtable.admin_v2.types.Type.String):
            String

            This field is a member of `oneof`_ ``kind``.
        int64_type (google.cloud.bigtable.admin_v2.types.Type.Int64):
            Int64

            This field is a member of `oneof`_ ``kind``.
        float32_type (google.cloud.bigtable.admin_v2.types.Type.Float32):
            Float32

            This field is a member of `oneof`_ ``kind``.
        float64_type (google.cloud.bigtable.admin_v2.types.Type.Float64):
            Float64

            This field is a member of `oneof`_ ``kind``.
        bool_type (google.cloud.bigtable.admin_v2.types.Type.Bool):
            Bool

            This field is a member of `oneof`_ ``kind``.
        timestamp_type (google.cloud.bigtable.admin_v2.types.Type.Timestamp):
            Timestamp
        ...
        date_type (google.cloud.bigtable.admin_v2.types.Type.Date):
            ...
            This field is a member of `oneof`_ ``kind``.
        aggregate_type (google.cloud.bigtable.admin_v2.types.Type.Aggregate):
            Aggregate

            This field is a member of `oneof`_ ``kind``.
        struct_type (google.cloud.bigtable.admin_v2.types.Type.Struct):
            Struct

            This field is a member of `oneof`_ ``kind``.
        array_type (google.cloud.bigtable.admin_v2.types.Type.Array):
            Array

            This field is a member of `oneof`_ ``kind``.
        map_type (google.cloud.bigtable.admin_v2.types.Type.Map):
            Map

            This field is a member of `oneof`_ ``kind``.
        proto_type (google.cloud.bigtable.admin_v2.types.Type.Proto):
            Proto

            This field is a member of `oneof`_ ``kind``.
        enum_type (google.cloud.bigtable.admin_v2.types.Type.Enum):
            Enum
    ...
    class Bytes(proto.Message):
        ...
        Attributes:
            encoding (google.cloud.bigtable.admin_v2.types.Type.Bytes.Encoding):
        ...
        class Encoding(proto.Message):
            ...
            Attributes:
                raw (google.cloud.bigtable.admin_v2.types.Type.Bytes.Encoding.Raw):
                    Use ``Raw`` encoding.
    ...
    class String(proto.Message):
        ...
        Attributes:
            encoding (google.cloud.bigtable.admin_v2.types.Type.String.Encoding):
                The encoding to use when converting to or
                from lower level types.
        """
        ...
        class Encoding(proto.Message):
            ...
            Attributes:
                utf8_raw (google.cloud.bigtable.admin_v2.types.Type.String.Encoding.Utf8Raw):
                    Deprecated: if set, converts to an empty ``utf8_bytes``.

                    This field is a member of `oneof`_ ``encoding``.
                utf8_bytes (google.cloud.bigtable.admin_v2.types.Type.String.Encoding.Utf8Bytes):
    ...
    class Int64(proto.Message):
        ...
        Attributes:
            encoding (google.cloud.bigtable.admin_v2.types.Type.Int64.Encoding):
                The encoding to use when converting to or
                from lower level types.
        """
        ...
        class Encoding(proto.Message):
            ...
            Attributes:
                big_endian_bytes (google.cloud.bigtable.admin_v2.types.Type.Int64.Encoding.BigEndianBytes):
                    ...
                    This field is a member of `oneof`_ ``encoding``.
                ordered_code_bytes (google.cloud.bigtable.admin_v2.types.Type.Int64.Encoding.OrderedCodeBytes):
    ...
    class Timestamp(proto.Message):
        ...
        Attributes:
            encoding (google.cloud.bigtable.admin_v2.types.Type.Timestamp.Encoding):
                The encoding to use when converting to or
                from lower level types.
        """
        ...
        class Encoding(proto.Message):
            ...
            Attributes:
                unix_micros_int64 (google.cloud.bigtable.admin_v2.types.Type.Int64.Encoding):
    ...
    class Struct(proto.Message):
        ...
        Attributes:
            fields (MutableSequence[google.cloud.bigtable.admin_v2.types.Type.Struct.Field]):
        ...
        class Field(proto.Message):
            ...
            Attributes:
                ...
                type_ (google.cloud.bigtable.admin_v2.types.Type):
        ...
        class Encoding(proto.Message):
            ...
            Attributes:
                singleton (google.cloud.bigtable.admin_v2.types.Type.Struct.Encoding.Singleton):
                    Use ``Singleton`` encoding.

                    This field is a member of `oneof`_ ``encoding``.
                delimited_bytes (google.cloud.bigtable.admin_v2.types.Type.Struct.Encoding.DelimitedBytes):
                    Use ``DelimitedBytes`` encoding.

                    This field is a member of `oneof`_ ``encoding``.
                ordered_code_bytes (google.cloud.bigtable.admin_v2.types.Type.Struct.Encoding.OrderedCodeBytes):
    ...
    class Array(proto.Message):
        ...
        Attributes:
            element_type (google.cloud.bigtable.admin_v2.types.Type):
    ...
    class Map(proto.Message):
        ...
        Attributes:
            key_type (google.cloud.bigtable.admin_v2.types.Type):
                The type of a map key. Only ``Bytes``, ``String``, and
                ``Int64`` are allowed as key types.
            value_type (google.cloud.bigtable.admin_v2.types.Type):
    ...
    class Aggregate(proto.Message):
        ...
        Attributes:
            input_type (google.cloud.bigtable.admin_v2.types.Type):
            ...
            state_type (google.cloud.bigtable.admin_v2.types.Type):
            ...
            sum (google.cloud.bigtable.admin_v2.types.Type.Aggregate.Sum):
                Sum aggregator.

                This field is a member of `oneof`_ ``aggregator``.
            hllpp_unique_count (google.cloud.bigtable.admin_v2.types.Type.Aggregate.HyperLogLogPlusPlusUniqueCount):
                HyperLogLogPlusPlusUniqueCount aggregator.

                This field is a member of `oneof`_ ``aggregator``.
            max_ (google.cloud.bigtable.admin_v2.types.Type.Aggregate.Max):
                Max aggregator.

                This field is a member of `oneof`_ ``aggregator``.
            min_ (google.cloud.bigtable.admin_v2.types.Type.Aggregate.Min):
                Min aggregator.
