...
class ListAppProfilesAsyncPager:
    ...
    @property
    async def pages(self) -> AsyncIterator[bigtable_instance_admin.ListAppProfilesResponse]:
        yield self._response
        while self._response.next_page_token:
            self._request.page_token = self._response.next_page_token
...
class ListHotTabletsAsyncPager:
    ...
    """
    def __init__(self,
            method: Callable[..., Awaitable[bigtable_instance_admin.ListHotTabletsResponse]],
            request: bigtable_instance_admin.ListHotTabletsRequest,
            response: bigtable_instance_admin.ListHotTabletsResponse,
            *,
            retry: OptionalAsyncRetry = gapic_v1.method.DEFAULT,
    ...
    @property
    async def pages(self) -> AsyncIterator[bigtable_instance_admin.ListHotTabletsResponse]:
        yield self._response
        while self._response.next_page_token:
            self._request.page_token = self._response.next_page_token
            self._response = await self._method(self._request, retry=self._retry, timeout=self._timeout, metadata=self._metadata)
...
class ListLogicalViewsAsyncPager:
    ...
    """
    def __init__(self,
            method: Callable[..., Awaitable[bigtable_instance_admin.ListLogicalViewsResponse]],
            request: bigtable_instance_admin.ListLogicalViewsRequest,
            response: bigtable_instance_admin.ListLogicalViewsResponse,
            *,
            retry: OptionalAsyncRetry = gapic_v1.method.DEFAULT,
    ...
    @property
    async def pages(self) -> AsyncIterator[bigtable_instance_admin.ListLogicalViewsResponse]:
        yield self._response
        while self._response.next_page_token:
            self._request.page_token = self._response.next_page_token
            self._response = await self._method(self._request, retry=self._retry, timeout=self._timeout, metadata=self._metadata)
...
class ListMaterializedViewsAsyncPager:
    ...
    """
    def __init__(self,
            method: Callable[..., Awaitable[bigtable_instance_admin.ListMaterializedViewsResponse]],
            request: bigtable_instance_admin.ListMaterializedViewsRequest,
            response: bigtable_instance_admin.ListMaterializedViewsResponse,
            *,
            retry: OptionalAsyncRetry = gapic_v1.method.DEFAULT,
    ...
    @property
    async def pages(self) -> AsyncIterator[bigtable_instance_admin.ListMaterializedViewsResponse]:
        yield self._response
        while self._response.next_page_token:
            self._request.page_token = self._response.next_page_token
            self._response = await self._method(self._request, retry=self._retry, timeout=self._timeout, metadata=self._metadata)
