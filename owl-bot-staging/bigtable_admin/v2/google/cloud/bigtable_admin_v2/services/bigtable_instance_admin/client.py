...
class BigtableInstanceAdminClient(metaclass=BigtableInstanceAdminClientMeta):
    ...
    @staticmethod
    def hot_tablet_path(project: str,instance: str,cluster: str,hot_tablet: str,) -> str:
        """Returns a fully-qualified hot_tablet string."""
        return "projects/{project}/instances/{instance}/clusters/{cluster}/hotTablets/{hot_tablet}".format(project=project, instance=instance, cluster=cluster, hot_tablet=hot_tablet, )

    @staticmethod
    def parse_hot_tablet_path(path: str) -> Dict[str,str]:
        """Parses a hot_tablet path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/instances/(?P<instance>.+?)/clusters/(?P<cluster>.+?)/hotTablets/(?P<hot_tablet>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    @staticmethod
    def logical_view_path(project: str,instance: str,logical_view: str,) -> str:
        """Returns a fully-qualified logical_view string."""
        return "projects/{project}/instances/{instance}/logicalViews/{logical_view}".format(project=project, instance=instance, logical_view=logical_view, )

    @staticmethod
    def parse_logical_view_path(path: str) -> Dict[str,str]:
        """Parses a logical_view path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/instances/(?P<instance>.+?)/logicalViews/(?P<logical_view>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def materialized_view_path(project: str,instance: str,materialized_view: str,) -> str:
        """Returns a fully-qualified materialized_view string."""
        return "projects/{project}/instances/{instance}/materializedViews/{materialized_view}".format(project=project, instance=instance, materialized_view=materialized_view, )

    @staticmethod
    def parse_materialized_view_path(path: str) -> Dict[str,str]:
        """Parses a materialized_view path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/instances/(?P<instance>.+?)/materializedViews/(?P<materialized_view>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = BigtableInstanceAdminClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, BigtableInstanceAdminTransport, Callable[..., BigtableInstanceAdminTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = BigtableInstanceAdminClient._read_environment_variables()
        self._client_cert_source = BigtableInstanceAdminClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = BigtableInstanceAdminClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[BigtableInstanceAdminTransport], Callable[..., BigtableInstanceAdminTransport]] = (
    ...
    def partial_update_cluster(self,
