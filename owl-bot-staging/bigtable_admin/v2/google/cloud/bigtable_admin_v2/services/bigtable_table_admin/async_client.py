...
class BigtableTableAdminAsyncClient:
    ...
    parse_authorized_view_path = staticmethod(BigtableTableAdminClient.parse_authorized_view_path)
    ...
    crypto_key_version_path = staticmethod(BigtableTableAdminClient.crypto_key_version_path)
    parse_crypto_key_version_path = staticmethod(BigtableTableAdminClient.parse_crypto_key_version_path)
    ...
    parse_schema_bundle_path = staticmethod(BigtableTableAdminClient.parse_schema_bundle_path)
