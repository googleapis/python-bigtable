...
class BaseBigtableTableAdminAsyncClient:
    ...
    authorized_view_path = staticmethod(BaseBigtableTableAdminClient.authorized_view_path)
    parse_authorized_view_path = staticmethod(BaseBigtableTableAdminClient.parse_authorized_view_path)
    ...
    crypto_key_version_path = staticmethod(BaseBigtableTableAdminClient.crypto_key_version_path)
    parse_crypto_key_version_path = staticmethod(BaseBigtableTableAdminClient.parse_crypto_key_version_path)
    ...
    parse_schema_bundle_path = staticmethod(BaseBigtableTableAdminClient.parse_schema_bundle_path)
    ...
    common_billing_account_path = staticmethod(BaseBigtableTableAdminClient.common_billing_account_path)
    parse_common_billing_account_path = staticmethod(BaseBigtableTableAdminClient.parse_common_billing_account_path)
    common_folder_path = staticmethod(BaseBigtableTableAdminClient.common_folder_path)
    parse_common_folder_path = staticmethod(BaseBigtableTableAdminClient.parse_common_folder_path)
    common_organization_path = staticmethod(BaseBigtableTableAdminClient.common_organization_path)
    parse_common_organization_path = staticmethod(BaseBigtableTableAdminClient.parse_common_organization_path)
    common_project_path = staticmethod(BaseBigtableTableAdminClient.common_project_path)
    parse_common_project_path = staticmethod(BaseBigtableTableAdminClient.parse_common_project_path)
    common_location_path = staticmethod(BaseBigtableTableAdminClient.common_location_path)
    parse_common_location_path = staticmethod(BaseBigtableTableAdminClient.parse_common_location_path)
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, BigtableTableAdminTransport, Callable[..., BigtableTableAdminTransport]]] = "grpc_asyncio",
    ...
    async def create_table(self,
        ...
        .. code-block:: python
            ...
            async def sample_create_table():
                # Create a client
                client = bigtable_admin_v2.BaseBigtableTableAdminAsyncClient()
    ...
    async def create_table_from_snapshot(self,
            request: Optional[Union[bigtable_table_admin.CreateTableFromSnapshotRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
            table_id: Optional[str] = None,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.create_table_from_snapshot]
    ...
    async def undelete_table(self,
            request: Optional[Union[bigtable_table_admin.UndeleteTableRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.undelete_table]
    ...
    async def create_authorized_view(self,
            request: Optional[Union[bigtable_table_admin.CreateAuthorizedViewRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.create_authorized_view]
    ...
    async def list_authorized_views(self,
            request: Optional[Union[bigtable_table_admin.ListAuthorizedViewsRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_authorized_views]
    ...
    async def get_authorized_view(self,
            request: Optional[Union[bigtable_table_admin.GetAuthorizedViewRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_authorized_view]
    ...
    async def update_authorized_view(self,
            request: Optional[Union[bigtable_table_admin.UpdateAuthorizedViewRequest, dict]] = None,
            *,
            authorized_view: Optional[table.AuthorizedView] = None,
            update_mask: Optional[field_mask_pb2.FieldMask] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.update_authorized_view]
    ...
    async def delete_authorized_view(self,
            request: Optional[Union[bigtable_table_admin.DeleteAuthorizedViewRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
    ...
    async def modify_column_families(self,
            request: Optional[Union[bigtable_table_admin.ModifyColumnFamiliesRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            modifications: Optional[MutableSequence[bigtable_table_admin.ModifyColumnFamiliesRequest.Modification]] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
            ) -> table.Table:
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.modify_column_families]
    ...
    async def drop_row_range(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.drop_row_range]
    ...
    async def generate_consistency_token(self,
            request: Optional[Union[bigtable_table_admin.GenerateConsistencyTokenRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.generate_consistency_token]
    ...
    async def check_consistency(self,
            request: Optional[Union[bigtable_table_admin.CheckConsistencyRequest, dict]] = None,
            *,
            name: Optional[str] = None,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.check_consistency]
    ...
    async def snapshot_table(self,
            request: Optional[Union[bigtable_table_admin.SnapshotTableRequest, dict]] = None,
            *,
            name: Optional[str] = None,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.snapshot_table]
    ...
    async def list_snapshots(self,
            request: Optional[Union[bigtable_table_admin.ListSnapshotsRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
    ...
    async def delete_snapshot(self,
            request: Optional[Union[bigtable_table_admin.DeleteSnapshotRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
    ...
    async def create_schema_bundle(self,
            request: Optional[Union[bigtable_table_admin.CreateSchemaBundleRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.create_schema_bundle]
    ...
    async def update_schema_bundle(self,
            request: Optional[Union[bigtable_table_admin.UpdateSchemaBundleRequest, dict]] = None,
            *,
            schema_bundle: Optional[table.SchemaBundle] = None,
            update_mask: Optional[field_mask_pb2.FieldMask] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.update_schema_bundle]
    ...
    async def get_schema_bundle(self,
            request: Optional[Union[bigtable_table_admin.GetSchemaBundleRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_schema_bundle]
    ...
    async def list_schema_bundles(self,
            request: Optional[Union[bigtable_table_admin.ListSchemaBundlesRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_schema_bundles]
    ...
    async def delete_schema_bundle(self,
            request: Optional[Union[bigtable_table_admin.DeleteSchemaBundleRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.delete_schema_bundle]
