...
class BigtableTableAdminClient(metaclass=BigtableTableAdminClientMeta):
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            BigtableTableAdminClient._compare_universes(self.universe_domain, self.transport._credentials))
    ...
    def create_authorized_view(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a bigtable_table_admin.CreateAuthorizedViewRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def list_authorized_views(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a bigtable_table_admin.ListAuthorizedViewsRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def get_authorized_view(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a bigtable_table_admin.GetAuthorizedViewRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def update_authorized_view(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a bigtable_table_admin.UpdateAuthorizedViewRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def delete_authorized_view(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a bigtable_table_admin.DeleteAuthorizedViewRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
