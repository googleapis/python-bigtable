...
class BaseBigtableTableAdminClient(metaclass=BaseBigtableTableAdminClientMeta):
    ...
    @staticmethod
    def authorized_view_path(project: str,instance: str,table: str,authorized_view: str,) -> str:
        """Returns a fully-qualified authorized_view string."""
        return "projects/{project}/instances/{instance}/tables/{table}/authorizedViews/{authorized_view}".format(project=project, instance=instance, table=table, authorized_view=authorized_view, )

    @staticmethod
    def parse_authorized_view_path(path: str) -> Dict[str,str]:
        """Parses a authorized_view path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/instances/(?P<instance>.+?)/tables/(?P<table>.+?)/authorizedViews/(?P<authorized_view>.+?)$", path)
    ...
    @staticmethod
    def schema_bundle_path(project: str,instance: str,table: str,schema_bundle: str,) -> str:
        """Returns a fully-qualified schema_bundle string."""
        return "projects/{project}/instances/{instance}/tables/{table}/schemaBundles/{schema_bundle}".format(project=project, instance=instance, table=table, schema_bundle=schema_bundle, )

    @staticmethod
    def parse_schema_bundle_path(path: str) -> Dict[str,str]:
        """Parses a schema_bundle path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/instances/(?P<instance>.+?)/tables/(?P<table>.+?)/schemaBundles/(?P<schema_bundle>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = BaseBigtableTableAdminClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, BigtableTableAdminTransport, Callable[..., BigtableTableAdminTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = BaseBigtableTableAdminClient._read_environment_variables()
        self._client_cert_source = BaseBigtableTableAdminClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = BaseBigtableTableAdminClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[BigtableTableAdminTransport], Callable[..., BigtableTableAdminTransport]] = (
    ...
    def create_table(self,
        ...
        .. code-block:: python
            ...
            def sample_create_table():
                # Create a client
                client = bigtable_admin_v2.BaseBigtableTableAdminClient()
    ...
    def create_table_from_snapshot(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.create_table_from_snapshot]
    ...
    def create_authorized_view(self,
    ...
    def list_authorized_views(self,
    ...
    def update_authorized_view(self,
    ...
    def delete_authorized_view(self,
    ...
    def generate_consistency_token(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.generate_consistency_token]
