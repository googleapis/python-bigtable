...
class BigtableTableAdminGrpcAsyncIOTransport(BigtableTableAdminTransport):
    ...
    def create_table_from_snapshot(self) -> Callable[
        ...
        if 'create_table_from_snapshot' not in self._stubs:
            self._stubs['create_table_from_snapshot'] = self._logged_channel.unary_unary(
    ...
    def get_authorized_view(self) -> Callable[
            ...
            Awaitable[table.AuthorizedView]]:
    ...
    def generate_consistency_token(self) -> Callable[
        ...
        if 'generate_consistency_token' not in self._stubs:
            self._stubs['generate_consistency_token'] = self._logged_channel.unary_unary(
