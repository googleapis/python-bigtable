...
def test__read_environment_variables():
    assert BigtableInstanceAdminClient._read_environment_variables() == (False, "auto", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert BigtableInstanceAdminClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert BigtableInstanceAdminClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert BigtableInstanceAdminClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert BigtableInstanceAdminClient._read_environment_variables() == (False, "auto", "foo.com")
...
def test__get_client_cert_source():
    ...
    assert BigtableInstanceAdminClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert BigtableInstanceAdminClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch('google.auth.transport.mtls.has_default_client_cert_source', return_value=True):
        with mock.patch('google.auth.transport.mtls.default_client_cert_source', return_value=mock_default_cert_source):
            assert BigtableInstanceAdminClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert BigtableInstanceAdminClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source

@mock.patch.object(BigtableInstanceAdminClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(BigtableInstanceAdminClient))
@mock.patch.object(BigtableInstanceAdminAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(BigtableInstanceAdminAsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = BigtableInstanceAdminClient._DEFAULT_UNIVERSE
    default_endpoint = BigtableInstanceAdminClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = BigtableInstanceAdminClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert BigtableInstanceAdminClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert BigtableInstanceAdminClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == BigtableInstanceAdminClient.DEFAULT_MTLS_ENDPOINT
    assert BigtableInstanceAdminClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert BigtableInstanceAdminClient._get_api_endpoint(None, None, default_universe, "always") == BigtableInstanceAdminClient.DEFAULT_MTLS_ENDPOINT
    assert BigtableInstanceAdminClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == BigtableInstanceAdminClient.DEFAULT_MTLS_ENDPOINT
    assert BigtableInstanceAdminClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert BigtableInstanceAdminClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        BigtableInstanceAdminClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert BigtableInstanceAdminClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert BigtableInstanceAdminClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert BigtableInstanceAdminClient._get_universe_domain(None, None) == BigtableInstanceAdminClient._DEFAULT_UNIVERSE
...
def test_bigtable_instance_admin_client_from_service_account_info(client_class, transport_name):
...
def test_bigtable_instance_admin_client_service_account_always_use_jwt(transport_class, transport_name):
...
def test_bigtable_instance_admin_client_from_service_account_file(client_class, transport_name):
    creds = ga_credentials.AnonymousCredentials()
...
@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    ...
    (BigtableInstanceAdminClient, transports.BigtableInstanceAdminRestTransport, "rest"),
])
@mock.patch.object(BigtableInstanceAdminClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(BigtableInstanceAdminClient))
@mock.patch.object(BigtableInstanceAdminAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(BigtableInstanceAdminAsyncClient))
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    ...
    (BigtableInstanceAdminClient, transports.BigtableInstanceAdminRestTransport, "rest", "true"),
    (BigtableInstanceAdminClient, transports.BigtableInstanceAdminRestTransport, "rest", "false"),
])
@mock.patch.object(BigtableInstanceAdminClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(BigtableInstanceAdminClient))
@mock.patch.object(BigtableInstanceAdminAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(BigtableInstanceAdminAsyncClient))
...
@pytest.mark.parametrize("client_class", [
    BigtableInstanceAdminClient, BigtableInstanceAdminAsyncClient
])
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    (BigtableInstanceAdminClient, transports.BigtableInstanceAdminGrpcTransport, "grpc", grpc_helpers),
    (BigtableInstanceAdminAsyncClient, transports.BigtableInstanceAdminGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
    (BigtableInstanceAdminClient, transports.BigtableInstanceAdminRestTransport, "rest", None),
])
def test_bigtable_instance_admin_client_client_options_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
...
def test_bigtable_instance_admin_client_create_channel_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
    # Check the case credentials file is provided.
    options = client_options.ClientOptions(
        credentials_file="credentials.json"
    )
...
def test_partial_update_instance_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.partial_update_instance in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.partial_update_instance] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_partial_update_instance_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = BigtableInstanceAdminAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.partial_update_instance in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.partial_update_instance] = mock_rpc
...
def test_get_cluster(request_type, transport: str = 'grpc'):
    ...
    assert response.node_scaling_factor == instance.Cluster.NodeScalingFactor.NODE_SCALING_FACTOR_1X
...
def test_partial_update_cluster(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.partial_update_cluster),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_partial_update_cluster_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.partial_update_cluster in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.partial_update_cluster] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_partial_update_cluster_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = BigtableInstanceAdminAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.partial_update_cluster in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.partial_update_cluster] = mock_rpc
...
@pytest.mark.asyncio
async def test_partial_update_cluster_async(transport: str = 'grpc_asyncio', request_type=bigtable_instance_admin.PartialUpdateClusterRequest):
    client = BigtableInstanceAdminAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_create_app_profile_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.create_app_profile in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.create_app_profile] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_create_app_profile_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = BigtableInstanceAdminAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.create_app_profile in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_app_profile] = mock_rpc
...
@pytest.mark.asyncio
async def test_get_app_profile_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = BigtableInstanceAdminAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_app_profile in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_app_profile] = mock_rpc
...
def test_list_app_profiles_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_app_profiles] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_app_profiles_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = BigtableInstanceAdminAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_app_profiles in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_app_profiles] = mock_rpc
...
def test_update_app_profile_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.update_app_profile in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.update_app_profile] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_update_app_profile_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = BigtableInstanceAdminAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.update_app_profile in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.update_app_profile] = mock_rpc
...
def test_delete_app_profile_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.delete_app_profile in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.delete_app_profile] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_delete_app_profile_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = BigtableInstanceAdminAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_app_profile in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.delete_app_profile] = mock_rpc
...
def test_list_hot_tablets(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.list_hot_tablets),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_list_hot_tablets_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_hot_tablets] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_hot_tablets_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = BigtableInstanceAdminAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_hot_tablets in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_hot_tablets] = mock_rpc
...
@pytest.mark.asyncio
async def test_list_hot_tablets_async(transport: str = 'grpc_asyncio', request_type=bigtable_instance_admin.ListHotTabletsRequest):
    client = BigtableInstanceAdminAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(bigtable_instance_admin.ListHotTabletsResponse(
            next_page_token='next_page_token_value',
        ))
...
def test_list_hot_tablets_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, instance.HotTablet)
                   for i in results)
...
def test_create_logical_view(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_logical_view),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
        response = client.create_logical_view(request)
...
def test_create_logical_view_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = BigtableInstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_create_logical_view_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.create_logical_view in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.create_logical_view] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_create_logical_view_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = BigtableInstanceAdminAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.create_logical_view in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_logical_view] = mock_rpc

        request = {}
        await client.create_logical_view(request)
...
@pytest.mark.asyncio
async def test_create_logical_view_async(transport: str = 'grpc_asyncio', request_type=bigtable_instance_admin.CreateLogicalViewRequest):
    client = BigtableInstanceAdminAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
        ...
        response = await client.create_logical_view(request)
...
@pytest.mark.asyncio
async def test_create_logical_view_field_headers_async():
    client = BigtableInstanceAdminAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_create_logical_view_flattened():
    client = BigtableInstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
    ...
    with mock.patch.object(
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        client.create_logical_view(
            parent='parent_value',
            logical_view=instance.LogicalView(name='name_value'),
            logical_view_id='logical_view_id_value',
        )
        ...
        mock_val = 'parent_value'
        assert arg == mock_val
        arg = args[0].logical_view
        mock_val = instance.LogicalView(name='name_value')
        assert arg == mock_val
        arg = args[0].logical_view_id
        mock_val = 'logical_view_id_value'
        assert arg == mock_val


def test_create_logical_view_flattened_error():
    client = BigtableInstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_create_logical_view_flattened_async():
    client = BigtableInstanceAdminAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    with mock.patch.object(
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        response = await client.create_logical_view(
            parent='parent_value',
            logical_view=instance.LogicalView(name='name_value'),
            logical_view_id='logical_view_id_value',
        )
...
@pytest.mark.asyncio
async def test_create_logical_view_flattened_error_async():
    client = BigtableInstanceAdminAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    # fields is an error.
    with pytest.raises(ValueError):
        await client.create_logical_view(
            bigtable_instance_admin.CreateLogicalViewRequest(),
            parent='parent_value',
            logical_view=instance.LogicalView(name='name_value'),
            logical_view_id='logical_view_id_value',
...
def test_get_logical_view(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_logical_view),
            '__call__') as call:
        # Designate an appropriate return value for the call.
    ...
    # Establish that the response is the type that we expect.
    assert isinstance(response, instance.LogicalView)
    assert response.name == 'name_value'
...
def test_get_logical_view_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.get_logical_view in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.get_logical_view] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_get_logical_view_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = BigtableInstanceAdminAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_logical_view in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_logical_view] = mock_rpc

        request = {}
        await client.get_logical_view(request)
...
@pytest.mark.asyncio
async def test_get_logical_view_async(transport: str = 'grpc_asyncio', request_type=bigtable_instance_admin.GetLogicalViewRequest):
    client = BigtableInstanceAdminAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_get_logical_view_field_headers_async():
    client = BigtableInstanceAdminAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_get_logical_view_flattened():
    client = BigtableInstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
def test_get_logical_view_flattened_error():
    client = BigtableInstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_get_logical_view_flattened_async():
    client = BigtableInstanceAdminAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    with mock.patch.object(
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        response = await client.get_logical_view(
            name='name_value',
        )
...
@pytest.mark.asyncio
async def test_get_logical_view_flattened_error_async():
    client = BigtableInstanceAdminAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_list_logical_views(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.list_logical_views),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = bigtable_instance_admin.ListLogicalViewsResponse(
            next_page_token='next_page_token_value',
        )
        response = client.list_logical_views(request)
    ...
    # Establish that the response is the type that we expect.
    assert isinstance(response, pagers.ListLogicalViewsPager)
    assert response.next_page_token == 'next_page_token_value'


def test_list_logical_views_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = BigtableInstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_list_logical_views_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.list_logical_views in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_logical_views] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_logical_views_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = BigtableInstanceAdminAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_logical_views in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_logical_views] = mock_rpc
...
@pytest.mark.asyncio
async def test_list_logical_views_async(transport: str = 'grpc_asyncio', request_type=bigtable_instance_admin.ListLogicalViewsRequest):
    client = BigtableInstanceAdminAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(bigtable_instance_admin.ListLogicalViewsResponse(
            next_page_token='next_page_token_value',
        ))
        response = await client.list_logical_views(request)
...
@pytest.mark.asyncio
async def test_list_logical_views_field_headers_async():
    client = BigtableInstanceAdminAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_list_logical_views_flattened():
    client = BigtableInstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
def test_list_logical_views_flattened_error():
    client = BigtableInstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_list_logical_views_flattened_async():
    client = BigtableInstanceAdminAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    with mock.patch.object(
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        response = await client.list_logical_views(
            parent='parent_value',
        )
...
@pytest.mark.asyncio
async def test_list_logical_views_flattened_error_async():
    client = BigtableInstanceAdminAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    # fields is an error.
    with pytest.raises(ValueError):
        await client.list_logical_views(
            bigtable_instance_admin.ListLogicalViewsRequest(),
            parent='parent_value',
        )


def test_list_logical_views_pager(transport_name: str = "grpc"):
    client = BigtableInstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport_name,
    )
    ...
    with mock.patch.object(
        ...
        pager = client.list_logical_views(request={}, retry=retry, timeout=timeout)
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, instance.LogicalView)
                   for i in results)
def test_list_logical_views_pages(transport_name: str = "grpc"):
    client = BigtableInstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport_name,
    )
    ...
    with mock.patch.object(
        ...
        pages = list(client.list_logical_views(request={}).pages)
        for page_, token in zip(pages, ['abc','def','ghi', '']):
            assert page_.raw_page.next_page_token == token

@pytest.mark.asyncio
async def test_list_logical_views_async_pager():
    client = BigtableInstanceAdminAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_logical_views(request={},)
        assert async_pager.next_page_token == 'abc'
        responses = []
        async for response in async_pager: # pragma: no branch
            responses.append(response)
...
@pytest.mark.asyncio
async def test_list_logical_views_async_pages():
    client = BigtableInstanceAdminAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_update_logical_view(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_logical_view),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
        response = client.update_logical_view(request)
...
def test_update_logical_view_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = BigtableInstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_update_logical_view_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.update_logical_view in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.update_logical_view] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_update_logical_view_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = BigtableInstanceAdminAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.update_logical_view in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.update_logical_view] = mock_rpc

        request = {}
        await client.update_logical_view(request)
...
@pytest.mark.asyncio
async def test_update_logical_view_async(transport: str = 'grpc_asyncio', request_type=bigtable_instance_admin.UpdateLogicalViewRequest):
    client = BigtableInstanceAdminAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
        ...
        response = await client.update_logical_view(request)
...
def test_update_logical_view_field_headers():
    ...
    request.logical_view.name = 'name_value'
    ...
    assert (
        'x-goog-request-params',
        'logical_view.name=name_value',
    ) in kw['metadata']


@pytest.mark.asyncio
async def test_update_logical_view_field_headers_async():
    client = BigtableInstanceAdminAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_update_logical_view_flattened():
    client = BigtableInstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
def test_update_logical_view_flattened_error():
    client = BigtableInstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_update_logical_view_flattened_async():
    client = BigtableInstanceAdminAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    with mock.patch.object(
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        response = await client.update_logical_view(
            logical_view=instance.LogicalView(name='name_value'),
            update_mask=field_mask_pb2.FieldMask(paths=['paths_value']),
        )
...
@pytest.mark.asyncio
async def test_update_logical_view_flattened_error_async():
    client = BigtableInstanceAdminAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    # fields is an error.
    with pytest.raises(ValueError):
        await client.update_logical_view(
            bigtable_instance_admin.UpdateLogicalViewRequest(),
            logical_view=instance.LogicalView(name='name_value'),
            update_mask=field_mask_pb2.FieldMask(paths=['paths_value']),
        )
...
def test_delete_logical_view(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_logical_view),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = None
        response = client.delete_logical_view(request)
...
def test_delete_logical_view_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.delete_logical_view in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.delete_logical_view] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_delete_logical_view_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = BigtableInstanceAdminAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_logical_view in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.delete_logical_view] = mock_rpc

        request = {}
        await client.delete_logical_view(request)
...
@pytest.mark.asyncio
async def test_delete_logical_view_async(transport: str = 'grpc_asyncio', request_type=bigtable_instance_admin.DeleteLogicalViewRequest):
    client = BigtableInstanceAdminAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
        ...
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(None)
        response = await client.delete_logical_view(request)
...
@pytest.mark.asyncio
async def test_delete_logical_view_field_headers_async():
    client = BigtableInstanceAdminAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_delete_logical_view_flattened():
    client = BigtableInstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
def test_delete_logical_view_flattened_error():
    client = BigtableInstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_delete_logical_view_flattened_async():
    client = BigtableInstanceAdminAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    with mock.patch.object(
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        response = await client.delete_logical_view(
            name='name_value',
        )
...
@pytest.mark.asyncio
async def test_delete_logical_view_flattened_error_async():
    client = BigtableInstanceAdminAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    # fields is an error.
    with pytest.raises(ValueError):
        await client.delete_logical_view(
            bigtable_instance_admin.DeleteLogicalViewRequest(),
            name='name_value',
        )
...
def test_create_materialized_view(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_materialized_view),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
        response = client.create_materialized_view(request)
...
def test_create_materialized_view_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = BigtableInstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_create_materialized_view_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.create_materialized_view in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.create_materialized_view] = mock_rpc
        request = {}
        client.create_materialized_view(request)
...
@pytest.mark.asyncio
async def test_create_materialized_view_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = BigtableInstanceAdminAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.create_materialized_view in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_materialized_view] = mock_rpc

        request = {}
        await client.create_materialized_view(request)
...
@pytest.mark.asyncio
async def test_create_materialized_view_async(transport: str = 'grpc_asyncio', request_type=bigtable_instance_admin.CreateMaterializedViewRequest):
    client = BigtableInstanceAdminAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
        ...
        response = await client.create_materialized_view(request)
...
@pytest.mark.asyncio
async def test_create_materialized_view_field_headers_async():
    client = BigtableInstanceAdminAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_create_materialized_view_flattened():
    client = BigtableInstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
    ...
    with mock.patch.object(
        ...
        client.create_materialized_view(
            parent='parent_value',
            materialized_view=instance.MaterializedView(name='name_value'),
            materialized_view_id='materialized_view_id_value',
        )
        ...
        mock_val = 'parent_value'
        assert arg == mock_val
        arg = args[0].materialized_view
        mock_val = instance.MaterializedView(name='name_value')
        assert arg == mock_val
        arg = args[0].materialized_view_id
        mock_val = 'materialized_view_id_value'
        assert arg == mock_val


def test_create_materialized_view_flattened_error():
    client = BigtableInstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_create_materialized_view_flattened_async():
    client = BigtableInstanceAdminAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    with mock.patch.object(
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        response = await client.create_materialized_view(
            parent='parent_value',
            materialized_view=instance.MaterializedView(name='name_value'),
            materialized_view_id='materialized_view_id_value',
        )
...
@pytest.mark.asyncio
async def test_create_materialized_view_flattened_error_async():
    client = BigtableInstanceAdminAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_get_materialized_view(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_materialized_view),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = instance.MaterializedView(
            name='name_value',
            query='query_value',
            etag='etag_value',
            deletion_protection=True,
        )
        response = client.get_materialized_view(request)
    ...
    # Establish that the response is the type that we expect.
    assert isinstance(response, instance.MaterializedView)
    assert response.name == 'name_value'
    assert response.query == 'query_value'
    assert response.etag == 'etag_value'
    assert response.deletion_protection is True
...
def test_get_materialized_view_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = BigtableInstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_get_materialized_view_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.get_materialized_view in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.get_materialized_view] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_get_materialized_view_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = BigtableInstanceAdminAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_materialized_view in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_materialized_view] = mock_rpc

        request = {}
        await client.get_materialized_view(request)
...
@pytest.mark.asyncio
async def test_get_materialized_view_async(transport: str = 'grpc_asyncio', request_type=bigtable_instance_admin.GetMaterializedViewRequest):
    client = BigtableInstanceAdminAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(instance.MaterializedView(
            name='name_value',
            query='query_value',
            etag='etag_value',
            deletion_protection=True,
        ))
        response = await client.get_materialized_view(request)
...
@pytest.mark.asyncio
async def test_get_materialized_view_field_headers_async():
    client = BigtableInstanceAdminAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_get_materialized_view_flattened_error():
    client = BigtableInstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_get_materialized_view_flattened_async():
    client = BigtableInstanceAdminAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    with mock.patch.object(
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        response = await client.get_materialized_view(
            name='name_value',
        )
...
@pytest.mark.asyncio
async def test_get_materialized_view_flattened_error_async():
    client = BigtableInstanceAdminAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    # fields is an error.
    with pytest.raises(ValueError):
        await client.get_materialized_view(
            bigtable_instance_admin.GetMaterializedViewRequest(),
            name='name_value',
        )
...
def test_list_materialized_views(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.list_materialized_views),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = bigtable_instance_admin.ListMaterializedViewsResponse(
            next_page_token='next_page_token_value',
        )
        response = client.list_materialized_views(request)
    ...
    # Establish that the response is the type that we expect.
    assert isinstance(response, pagers.ListMaterializedViewsPager)
    assert response.next_page_token == 'next_page_token_value'
...
def test_list_materialized_views_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.list_materialized_views in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_materialized_views] = mock_rpc
        request = {}
        client.list_materialized_views(request)
...
@pytest.mark.asyncio
async def test_list_materialized_views_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = BigtableInstanceAdminAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_materialized_views in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_materialized_views] = mock_rpc
...
@pytest.mark.asyncio
async def test_list_materialized_views_async(transport: str = 'grpc_asyncio', request_type=bigtable_instance_admin.ListMaterializedViewsRequest):
    client = BigtableInstanceAdminAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(bigtable_instance_admin.ListMaterializedViewsResponse(
            next_page_token='next_page_token_value',
        ))
        response = await client.list_materialized_views(request)
...
@pytest.mark.asyncio
async def test_list_materialized_views_field_headers_async():
    client = BigtableInstanceAdminAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_list_materialized_views_flattened():
    client = BigtableInstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
def test_list_materialized_views_flattened_error():
    client = BigtableInstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_list_materialized_views_flattened_async():
    client = BigtableInstanceAdminAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    with mock.patch.object(
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        response = await client.list_materialized_views(
            parent='parent_value',
        )
...
@pytest.mark.asyncio
async def test_list_materialized_views_flattened_error_async():
    client = BigtableInstanceAdminAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    # fields is an error.
    with pytest.raises(ValueError):
        await client.list_materialized_views(
            bigtable_instance_admin.ListMaterializedViewsRequest(),
            parent='parent_value',
        )


def test_list_materialized_views_pager(transport_name: str = "grpc"):
    client = BigtableInstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport_name,
    )
    ...
    with mock.patch.object(
        ...
        pager = client.list_materialized_views(request={}, retry=retry, timeout=timeout)
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, instance.MaterializedView)
                   for i in results)
def test_list_materialized_views_pages(transport_name: str = "grpc"):
    client = BigtableInstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport_name,
    )
    ...
    with mock.patch.object(
        ...
        pages = list(client.list_materialized_views(request={}).pages)
        for page_, token in zip(pages, ['abc','def','ghi', '']):
            assert page_.raw_page.next_page_token == token

@pytest.mark.asyncio
async def test_list_materialized_views_async_pager():
    client = BigtableInstanceAdminAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_materialized_views(request={},)
        assert async_pager.next_page_token == 'abc'
        responses = []
        async for response in async_pager: # pragma: no branch
            responses.append(response)
...
@pytest.mark.asyncio
async def test_list_materialized_views_async_pages():
    client = BigtableInstanceAdminAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_update_materialized_view(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_materialized_view),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
        response = client.update_materialized_view(request)
...
def test_update_materialized_view_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = BigtableInstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_update_materialized_view_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.update_materialized_view in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.update_materialized_view] = mock_rpc
        request = {}
        client.update_materialized_view(request)
...
@pytest.mark.asyncio
async def test_update_materialized_view_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = BigtableInstanceAdminAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.update_materialized_view in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.update_materialized_view] = mock_rpc

        request = {}
        await client.update_materialized_view(request)
...
@pytest.mark.asyncio
async def test_update_materialized_view_async(transport: str = 'grpc_asyncio', request_type=bigtable_instance_admin.UpdateMaterializedViewRequest):
    client = BigtableInstanceAdminAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
        ...
        response = await client.update_materialized_view(request)
...
def test_update_materialized_view_field_headers():
    ...
    request.materialized_view.name = 'name_value'
    ...
    assert (
        'x-goog-request-params',
        'materialized_view.name=name_value',
    ) in kw['metadata']


@pytest.mark.asyncio
async def test_update_materialized_view_field_headers_async():
    client = BigtableInstanceAdminAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_update_materialized_view_flattened():
    client = BigtableInstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
    ...
    with mock.patch.object(
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        client.update_materialized_view(
            materialized_view=instance.MaterializedView(name='name_value'),
            update_mask=field_mask_pb2.FieldMask(paths=['paths_value']),
        )
...
def test_update_materialized_view_flattened_error():
    client = BigtableInstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_update_materialized_view_flattened_async():
    client = BigtableInstanceAdminAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    with mock.patch.object(
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        response = await client.update_materialized_view(
            materialized_view=instance.MaterializedView(name='name_value'),
            update_mask=field_mask_pb2.FieldMask(paths=['paths_value']),
        )
...
@pytest.mark.asyncio
async def test_update_materialized_view_flattened_error_async():
    client = BigtableInstanceAdminAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    # fields is an error.
    with pytest.raises(ValueError):
        await client.update_materialized_view(
            bigtable_instance_admin.UpdateMaterializedViewRequest(),
            materialized_view=instance.MaterializedView(name='name_value'),
            update_mask=field_mask_pb2.FieldMask(paths=['paths_value']),
        )
...
def test_delete_materialized_view(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_materialized_view),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = None
        response = client.delete_materialized_view(request)
...
def test_delete_materialized_view_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = BigtableInstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_delete_materialized_view_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.delete_materialized_view in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.delete_materialized_view] = mock_rpc
        request = {}
        client.delete_materialized_view(request)
...
@pytest.mark.asyncio
async def test_delete_materialized_view_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = BigtableInstanceAdminAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_materialized_view in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.delete_materialized_view] = mock_rpc

        request = {}
        await client.delete_materialized_view(request)
...
@pytest.mark.asyncio
async def test_delete_materialized_view_async(transport: str = 'grpc_asyncio', request_type=bigtable_instance_admin.DeleteMaterializedViewRequest):
    client = BigtableInstanceAdminAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
        ...
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(None)
        response = await client.delete_materialized_view(request)
...
@pytest.mark.asyncio
async def test_delete_materialized_view_field_headers_async():
    client = BigtableInstanceAdminAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_delete_materialized_view_flattened():
    client = BigtableInstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
def test_delete_materialized_view_flattened_error():
    client = BigtableInstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_delete_materialized_view_flattened_async():
    client = BigtableInstanceAdminAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    with mock.patch.object(
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        response = await client.delete_materialized_view(
            name='name_value',
        )
...
@pytest.mark.asyncio
async def test_delete_materialized_view_flattened_error_async():
    client = BigtableInstanceAdminAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    # fields is an error.
    with pytest.raises(ValueError):
        await client.delete_materialized_view(
            bigtable_instance_admin.DeleteMaterializedViewRequest(),
            name='name_value',
        )
...
def test_create_instance_rest_required_fields(request_type=bigtable_instance_admin.CreateInstanceRequest):
...
def test_create_instance_rest_unset_required_fields():
    transport = transports.BigtableInstanceAdminRestTransport(credentials=ga_credentials.AnonymousCredentials)

    unset_fields = transport.create_instance._get_unset_required_fields({})
    assert set(unset_fields) == (set(()) & set(("parent", "instanceId", "instance", "clusters", )))
...
def test_create_instance_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/v2/{parent=projects/*}/instances" % client.transport._host, args[1])
...
def test_get_instance_rest_required_fields(request_type=bigtable_instance_admin.GetInstanceRequest):
    transport_class = transports.BigtableInstanceAdminRestTransport
...
def test_get_instance_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2/{name=projects/*/instances/*}" % client.transport._host, args[1])
...
def test_list_instances_rest_required_fields(request_type=bigtable_instance_admin.ListInstancesRequest):
    transport_class = transports.BigtableInstanceAdminRestTransport
...
def test_partial_update_instance_rest_required_fields(request_type=bigtable_instance_admin.PartialUpdateInstanceRequest):
    transport_class = transports.BigtableInstanceAdminRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).partial_update_instance._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_partial_update_instance_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("updateMask", )) & set(("instance", "updateMask", )))
...
def test_partial_update_instance_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2/{instance.name=projects/*/instances/*}" % client.transport._host, args[1])
...
def test_delete_instance_rest_required_fields(request_type=bigtable_instance_admin.DeleteInstanceRequest):
    transport_class = transports.BigtableInstanceAdminRestTransport
...
def test_create_cluster_rest_required_fields(request_type=bigtable_instance_admin.CreateClusterRequest):
    transport_class = transports.BigtableInstanceAdminRestTransport
...
def test_create_cluster_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("clusterId", )) & set(("parent", "clusterId", "cluster", )))
...
def test_create_cluster_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2/{parent=projects/*/instances/*}/clusters" % client.transport._host, args[1])
...
def test_get_cluster_rest_required_fields(request_type=bigtable_instance_admin.GetClusterRequest):
    transport_class = transports.BigtableInstanceAdminRestTransport
...
def test_get_cluster_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2/{name=projects/*/instances/*/clusters/*}" % client.transport._host, args[1])
...
def test_list_clusters_rest_required_fields(request_type=bigtable_instance_admin.ListClustersRequest):
    transport_class = transports.BigtableInstanceAdminRestTransport
...
def test_partial_update_cluster_rest_required_fields(request_type=bigtable_instance_admin.PartialUpdateClusterRequest):
    transport_class = transports.BigtableInstanceAdminRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).partial_update_cluster._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_partial_update_cluster_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("updateMask", )) & set(("cluster", "updateMask", )))
...
def test_partial_update_cluster_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'cluster': {'name': 'projects/sample1/instances/sample2/clusters/sample3'}}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2/{cluster.name=projects/*/instances/*/clusters/*}" % client.transport._host, args[1])
...
def test_delete_cluster_rest_required_fields(request_type=bigtable_instance_admin.DeleteClusterRequest):
    transport_class = transports.BigtableInstanceAdminRestTransport
...
def test_create_app_profile_rest_required_fields(request_type=bigtable_instance_admin.CreateAppProfileRequest):
    transport_class = transports.BigtableInstanceAdminRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_app_profile._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_app_profile._get_unset_required_fields(jsonified_request)
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("app_profile_id", "ignore_warnings", ))
    jsonified_request.update(unset_fields)
...
def test_create_app_profile_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("appProfileId", "ignoreWarnings", )) & set(("parent", "appProfileId", "appProfile", )))
...
def test_create_app_profile_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2/{parent=projects/*/instances/*}/appProfiles" % client.transport._host, args[1])
...
def test_get_app_profile_rest_required_fields(request_type=bigtable_instance_admin.GetAppProfileRequest):
    transport_class = transports.BigtableInstanceAdminRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_app_profile._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_app_profile_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'name': 'projects/sample1/instances/sample2/appProfiles/sample3'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2/{name=projects/*/instances/*/appProfiles/*}" % client.transport._host, args[1])
...
def test_list_app_profiles_rest_required_fields(request_type=bigtable_instance_admin.ListAppProfilesRequest):
    transport_class = transports.BigtableInstanceAdminRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_app_profiles._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_app_profiles_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        response = tuple(bigtable_instance_admin.ListAppProfilesResponse.to_json(x) for x in response)
...
def test_update_app_profile_rest_required_fields(request_type=bigtable_instance_admin.UpdateAppProfileRequest):
    transport_class = transports.BigtableInstanceAdminRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_app_profile._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_app_profile._get_unset_required_fields(jsonified_request)
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("ignore_warnings", "update_mask", ))
    jsonified_request.update(unset_fields)
...
def test_update_app_profile_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("ignoreWarnings", "updateMask", )) & set(("appProfile", "updateMask", )))
...
def test_update_app_profile_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'app_profile': {'name': 'projects/sample1/instances/sample2/appProfiles/sample3'}}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2/{app_profile.name=projects/*/instances/*/appProfiles/*}" % client.transport._host, args[1])
...
def test_delete_app_profile_rest_required_fields(request_type=bigtable_instance_admin.DeleteAppProfileRequest):
    transport_class = transports.BigtableInstanceAdminRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_app_profile._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_app_profile_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("ignoreWarnings", )) & set(("name", "ignoreWarnings", )))
...
def test_get_iam_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2/{resource=projects/*/instances/*}:getIamPolicy" % client.transport._host, args[1])
...
def test_set_iam_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2/{resource=projects/*/instances/*}:setIamPolicy" % client.transport._host, args[1])
...
def test_test_iam_permissions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2/{resource=projects/*/instances/*}:testIamPermissions" % client.transport._host, args[1])
...
def test_list_hot_tablets_rest_required_fields(request_type=bigtable_instance_admin.ListHotTabletsRequest):
    transport_class = transports.BigtableInstanceAdminRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_hot_tablets._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_hot_tablets._get_unset_required_fields(jsonified_request)
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("end_time", "page_size", "page_token", "start_time", ))
    jsonified_request.update(unset_fields)
...
def test_list_hot_tablets_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("endTime", "pageSize", "pageToken", "startTime", )) & set(("parent", )))
...
def test_list_hot_tablets_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'parent': 'projects/sample1/instances/sample2/clusters/sample3'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2/{parent=projects/*/instances/*/clusters/*}/hotTablets" % client.transport._host, args[1])
...
def test_list_hot_tablets_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(bigtable_instance_admin.ListHotTabletsResponse.to_json(x) for x in response)
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode('UTF-8')
            return_val.status_code = 200
...
def test_create_logical_view_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = BigtableInstanceAdminClient(
...
def test_create_logical_view_rest_required_fields(request_type=bigtable_instance_admin.CreateLogicalViewRequest):
    transport_class = transports.BigtableInstanceAdminRestTransport

    request_init = {}
    request_init["parent"] = ""
    request_init["logical_view_id"] = ""
    request = request_type(**request_init)
    pb_request = request_type.pb(request)
    jsonified_request = json.loads(json_format.MessageToJson(
        pb_request,
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_logical_view._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

    # verify required fields with default values are now present
    assert "logicalViewId" in jsonified_request
    assert jsonified_request["logicalViewId"] == request_init["logical_view_id"]
    ...
    assert jsonified_request["parent"] == 'parent_value'
    assert "logicalViewId" in jsonified_request
    assert jsonified_request["logicalViewId"] == 'logical_view_id_value'
...
def test_create_logical_view_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("logicalViewId", )) & set(("parent", "logicalViewId", "logicalView", )))
...
def test_create_logical_view_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        client.create_logical_view(**mock_args)

        # Establish that the underlying call was made with the expected
        # request object values.
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2/{parent=projects/*/instances/*}/logicalViews" % client.transport._host, args[1])


def test_create_logical_view_rest_flattened_error(transport: str = 'rest'):
    client = BigtableInstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_logical_view_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = BigtableInstanceAdminClient(
...
def test_get_logical_view_rest_required_fields(request_type=bigtable_instance_admin.GetLogicalViewRequest):
    transport_class = transports.BigtableInstanceAdminRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_logical_view._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
    ...
    # Designate an appropriate value for the returned response.
    return_value = instance.LogicalView()
    # Mock the http request call within the method and fake a response.
    with mock.patch.object(Session, 'request') as req:
        # We need to mock transcode() because providing default values
        # for required fields will fail the real version if the http_options
        ...
        with mock.patch.object(path_template, 'transcode') as transcode:
            ...
            # Convert return value to protobuf type
            return_value = instance.LogicalView.pb(return_value)
            json_return_value = json_format.MessageToJson(return_value)
...
def test_get_logical_view_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'name': 'projects/sample1/instances/sample2/logicalViews/sample3'}
        ...
        client.get_logical_view(**mock_args)

        # Establish that the underlying call was made with the expected
        # request object values.
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2/{name=projects/*/instances/*/logicalViews/*}" % client.transport._host, args[1])


def test_get_logical_view_rest_flattened_error(transport: str = 'rest'):
    client = BigtableInstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_logical_views_rest_required_fields(request_type=bigtable_instance_admin.ListLogicalViewsRequest):
    transport_class = transports.BigtableInstanceAdminRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_logical_views._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
    ...
    # Designate an appropriate value for the returned response.
    return_value = bigtable_instance_admin.ListLogicalViewsResponse()
    # Mock the http request call within the method and fake a response.
    with mock.patch.object(Session, 'request') as req:
        # We need to mock transcode() because providing default values
        # for required fields will fail the real version if the http_options
        ...
        with mock.patch.object(path_template, 'transcode') as transcode:
            ...
            # Convert return value to protobuf type
            return_value = bigtable_instance_admin.ListLogicalViewsResponse.pb(return_value)
            json_return_value = json_format.MessageToJson(return_value)
...
def test_list_logical_views_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        client.list_logical_views(**mock_args)
...
def test_list_logical_views_rest_flattened_error(transport: str = 'rest'):
    client = BigtableInstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_logical_views_rest_pager(transport: str = 'rest'):
    client = BigtableInstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(bigtable_instance_admin.ListLogicalViewsResponse.to_json(x) for x in response)
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode('UTF-8')
            return_val.status_code = 200
        ...
        pages = list(client.list_logical_views(request=sample_request).pages)
        for page_, token in zip(pages, ['abc','def','ghi', '']):
            assert page_.raw_page.next_page_token == token


def test_update_logical_view_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = BigtableInstanceAdminClient(
...
def test_update_logical_view_rest_required_fields(request_type=bigtable_instance_admin.UpdateLogicalViewRequest):
    transport_class = transports.BigtableInstanceAdminRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_logical_view._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_logical_view_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'logical_view': {'name': 'projects/sample1/instances/sample2/logicalViews/sample3'}}
        ...
        client.update_logical_view(**mock_args)

        # Establish that the underlying call was made with the expected
        # request object values.
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2/{logical_view.name=projects/*/instances/*/logicalViews/*}" % client.transport._host, args[1])


def test_update_logical_view_rest_flattened_error(transport: str = 'rest'):
    client = BigtableInstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_logical_view_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = BigtableInstanceAdminClient(
...
def test_delete_logical_view_rest_required_fields(request_type=bigtable_instance_admin.DeleteLogicalViewRequest):
    transport_class = transports.BigtableInstanceAdminRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_logical_view._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_logical_view_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        client.delete_logical_view(**mock_args)
...
def test_delete_logical_view_rest_flattened_error(transport: str = 'rest'):
    client = BigtableInstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_materialized_view_rest_required_fields(request_type=bigtable_instance_admin.CreateMaterializedViewRequest):
    transport_class = transports.BigtableInstanceAdminRestTransport

    request_init = {}
    request_init["parent"] = ""
    request_init["materialized_view_id"] = ""
    request = request_type(**request_init)
    pb_request = request_type.pb(request)
    jsonified_request = json.loads(json_format.MessageToJson(
        pb_request,
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_materialized_view._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

    # verify required fields with default values are now present
    assert "materializedViewId" in jsonified_request
    assert jsonified_request["materializedViewId"] == request_init["materialized_view_id"]
    ...
    assert jsonified_request["parent"] == 'parent_value'
    assert "materializedViewId" in jsonified_request
    assert jsonified_request["materializedViewId"] == 'materialized_view_id_value'
...
def test_create_materialized_view_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        client.create_materialized_view(**mock_args)

        # Establish that the underlying call was made with the expected
        # request object values.
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2/{parent=projects/*/instances/*}/materializedViews" % client.transport._host, args[1])


def test_create_materialized_view_rest_flattened_error(transport: str = 'rest'):
    client = BigtableInstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_materialized_view_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = BigtableInstanceAdminClient(
...
def test_get_materialized_view_rest_required_fields(request_type=bigtable_instance_admin.GetMaterializedViewRequest):
    transport_class = transports.BigtableInstanceAdminRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_materialized_view._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
    ...
    # Designate an appropriate value for the returned response.
    return_value = instance.MaterializedView()
    # Mock the http request call within the method and fake a response.
    with mock.patch.object(Session, 'request') as req:
        # We need to mock transcode() because providing default values
        # for required fields will fail the real version if the http_options
        ...
        with mock.patch.object(path_template, 'transcode') as transcode:
            ...
            # Convert return value to protobuf type
            return_value = instance.MaterializedView.pb(return_value)
            json_return_value = json_format.MessageToJson(return_value)
...
def test_get_materialized_view_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'name': 'projects/sample1/instances/sample2/materializedViews/sample3'}
        ...
        client.get_materialized_view(**mock_args)

        # Establish that the underlying call was made with the expected
        # request object values.
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2/{name=projects/*/instances/*/materializedViews/*}" % client.transport._host, args[1])


def test_get_materialized_view_rest_flattened_error(transport: str = 'rest'):
    client = BigtableInstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_materialized_views_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = BigtableInstanceAdminClient(
...
def test_list_materialized_views_rest_required_fields(request_type=bigtable_instance_admin.ListMaterializedViewsRequest):
    transport_class = transports.BigtableInstanceAdminRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_materialized_views._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
    ...
    # Designate an appropriate value for the returned response.
    return_value = bigtable_instance_admin.ListMaterializedViewsResponse()
    # Mock the http request call within the method and fake a response.
    with mock.patch.object(Session, 'request') as req:
        # We need to mock transcode() because providing default values
        # for required fields will fail the real version if the http_options
        ...
        with mock.patch.object(path_template, 'transcode') as transcode:
            ...
            # Convert return value to protobuf type
            return_value = bigtable_instance_admin.ListMaterializedViewsResponse.pb(return_value)
            json_return_value = json_format.MessageToJson(return_value)
...
def test_list_materialized_views_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        client.list_materialized_views(**mock_args)
...
def test_list_materialized_views_rest_flattened_error(transport: str = 'rest'):
    client = BigtableInstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_materialized_views_rest_pager(transport: str = 'rest'):
    client = BigtableInstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(bigtable_instance_admin.ListMaterializedViewsResponse.to_json(x) for x in response)
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode('UTF-8')
            return_val.status_code = 200
        ...
        pages = list(client.list_materialized_views(request=sample_request).pages)
        for page_, token in zip(pages, ['abc','def','ghi', '']):
            assert page_.raw_page.next_page_token == token


def test_update_materialized_view_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = BigtableInstanceAdminClient(
...
def test_update_materialized_view_rest_required_fields(request_type=bigtable_instance_admin.UpdateMaterializedViewRequest):
    transport_class = transports.BigtableInstanceAdminRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_materialized_view._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_materialized_view_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'materialized_view': {'name': 'projects/sample1/instances/sample2/materializedViews/sample3'}}
        ...
        client.update_materialized_view(**mock_args)

        # Establish that the underlying call was made with the expected
        # request object values.
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2/{materialized_view.name=projects/*/instances/*/materializedViews/*}" % client.transport._host, args[1])


def test_update_materialized_view_rest_flattened_error(transport: str = 'rest'):
    client = BigtableInstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_materialized_view_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = BigtableInstanceAdminClient(
...
def test_delete_materialized_view_rest_required_fields(request_type=bigtable_instance_admin.DeleteMaterializedViewRequest):
    transport_class = transports.BigtableInstanceAdminRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_materialized_view._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_materialized_view_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        client.delete_materialized_view(**mock_args)
...
def test_delete_materialized_view_rest_flattened_error(transport: str = 'rest'):
    client = BigtableInstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_logical_view_empty_call_grpc():
    client = BigtableInstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        client.create_logical_view(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_logical_view_empty_call_grpc():
    client = BigtableInstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = instance.LogicalView()
        client.get_logical_view(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_logical_views_empty_call_grpc():
    client = BigtableInstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = bigtable_instance_admin.ListLogicalViewsResponse()
        client.list_logical_views(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_update_logical_view_empty_call_grpc():
    client = BigtableInstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        client.update_logical_view(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_logical_view_empty_call_grpc():
    client = BigtableInstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = None
        client.delete_logical_view(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_materialized_view_empty_call_grpc():
    client = BigtableInstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        client.create_materialized_view(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_materialized_view_empty_call_grpc():
    client = BigtableInstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = instance.MaterializedView()
        client.get_materialized_view(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_materialized_views_empty_call_grpc():
    client = BigtableInstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = bigtable_instance_admin.ListMaterializedViewsResponse()
        client.list_materialized_views(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_update_materialized_view_empty_call_grpc():
    client = BigtableInstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        client.update_materialized_view(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_materialized_view_empty_call_grpc():
    client = BigtableInstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = None
        client.delete_materialized_view(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_create_logical_view_empty_call_grpc_asyncio():
    client = BigtableInstanceAdminAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.create_logical_view(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_get_logical_view_empty_call_grpc_asyncio():
    client = BigtableInstanceAdminAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_list_logical_views_empty_call_grpc_asyncio():
    client = BigtableInstanceAdminAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.list_logical_views(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_update_logical_view_empty_call_grpc_asyncio():
    client = BigtableInstanceAdminAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.update_logical_view(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_delete_logical_view_empty_call_grpc_asyncio():
    client = BigtableInstanceAdminAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(None)
        await client.delete_logical_view(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_create_materialized_view_empty_call_grpc_asyncio():
    client = BigtableInstanceAdminAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.create_materialized_view(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_get_materialized_view_empty_call_grpc_asyncio():
    client = BigtableInstanceAdminAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.get_materialized_view(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_list_materialized_views_empty_call_grpc_asyncio():
    client = BigtableInstanceAdminAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.list_materialized_views(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_update_materialized_view_empty_call_grpc_asyncio():
    client = BigtableInstanceAdminAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.update_materialized_view(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_delete_materialized_view_empty_call_grpc_asyncio():
    client = BigtableInstanceAdminAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(None)
        await client.delete_materialized_view(request=None)
...
def test_create_instance_rest_bad_request(request_type=bigtable_instance_admin.CreateInstanceRequest):
    client = BigtableInstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_create_instance_rest_interceptors(null_interceptor):
    transport = transports.BigtableInstanceAdminRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.BigtableInstanceAdminRestInterceptor(),
        )
    client = BigtableInstanceAdminClient(transport=transport)
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.BigtableInstanceAdminRestInterceptor, "post_create_instance") as post, \
        mock.patch.object(transports.BigtableInstanceAdminRestInterceptor, "post_create_instance_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BigtableInstanceAdminRestInterceptor, "pre_create_instance") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = bigtable_instance_admin.CreateInstanceRequest.pb(bigtable_instance_admin.CreateInstanceRequest())
...
def test_get_instance_rest_bad_request(request_type=bigtable_instance_admin.GetInstanceRequest):
    client = BigtableInstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_get_instance_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.BigtableInstanceAdminRestInterceptor, "post_get_instance") as post, \
        mock.patch.object(transports.BigtableInstanceAdminRestInterceptor, "post_get_instance_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BigtableInstanceAdminRestInterceptor, "pre_get_instance") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = bigtable_instance_admin.GetInstanceRequest.pb(bigtable_instance_admin.GetInstanceRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_list_instances_rest_bad_request(request_type=bigtable_instance_admin.ListInstancesRequest):
    client = BigtableInstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_instances_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.BigtableInstanceAdminRestInterceptor, "post_list_instances") as post, \
        mock.patch.object(transports.BigtableInstanceAdminRestInterceptor, "post_list_instances_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BigtableInstanceAdminRestInterceptor, "pre_list_instances") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = bigtable_instance_admin.ListInstancesRequest.pb(bigtable_instance_admin.ListInstancesRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = bigtable_instance_admin.ListInstancesResponse.to_json(bigtable_instance_admin.ListInstancesResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = bigtable_instance_admin.ListInstancesResponse(), metadata
...
def test_update_instance_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.BigtableInstanceAdminRestInterceptor, "post_update_instance") as post, \
        mock.patch.object(transports.BigtableInstanceAdminRestInterceptor, "post_update_instance_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BigtableInstanceAdminRestInterceptor, "pre_update_instance") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_partial_update_instance_rest_bad_request(request_type=bigtable_instance_admin.PartialUpdateInstanceRequest):
    client = BigtableInstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_partial_update_instance_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'instance': {'name': 'projects/sample1/instances/sample2'}}
    request_init["instance"] = {'name': 'projects/sample1/instances/sample2', 'display_name': 'display_name_value', 'state': 1, 'type_': 1, 'labels': {}, 'create_time': {'seconds': 751, 'nanos': 543}, 'satisfies_pzs': True, 'satisfies_pzi': True, 'tags': {}}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748

    # Determine if the message type is proto-plus or protobuf
    test_field = bigtable_instance_admin.PartialUpdateInstanceRequest.meta.fields["instance"]
...
def test_partial_update_instance_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.BigtableInstanceAdminRestInterceptor, "post_partial_update_instance") as post, \
        mock.patch.object(transports.BigtableInstanceAdminRestInterceptor, "post_partial_update_instance_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BigtableInstanceAdminRestInterceptor, "pre_partial_update_instance") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = bigtable_instance_admin.PartialUpdateInstanceRequest.pb(bigtable_instance_admin.PartialUpdateInstanceRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.partial_update_instance(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_delete_instance_rest_bad_request(request_type=bigtable_instance_admin.DeleteInstanceRequest):
    client = BigtableInstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_instance_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.BigtableInstanceAdminRestInterceptor, "pre_delete_instance") as pre:
        pre.assert_not_called()
        pb_message = bigtable_instance_admin.DeleteInstanceRequest.pb(bigtable_instance_admin.DeleteInstanceRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_create_cluster_rest_bad_request(request_type=bigtable_instance_admin.CreateClusterRequest):
    client = BigtableInstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_create_cluster_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.BigtableInstanceAdminRestInterceptor, "post_create_cluster") as post, \
        mock.patch.object(transports.BigtableInstanceAdminRestInterceptor, "post_create_cluster_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BigtableInstanceAdminRestInterceptor, "pre_create_cluster") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = bigtable_instance_admin.CreateClusterRequest.pb(bigtable_instance_admin.CreateClusterRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_get_cluster_rest_bad_request(request_type=bigtable_instance_admin.GetClusterRequest):
    client = BigtableInstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_get_cluster_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.BigtableInstanceAdminRestInterceptor, "post_get_cluster") as post, \
        mock.patch.object(transports.BigtableInstanceAdminRestInterceptor, "post_get_cluster_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BigtableInstanceAdminRestInterceptor, "pre_get_cluster") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = bigtable_instance_admin.GetClusterRequest.pb(bigtable_instance_admin.GetClusterRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_list_clusters_rest_bad_request(request_type=bigtable_instance_admin.ListClustersRequest):
    client = BigtableInstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_clusters_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.BigtableInstanceAdminRestInterceptor, "post_list_clusters") as post, \
        mock.patch.object(transports.BigtableInstanceAdminRestInterceptor, "post_list_clusters_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BigtableInstanceAdminRestInterceptor, "pre_list_clusters") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = bigtable_instance_admin.ListClustersRequest.pb(bigtable_instance_admin.ListClustersRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = bigtable_instance_admin.ListClustersResponse.to_json(bigtable_instance_admin.ListClustersResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = bigtable_instance_admin.ListClustersResponse(), metadata
...
def test_update_cluster_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.BigtableInstanceAdminRestInterceptor, "post_update_cluster") as post, \
        mock.patch.object(transports.BigtableInstanceAdminRestInterceptor, "post_update_cluster_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BigtableInstanceAdminRestInterceptor, "pre_update_cluster") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_partial_update_cluster_rest_bad_request(request_type=bigtable_instance_admin.PartialUpdateClusterRequest):
    client = BigtableInstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    # send a request that will satisfy transcoding
    request_init = {'cluster': {'name': 'projects/sample1/instances/sample2/clusters/sample3'}}
    request = request_type(**request_init)
...
def test_partial_update_cluster_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.BigtableInstanceAdminRestInterceptor, "post_partial_update_cluster") as post, \
        mock.patch.object(transports.BigtableInstanceAdminRestInterceptor, "post_partial_update_cluster_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BigtableInstanceAdminRestInterceptor, "pre_partial_update_cluster") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = bigtable_instance_admin.PartialUpdateClusterRequest.pb(bigtable_instance_admin.PartialUpdateClusterRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.partial_update_cluster(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_delete_cluster_rest_bad_request(request_type=bigtable_instance_admin.DeleteClusterRequest):
    client = BigtableInstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_cluster_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.BigtableInstanceAdminRestInterceptor, "pre_delete_cluster") as pre:
        pre.assert_not_called()
        pb_message = bigtable_instance_admin.DeleteClusterRequest.pb(bigtable_instance_admin.DeleteClusterRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_create_app_profile_rest_bad_request(request_type=bigtable_instance_admin.CreateAppProfileRequest):
    client = BigtableInstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_create_app_profile_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.BigtableInstanceAdminRestInterceptor, "post_create_app_profile") as post, \
        mock.patch.object(transports.BigtableInstanceAdminRestInterceptor, "post_create_app_profile_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BigtableInstanceAdminRestInterceptor, "pre_create_app_profile") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = bigtable_instance_admin.CreateAppProfileRequest.pb(bigtable_instance_admin.CreateAppProfileRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.create_app_profile(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_app_profile_rest_bad_request(request_type=bigtable_instance_admin.GetAppProfileRequest):
    client = BigtableInstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_get_app_profile_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.BigtableInstanceAdminRestInterceptor, "post_get_app_profile") as post, \
        mock.patch.object(transports.BigtableInstanceAdminRestInterceptor, "post_get_app_profile_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BigtableInstanceAdminRestInterceptor, "pre_get_app_profile") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = bigtable_instance_admin.GetAppProfileRequest.pb(bigtable_instance_admin.GetAppProfileRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.get_app_profile(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_list_app_profiles_rest_bad_request(request_type=bigtable_instance_admin.ListAppProfilesRequest):
    client = BigtableInstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_app_profiles_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.BigtableInstanceAdminRestInterceptor, "post_list_app_profiles") as post, \
        mock.patch.object(transports.BigtableInstanceAdminRestInterceptor, "post_list_app_profiles_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BigtableInstanceAdminRestInterceptor, "pre_list_app_profiles") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = bigtable_instance_admin.ListAppProfilesRequest.pb(bigtable_instance_admin.ListAppProfilesRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = bigtable_instance_admin.ListAppProfilesResponse.to_json(bigtable_instance_admin.ListAppProfilesResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = bigtable_instance_admin.ListAppProfilesResponse(), metadata

        client.list_app_profiles(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_update_app_profile_rest_bad_request(request_type=bigtable_instance_admin.UpdateAppProfileRequest):
    client = BigtableInstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    # send a request that will satisfy transcoding
    request_init = {'app_profile': {'name': 'projects/sample1/instances/sample2/appProfiles/sample3'}}
    request = request_type(**request_init)
...
def test_update_app_profile_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'app_profile': {'name': 'projects/sample1/instances/sample2/appProfiles/sample3'}}
    request_init["app_profile"] = {'name': 'projects/sample1/instances/sample2/appProfiles/sample3', 'etag': 'etag_value', 'description': 'description_value', 'multi_cluster_routing_use_any': {'cluster_ids': ['cluster_ids_value1', 'cluster_ids_value2'], 'row_affinity': {}}, 'single_cluster_routing': {'cluster_id': 'cluster_id_value', 'allow_transactional_writes': True}, 'priority': 1, 'standard_isolation': {'priority': 1}, 'data_boost_isolation_read_only': {'compute_billing_owner': 1}}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748

    # Determine if the message type is proto-plus or protobuf
    test_field = bigtable_instance_admin.UpdateAppProfileRequest.meta.fields["app_profile"]
...
def test_update_app_profile_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.BigtableInstanceAdminRestInterceptor, "post_update_app_profile") as post, \
        mock.patch.object(transports.BigtableInstanceAdminRestInterceptor, "post_update_app_profile_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BigtableInstanceAdminRestInterceptor, "pre_update_app_profile") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = bigtable_instance_admin.UpdateAppProfileRequest.pb(bigtable_instance_admin.UpdateAppProfileRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.update_app_profile(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_delete_app_profile_rest_bad_request(request_type=bigtable_instance_admin.DeleteAppProfileRequest):
    client = BigtableInstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_app_profile_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.BigtableInstanceAdminRestInterceptor, "pre_delete_app_profile") as pre:
        pre.assert_not_called()
        pb_message = bigtable_instance_admin.DeleteAppProfileRequest.pb(bigtable_instance_admin.DeleteAppProfileRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.delete_app_profile(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_iam_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.BigtableInstanceAdminRestInterceptor, "post_get_iam_policy") as post, \
        mock.patch.object(transports.BigtableInstanceAdminRestInterceptor, "post_get_iam_policy_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BigtableInstanceAdminRestInterceptor, "pre_get_iam_policy") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_set_iam_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.BigtableInstanceAdminRestInterceptor, "post_set_iam_policy") as post, \
        mock.patch.object(transports.BigtableInstanceAdminRestInterceptor, "post_set_iam_policy_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BigtableInstanceAdminRestInterceptor, "pre_set_iam_policy") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_test_iam_permissions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.BigtableInstanceAdminRestInterceptor, "post_test_iam_permissions") as post, \
        mock.patch.object(transports.BigtableInstanceAdminRestInterceptor, "post_test_iam_permissions_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BigtableInstanceAdminRestInterceptor, "pre_test_iam_permissions") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_list_hot_tablets_rest_bad_request(request_type=bigtable_instance_admin.ListHotTabletsRequest):
    client = BigtableInstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_hot_tablets_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.BigtableInstanceAdminRestInterceptor, "post_list_hot_tablets") as post, \
        mock.patch.object(transports.BigtableInstanceAdminRestInterceptor, "post_list_hot_tablets_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BigtableInstanceAdminRestInterceptor, "pre_list_hot_tablets") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = bigtable_instance_admin.ListHotTabletsRequest.pb(bigtable_instance_admin.ListHotTabletsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = bigtable_instance_admin.ListHotTabletsResponse.to_json(bigtable_instance_admin.ListHotTabletsResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = bigtable_instance_admin.ListHotTabletsResponse(), metadata

        client.list_hot_tablets(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_create_logical_view_rest_bad_request(request_type=bigtable_instance_admin.CreateLogicalViewRequest):
    client = BigtableInstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_create_logical_view_rest_call_success(request_type):
    client = BigtableInstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/instances/sample2'}
    request_init["logical_view"] = {'name': 'name_value', 'query': 'query_value', 'etag': 'etag_value', 'deletion_protection': True}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748

    # Determine if the message type is proto-plus or protobuf
    test_field = bigtable_instance_admin.CreateLogicalViewRequest.meta.fields["logical_view"]
    ...
    # For each item in the sample request, create a list of sub fields which are not present at runtime
    # Add `# pragma: NO COVER` because this test code will not run if all subfields are present at runtime
    for field, value in request_init["logical_view"].items(): # pragma: NO COVER
        result = None
        is_repeated = False
        # For repeated fields
        if isinstance(value, list) and len(value):
    ...
    for subfield_to_delete in subfields_not_in_runtime: # pragma: NO COVER
        ...
        if subfield:
            if field_repeated:
                for i in range(0, len(request_init["logical_view"][field])):
                    del request_init["logical_view"][field][i][subfield]
            else:
                del request_init["logical_view"][field][subfield]
    request = request_type(**request_init)
...
@pytest.mark.parametrize("null_interceptor", [True, False])
def test_create_logical_view_rest_interceptors(null_interceptor):
    transport = transports.BigtableInstanceAdminRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.BigtableInstanceAdminRestInterceptor(),
        )
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.BigtableInstanceAdminRestInterceptor, "post_create_logical_view") as post, \
        mock.patch.object(transports.BigtableInstanceAdminRestInterceptor, "post_create_logical_view_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BigtableInstanceAdminRestInterceptor, "pre_create_logical_view") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = bigtable_instance_admin.CreateLogicalViewRequest.pb(bigtable_instance_admin.CreateLogicalViewRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.create_logical_view(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_logical_view_rest_bad_request(request_type=bigtable_instance_admin.GetLogicalViewRequest):
    client = BigtableInstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    # send a request that will satisfy transcoding
    request_init = {'name': 'projects/sample1/instances/sample2/logicalViews/sample3'}
    request = request_type(**request_init)
...
def test_get_logical_view_rest_call_success(request_type):
    client = BigtableInstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
@pytest.mark.parametrize("null_interceptor", [True, False])
def test_get_logical_view_rest_interceptors(null_interceptor):
    transport = transports.BigtableInstanceAdminRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.BigtableInstanceAdminRestInterceptor(),
        )
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.BigtableInstanceAdminRestInterceptor, "post_get_logical_view") as post, \
        mock.patch.object(transports.BigtableInstanceAdminRestInterceptor, "post_get_logical_view_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BigtableInstanceAdminRestInterceptor, "pre_get_logical_view") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = bigtable_instance_admin.GetLogicalViewRequest.pb(bigtable_instance_admin.GetLogicalViewRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = instance.LogicalView.to_json(instance.LogicalView())
        req.return_value.content = return_value
        ...
        pre.return_value = request, metadata
        post.return_value = instance.LogicalView()
        post_with_metadata.return_value = instance.LogicalView(), metadata

        client.get_logical_view(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_list_logical_views_rest_bad_request(request_type=bigtable_instance_admin.ListLogicalViewsRequest):
    client = BigtableInstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_logical_views_rest_call_success(request_type):
    client = BigtableInstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
@pytest.mark.parametrize("null_interceptor", [True, False])
def test_list_logical_views_rest_interceptors(null_interceptor):
    transport = transports.BigtableInstanceAdminRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.BigtableInstanceAdminRestInterceptor(),
        )
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.BigtableInstanceAdminRestInterceptor, "post_list_logical_views") as post, \
        mock.patch.object(transports.BigtableInstanceAdminRestInterceptor, "post_list_logical_views_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BigtableInstanceAdminRestInterceptor, "pre_list_logical_views") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = bigtable_instance_admin.ListLogicalViewsRequest.pb(bigtable_instance_admin.ListLogicalViewsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = bigtable_instance_admin.ListLogicalViewsResponse.to_json(bigtable_instance_admin.ListLogicalViewsResponse())
        req.return_value.content = return_value
        ...
        pre.return_value = request, metadata
        post.return_value = bigtable_instance_admin.ListLogicalViewsResponse()
        post_with_metadata.return_value = bigtable_instance_admin.ListLogicalViewsResponse(), metadata

        client.list_logical_views(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_update_logical_view_rest_bad_request(request_type=bigtable_instance_admin.UpdateLogicalViewRequest):
    client = BigtableInstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    # send a request that will satisfy transcoding
    request_init = {'logical_view': {'name': 'projects/sample1/instances/sample2/logicalViews/sample3'}}
    request = request_type(**request_init)
...
def test_update_logical_view_rest_call_success(request_type):
    client = BigtableInstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    ...
    # send a request that will satisfy transcoding
    request_init = {'logical_view': {'name': 'projects/sample1/instances/sample2/logicalViews/sample3'}}
    request_init["logical_view"] = {'name': 'projects/sample1/instances/sample2/logicalViews/sample3', 'query': 'query_value', 'etag': 'etag_value', 'deletion_protection': True}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748

    # Determine if the message type is proto-plus or protobuf
    test_field = bigtable_instance_admin.UpdateLogicalViewRequest.meta.fields["logical_view"]
...
@pytest.mark.parametrize("null_interceptor", [True, False])
def test_update_logical_view_rest_interceptors(null_interceptor):
    transport = transports.BigtableInstanceAdminRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.BigtableInstanceAdminRestInterceptor(),
        )
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.BigtableInstanceAdminRestInterceptor, "post_update_logical_view") as post, \
        mock.patch.object(transports.BigtableInstanceAdminRestInterceptor, "post_update_logical_view_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BigtableInstanceAdminRestInterceptor, "pre_update_logical_view") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = bigtable_instance_admin.UpdateLogicalViewRequest.pb(bigtable_instance_admin.UpdateLogicalViewRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.update_logical_view(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_delete_logical_view_rest_bad_request(request_type=bigtable_instance_admin.DeleteLogicalViewRequest):
    client = BigtableInstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_logical_view_rest_call_success(request_type):
    client = BigtableInstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
@pytest.mark.parametrize("null_interceptor", [True, False])
def test_delete_logical_view_rest_interceptors(null_interceptor):
    transport = transports.BigtableInstanceAdminRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.BigtableInstanceAdminRestInterceptor(),
        )
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.BigtableInstanceAdminRestInterceptor, "pre_delete_logical_view") as pre:
        pre.assert_not_called()
        pb_message = bigtable_instance_admin.DeleteLogicalViewRequest.pb(bigtable_instance_admin.DeleteLogicalViewRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.delete_logical_view(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()


def test_create_materialized_view_rest_bad_request(request_type=bigtable_instance_admin.CreateMaterializedViewRequest):
    client = BigtableInstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_create_materialized_view_rest_call_success(request_type):
    client = BigtableInstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/instances/sample2'}
    request_init["materialized_view"] = {'name': 'name_value', 'query': 'query_value', 'etag': 'etag_value', 'deletion_protection': True}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748

    # Determine if the message type is proto-plus or protobuf
    test_field = bigtable_instance_admin.CreateMaterializedViewRequest.meta.fields["materialized_view"]
    ...
    # For each item in the sample request, create a list of sub fields which are not present at runtime
    # Add `# pragma: NO COVER` because this test code will not run if all subfields are present at runtime
    for field, value in request_init["materialized_view"].items(): # pragma: NO COVER
        result = None
        is_repeated = False
        # For repeated fields
        if isinstance(value, list) and len(value):
    ...
    for subfield_to_delete in subfields_not_in_runtime: # pragma: NO COVER
        ...
        if subfield:
            if field_repeated:
                for i in range(0, len(request_init["materialized_view"][field])):
                    del request_init["materialized_view"][field][i][subfield]
            else:
                del request_init["materialized_view"][field][subfield]
    request = request_type(**request_init)
...
@pytest.mark.parametrize("null_interceptor", [True, False])
def test_create_materialized_view_rest_interceptors(null_interceptor):
    transport = transports.BigtableInstanceAdminRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.BigtableInstanceAdminRestInterceptor(),
        )
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.BigtableInstanceAdminRestInterceptor, "post_create_materialized_view") as post, \
        mock.patch.object(transports.BigtableInstanceAdminRestInterceptor, "post_create_materialized_view_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BigtableInstanceAdminRestInterceptor, "pre_create_materialized_view") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = bigtable_instance_admin.CreateMaterializedViewRequest.pb(bigtable_instance_admin.CreateMaterializedViewRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.create_materialized_view(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_materialized_view_rest_bad_request(request_type=bigtable_instance_admin.GetMaterializedViewRequest):
    client = BigtableInstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    # send a request that will satisfy transcoding
    request_init = {'name': 'projects/sample1/instances/sample2/materializedViews/sample3'}
    request = request_type(**request_init)
...
def test_get_materialized_view_rest_call_success(request_type):
    client = BigtableInstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
@pytest.mark.parametrize("null_interceptor", [True, False])
def test_get_materialized_view_rest_interceptors(null_interceptor):
    transport = transports.BigtableInstanceAdminRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.BigtableInstanceAdminRestInterceptor(),
        )
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.BigtableInstanceAdminRestInterceptor, "post_get_materialized_view") as post, \
        mock.patch.object(transports.BigtableInstanceAdminRestInterceptor, "post_get_materialized_view_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BigtableInstanceAdminRestInterceptor, "pre_get_materialized_view") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = bigtable_instance_admin.GetMaterializedViewRequest.pb(bigtable_instance_admin.GetMaterializedViewRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = instance.MaterializedView.to_json(instance.MaterializedView())
        req.return_value.content = return_value
        ...
        pre.return_value = request, metadata
        post.return_value = instance.MaterializedView()
        post_with_metadata.return_value = instance.MaterializedView(), metadata

        client.get_materialized_view(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_list_materialized_views_rest_bad_request(request_type=bigtable_instance_admin.ListMaterializedViewsRequest):
    client = BigtableInstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_materialized_views_rest_call_success(request_type):
    client = BigtableInstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
@pytest.mark.parametrize("null_interceptor", [True, False])
def test_list_materialized_views_rest_interceptors(null_interceptor):
    transport = transports.BigtableInstanceAdminRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.BigtableInstanceAdminRestInterceptor(),
        )
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.BigtableInstanceAdminRestInterceptor, "post_list_materialized_views") as post, \
        mock.patch.object(transports.BigtableInstanceAdminRestInterceptor, "post_list_materialized_views_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BigtableInstanceAdminRestInterceptor, "pre_list_materialized_views") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = bigtable_instance_admin.ListMaterializedViewsRequest.pb(bigtable_instance_admin.ListMaterializedViewsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = bigtable_instance_admin.ListMaterializedViewsResponse.to_json(bigtable_instance_admin.ListMaterializedViewsResponse())
        req.return_value.content = return_value
        ...
        pre.return_value = request, metadata
        post.return_value = bigtable_instance_admin.ListMaterializedViewsResponse()
        post_with_metadata.return_value = bigtable_instance_admin.ListMaterializedViewsResponse(), metadata

        client.list_materialized_views(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_update_materialized_view_rest_bad_request(request_type=bigtable_instance_admin.UpdateMaterializedViewRequest):
    client = BigtableInstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    # send a request that will satisfy transcoding
    request_init = {'materialized_view': {'name': 'projects/sample1/instances/sample2/materializedViews/sample3'}}
    request = request_type(**request_init)
...
def test_update_materialized_view_rest_call_success(request_type):
    client = BigtableInstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    ...
    # send a request that will satisfy transcoding
    request_init = {'materialized_view': {'name': 'projects/sample1/instances/sample2/materializedViews/sample3'}}
    request_init["materialized_view"] = {'name': 'projects/sample1/instances/sample2/materializedViews/sample3', 'query': 'query_value', 'etag': 'etag_value', 'deletion_protection': True}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748

    # Determine if the message type is proto-plus or protobuf
    test_field = bigtable_instance_admin.UpdateMaterializedViewRequest.meta.fields["materialized_view"]
...
@pytest.mark.parametrize("null_interceptor", [True, False])
def test_update_materialized_view_rest_interceptors(null_interceptor):
    transport = transports.BigtableInstanceAdminRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.BigtableInstanceAdminRestInterceptor(),
        )
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.BigtableInstanceAdminRestInterceptor, "post_update_materialized_view") as post, \
        mock.patch.object(transports.BigtableInstanceAdminRestInterceptor, "post_update_materialized_view_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BigtableInstanceAdminRestInterceptor, "pre_update_materialized_view") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = bigtable_instance_admin.UpdateMaterializedViewRequest.pb(bigtable_instance_admin.UpdateMaterializedViewRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.update_materialized_view(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_delete_materialized_view_rest_bad_request(request_type=bigtable_instance_admin.DeleteMaterializedViewRequest):
    client = BigtableInstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_materialized_view_rest_call_success(request_type):
    client = BigtableInstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
@pytest.mark.parametrize("null_interceptor", [True, False])
def test_delete_materialized_view_rest_interceptors(null_interceptor):
    transport = transports.BigtableInstanceAdminRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.BigtableInstanceAdminRestInterceptor(),
        )
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.BigtableInstanceAdminRestInterceptor, "pre_delete_materialized_view") as pre:
        pre.assert_not_called()
        pb_message = bigtable_instance_admin.DeleteMaterializedViewRequest.pb(bigtable_instance_admin.DeleteMaterializedViewRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.delete_materialized_view(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_logical_view_empty_call_rest():
    client = BigtableInstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_logical_view_empty_call_rest():
    client = BigtableInstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_logical_views_empty_call_rest():
    client = BigtableInstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_update_logical_view_empty_call_rest():
    client = BigtableInstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_logical_view_empty_call_rest():
    client = BigtableInstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_materialized_view_empty_call_rest():
    client = BigtableInstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_materialized_view_empty_call_rest():
    client = BigtableInstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_materialized_views_empty_call_rest():
    client = BigtableInstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_update_materialized_view_empty_call_rest():
    client = BigtableInstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_materialized_view_empty_call_rest():
    client = BigtableInstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_bigtable_instance_admin_client_transport_session_collision(transport_name):
    ...
    assert session1 != session2
    session1 = client1.transport.create_logical_view._session
    session2 = client2.transport.create_logical_view._session
    assert session1 != session2
    session1 = client1.transport.get_logical_view._session
    session2 = client2.transport.get_logical_view._session
    assert session1 != session2
    session1 = client1.transport.list_logical_views._session
    session2 = client2.transport.list_logical_views._session
    assert session1 != session2
    session1 = client1.transport.update_logical_view._session
    session2 = client2.transport.update_logical_view._session
    assert session1 != session2
    session1 = client1.transport.delete_logical_view._session
    session2 = client2.transport.delete_logical_view._session
    assert session1 != session2
    session1 = client1.transport.create_materialized_view._session
    session2 = client2.transport.create_materialized_view._session
    assert session1 != session2
    session1 = client1.transport.get_materialized_view._session
    session2 = client2.transport.get_materialized_view._session
    assert session1 != session2
    session1 = client1.transport.list_materialized_views._session
    session2 = client2.transport.list_materialized_views._session
    assert session1 != session2
    session1 = client1.transport.update_materialized_view._session
    session2 = client2.transport.update_materialized_view._session
    assert session1 != session2
    session1 = client1.transport.delete_materialized_view._session
    session2 = client2.transport.delete_materialized_view._session
    assert session1 != session2
...
def test_hot_tablet_path():
    ...
    cluster = "scallop"
    hot_tablet = "abalone"
    expected = "projects/{project}/instances/{instance}/clusters/{cluster}/hotTablets/{hot_tablet}".format(project=project, instance=instance, cluster=cluster, hot_tablet=hot_tablet, )
    actual = BigtableInstanceAdminClient.hot_tablet_path(project, instance, cluster, hot_tablet)
    assert expected == actual
...
def test_logical_view_path():
    project = "winkle"
    instance = "nautilus"
    logical_view = "scallop"
    expected = "projects/{project}/instances/{instance}/logicalViews/{logical_view}".format(project=project, instance=instance, logical_view=logical_view, )
    actual = BigtableInstanceAdminClient.logical_view_path(project, instance, logical_view)
    assert expected == actual


def test_parse_logical_view_path():
    expected = {
        "project": "abalone",
        "instance": "squid",
        "logical_view": "clam",
    }
    path = BigtableInstanceAdminClient.logical_view_path(**expected)

    # Check that the path construction is reversible.
    actual = BigtableInstanceAdminClient.parse_logical_view_path(path)
    assert expected == actual

def test_materialized_view_path():
    project = "whelk"
    instance = "octopus"
    materialized_view = "oyster"
    expected = "projects/{project}/instances/{instance}/materializedViews/{materialized_view}".format(project=project, instance=instance, materialized_view=materialized_view, )
    actual = BigtableInstanceAdminClient.materialized_view_path(project, instance, materialized_view)
    assert expected == actual
...
def test_parse_materialized_view_path():
    expected = {
        "project": "nudibranch",
        "instance": "cuttlefish",
        "materialized_view": "mussel",
    }
    path = BigtableInstanceAdminClient.materialized_view_path(**expected)

    # Check that the path construction is reversible.
    actual = BigtableInstanceAdminClient.parse_materialized_view_path(path)
    assert expected == actual
...
@pytest.mark.parametrize("client_class,transport_class", [
    ...
    (BigtableInstanceAdminAsyncClient, transports.BigtableInstanceAdminGrpcAsyncIOTransport),
])
