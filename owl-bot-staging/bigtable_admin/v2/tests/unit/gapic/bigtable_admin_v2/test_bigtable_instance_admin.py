...
def test_create_instance_rest_unset_required_fields():
    transport = transports.BigtableInstanceAdminRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_partial_update_instance_rest_required_fields(request_type=bigtable_instance_admin.PartialUpdateInstanceRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).partial_update_instance._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_partial_update_cluster_rest_required_fields(request_type=bigtable_instance_admin.PartialUpdateClusterRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).partial_update_cluster._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_app_profile_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/instances/sample2'}
    request_init["app_profile"] = {'name': 'name_value', 'etag': 'etag_value', 'description': 'description_value', 'multi_cluster_routing_use_any': {'cluster_ids': ['cluster_ids_value1', 'cluster_ids_value2']}, 'single_cluster_routing': {'cluster_id': 'cluster_id_value', 'allow_transactional_writes': True}, 'priority': 1, 'standard_isolation': {'priority': 1}}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_create_app_profile_rest_required_fields(request_type=bigtable_instance_admin.CreateAppProfileRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).create_app_profile._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_app_profile_rest_required_fields(request_type=bigtable_instance_admin.GetAppProfileRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_app_profile._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_app_profiles_rest_required_fields(request_type=bigtable_instance_admin.ListAppProfilesRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_app_profiles._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_app_profile_rest_required_fields(request_type=bigtable_instance_admin.UpdateAppProfileRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).update_app_profile._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_app_profile_rest_required_fields(request_type=bigtable_instance_admin.DeleteAppProfileRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).delete_app_profile._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_hot_tablets_rest_required_fields(request_type=bigtable_instance_admin.ListHotTabletsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_hot_tablets._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
