...
def test_create_instance_rest_bad_request(transport: str = 'rest', request_type=bigtable_instance_admin.CreateInstanceRequest):
    client = BigtableInstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_instance_rest_bad_request(transport: str = 'rest', request_type=bigtable_instance_admin.GetInstanceRequest):
    client = BigtableInstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_instances_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = bigtable_instance_admin.ListInstancesResponse.to_json(bigtable_instance_admin.ListInstancesResponse())
...
def test_list_instances_rest_bad_request(transport: str = 'rest', request_type=bigtable_instance_admin.ListInstancesRequest):
    client = BigtableInstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_instances_rest_error():
    client = BigtableInstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport='rest'
    )
...
def test_update_instance_rest_bad_request(transport: str = 'rest', request_type=instance.Instance):
    client = BigtableInstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_partial_update_instance_rest(request_type):
    client = BigtableInstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_partial_update_instance_rest_bad_request(transport: str = 'rest', request_type=bigtable_instance_admin.PartialUpdateInstanceRequest):
    client = BigtableInstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_partial_update_instance_rest_error():
    client = BigtableInstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport='rest'
    )
...
def test_delete_instance_rest_bad_request(transport: str = 'rest', request_type=bigtable_instance_admin.DeleteInstanceRequest):
    client = BigtableInstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_cluster_rest_bad_request(transport: str = 'rest', request_type=bigtable_instance_admin.CreateClusterRequest):
    client = BigtableInstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_cluster_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = instance.Cluster.to_json(instance.Cluster())
...
def test_get_cluster_rest_bad_request(transport: str = 'rest', request_type=bigtable_instance_admin.GetClusterRequest):
    client = BigtableInstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_clusters_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = bigtable_instance_admin.ListClustersResponse.to_json(bigtable_instance_admin.ListClustersResponse())
...
def test_list_clusters_rest_bad_request(transport: str = 'rest', request_type=bigtable_instance_admin.ListClustersRequest):
    client = BigtableInstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_cluster_rest_bad_request(transport: str = 'rest', request_type=instance.Cluster):
    client = BigtableInstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_partial_update_cluster_rest(request_type):
    client = BigtableInstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_partial_update_cluster_rest_bad_request(transport: str = 'rest', request_type=bigtable_instance_admin.PartialUpdateClusterRequest):
    client = BigtableInstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_partial_update_cluster_rest_error():
    client = BigtableInstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport='rest'
    )
...
def test_delete_cluster_rest_bad_request(transport: str = 'rest', request_type=bigtable_instance_admin.DeleteClusterRequest):
    client = BigtableInstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_app_profile_rest(request_type):
    client = BigtableInstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_create_app_profile_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = instance.AppProfile.to_json(instance.AppProfile())
...
def test_create_app_profile_rest_bad_request(transport: str = 'rest', request_type=bigtable_instance_admin.CreateAppProfileRequest):
    client = BigtableInstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_app_profile_rest(request_type):
    client = BigtableInstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_get_app_profile_rest_bad_request(transport: str = 'rest', request_type=bigtable_instance_admin.GetAppProfileRequest):
    client = BigtableInstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_app_profiles_rest(request_type):
    client = BigtableInstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_list_app_profiles_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = bigtable_instance_admin.ListAppProfilesResponse.to_json(bigtable_instance_admin.ListAppProfilesResponse())
...
def test_list_app_profiles_rest_bad_request(transport: str = 'rest', request_type=bigtable_instance_admin.ListAppProfilesRequest):
    client = BigtableInstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_app_profile_rest(request_type):
    client = BigtableInstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_update_app_profile_rest_bad_request(transport: str = 'rest', request_type=bigtable_instance_admin.UpdateAppProfileRequest):
    client = BigtableInstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_app_profile_rest_error():
    client = BigtableInstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport='rest'
    )
...
def test_delete_app_profile_rest(request_type):
    client = BigtableInstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_delete_app_profile_rest_bad_request(transport: str = 'rest', request_type=bigtable_instance_admin.DeleteAppProfileRequest):
    client = BigtableInstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_app_profile_rest_error():
    client = BigtableInstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport='rest'
    )
...
def test_list_hot_tablets_rest(request_type):
    client = BigtableInstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_list_hot_tablets_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = bigtable_instance_admin.ListHotTabletsResponse.to_json(bigtable_instance_admin.ListHotTabletsResponse())
...
def test_list_hot_tablets_rest_bad_request(transport: str = 'rest', request_type=bigtable_instance_admin.ListHotTabletsRequest):
    client = BigtableInstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
