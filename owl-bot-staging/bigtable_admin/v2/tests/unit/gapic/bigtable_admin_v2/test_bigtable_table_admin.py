...
def test__read_environment_variables():
    assert BigtableTableAdminClient._read_environment_variables() == (False, "auto", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert BigtableTableAdminClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert BigtableTableAdminClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert BigtableTableAdminClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert BigtableTableAdminClient._read_environment_variables() == (False, "auto", "foo.com")
...
def test__get_client_cert_source():
    ...
    assert BigtableTableAdminClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert BigtableTableAdminClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch('google.auth.transport.mtls.has_default_client_cert_source', return_value=True):
        with mock.patch('google.auth.transport.mtls.default_client_cert_source', return_value=mock_default_cert_source):
            assert BigtableTableAdminClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert BigtableTableAdminClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source

@mock.patch.object(BigtableTableAdminClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(BigtableTableAdminClient))
@mock.patch.object(BigtableTableAdminAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(BigtableTableAdminAsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = BigtableTableAdminClient._DEFAULT_UNIVERSE
    default_endpoint = BigtableTableAdminClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = BigtableTableAdminClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert BigtableTableAdminClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert BigtableTableAdminClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == BigtableTableAdminClient.DEFAULT_MTLS_ENDPOINT
    assert BigtableTableAdminClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert BigtableTableAdminClient._get_api_endpoint(None, None, default_universe, "always") == BigtableTableAdminClient.DEFAULT_MTLS_ENDPOINT
    assert BigtableTableAdminClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == BigtableTableAdminClient.DEFAULT_MTLS_ENDPOINT
    assert BigtableTableAdminClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert BigtableTableAdminClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        BigtableTableAdminClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert BigtableTableAdminClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert BigtableTableAdminClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert BigtableTableAdminClient._get_universe_domain(None, None) == BigtableTableAdminClient._DEFAULT_UNIVERSE
...
def test_bigtable_table_admin_client_from_service_account_info(client_class, transport_name):
...
def test_bigtable_table_admin_client_service_account_always_use_jwt(transport_class, transport_name):
...
def test_bigtable_table_admin_client_from_service_account_file(client_class, transport_name):
    creds = ga_credentials.AnonymousCredentials()
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    ...
    (BigtableTableAdminClient, transports.BigtableTableAdminRestTransport, "rest", "true"),
    (BigtableTableAdminClient, transports.BigtableTableAdminRestTransport, "rest", "false"),
])
@mock.patch.object(BigtableTableAdminClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(BigtableTableAdminClient))
@mock.patch.object(BigtableTableAdminAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(BigtableTableAdminAsyncClient))
...
@pytest.mark.parametrize("client_class", [
    BigtableTableAdminClient, BigtableTableAdminAsyncClient
])
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    (BigtableTableAdminClient, transports.BigtableTableAdminGrpcTransport, "grpc", grpc_helpers),
    (BigtableTableAdminAsyncClient, transports.BigtableTableAdminGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
    (BigtableTableAdminClient, transports.BigtableTableAdminRestTransport, "rest", None),
])
def test_bigtable_table_admin_client_client_options_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
...
def test_bigtable_table_admin_client_create_channel_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
    # Check the case credentials file is provided.
    options = client_options.ClientOptions(
        credentials_file="credentials.json"
    )
...
def test_create_table_from_snapshot_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.create_table_from_snapshot in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.create_table_from_snapshot] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_create_table_from_snapshot_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = BigtableTableAdminAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.create_table_from_snapshot in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_table_from_snapshot] = mock_rpc
...
def test_update_table(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_table),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
@pytest.mark.asyncio
async def test_update_table_async(transport: str = 'grpc_asyncio', request_type=bigtable_table_admin.UpdateTableRequest):
    client = BigtableTableAdminAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_undelete_table(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.undelete_table),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
@pytest.mark.asyncio
async def test_undelete_table_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = BigtableTableAdminAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.undelete_table in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.undelete_table] = mock_rpc
...
@pytest.mark.asyncio
async def test_undelete_table_async(transport: str = 'grpc_asyncio', request_type=bigtable_table_admin.UndeleteTableRequest):
    client = BigtableTableAdminAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_create_authorized_view_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.create_authorized_view in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.create_authorized_view] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_create_authorized_view_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = BigtableTableAdminAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.create_authorized_view in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_authorized_view] = mock_rpc
...
@pytest.mark.asyncio
async def test_create_authorized_view_async(transport: str = 'grpc_asyncio', request_type=bigtable_table_admin.CreateAuthorizedViewRequest):
    client = BigtableTableAdminAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_list_authorized_views_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.list_authorized_views in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_authorized_views] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_authorized_views_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = BigtableTableAdminAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_authorized_views in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_authorized_views] = mock_rpc
...
@pytest.mark.asyncio
async def test_list_authorized_views_async(transport: str = 'grpc_asyncio', request_type=bigtable_table_admin.ListAuthorizedViewsRequest):
    client = BigtableTableAdminAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_list_authorized_views_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, table.AuthorizedView)
                   for i in results)
...
async def test_list_authorized_views_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_authorized_views(request={},)
        assert async_pager.next_page_token == 'abc'
        responses = []
        async for response in async_pager: # pragma: no branch
            responses.append(response)
...
def test_get_authorized_view(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_authorized_view),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_get_authorized_view_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.get_authorized_view in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.get_authorized_view] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_get_authorized_view_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = BigtableTableAdminAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_authorized_view in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_authorized_view] = mock_rpc
...
@pytest.mark.asyncio
async def test_get_authorized_view_async(transport: str = 'grpc_asyncio', request_type=bigtable_table_admin.GetAuthorizedViewRequest):
    client = BigtableTableAdminAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(table.AuthorizedView(
            name='name_value',
            etag='etag_value',
            deletion_protection=True,
        ))
...
def test_update_authorized_view(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_authorized_view),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_update_authorized_view_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.update_authorized_view in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.update_authorized_view] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_update_authorized_view_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = BigtableTableAdminAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.update_authorized_view in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.update_authorized_view] = mock_rpc
...
@pytest.mark.asyncio
async def test_update_authorized_view_async(transport: str = 'grpc_asyncio', request_type=bigtable_table_admin.UpdateAuthorizedViewRequest):
    client = BigtableTableAdminAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_delete_authorized_view(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_authorized_view),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = None
...
def test_delete_authorized_view_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.delete_authorized_view in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.delete_authorized_view] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_delete_authorized_view_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = BigtableTableAdminAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_authorized_view in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.delete_authorized_view] = mock_rpc
...
@pytest.mark.asyncio
async def test_delete_authorized_view_async(transport: str = 'grpc_asyncio', request_type=bigtable_table_admin.DeleteAuthorizedViewRequest):
    client = BigtableTableAdminAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_modify_column_families_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.modify_column_families in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.modify_column_families] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_modify_column_families_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = BigtableTableAdminAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.modify_column_families in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.modify_column_families] = mock_rpc
...
def test_modify_column_families_flattened():
    ...
    with mock.patch.object(
        ...
        mock_val = [bigtable_table_admin.ModifyColumnFamiliesRequest.Modification(id='id_value')]
        assert arg == mock_val
...
@pytest.mark.asyncio
async def test_drop_row_range_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = BigtableTableAdminAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.drop_row_range in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.drop_row_range] = mock_rpc
...
def test_generate_consistency_token_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.generate_consistency_token in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.generate_consistency_token] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_generate_consistency_token_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = BigtableTableAdminAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.generate_consistency_token in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.generate_consistency_token] = mock_rpc
...
def test_check_consistency_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.check_consistency] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_check_consistency_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = BigtableTableAdminAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.check_consistency in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.check_consistency] = mock_rpc
...
@pytest.mark.asyncio
async def test_snapshot_table_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = BigtableTableAdminAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.snapshot_table in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.snapshot_table] = mock_rpc
...
@pytest.mark.asyncio
async def test_restore_table_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = BigtableTableAdminAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.restore_table in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.restore_table] = mock_rpc
...
@pytest.mark.asyncio
async def test_copy_backup_async(transport: str = 'grpc_asyncio', request_type=bigtable_table_admin.CopyBackupRequest):
    client = BigtableTableAdminAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_create_table_rest_required_fields(request_type=bigtable_table_admin.CreateTableRequest):
...
def test_create_table_rest_unset_required_fields():
    transport = transports.BigtableTableAdminRestTransport(credentials=ga_credentials.AnonymousCredentials)

    unset_fields = transport.create_table._get_unset_required_fields({})
    assert set(unset_fields) == (set(()) & set(("parent", "tableId", "table", )))
...
def test_create_table_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/v2/{parent=projects/*/instances/*}/tables" % client.transport._host, args[1])
...
def test_create_table_from_snapshot_rest_required_fields(request_type=bigtable_table_admin.CreateTableFromSnapshotRequest):
    transport_class = transports.BigtableTableAdminRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_table_from_snapshot._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_table_from_snapshot_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("parent", "tableId", "sourceSnapshot", )))
...
def test_create_table_from_snapshot_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2/{parent=projects/*/instances/*}/tables:createFromSnapshot" % client.transport._host, args[1])
...
def test_list_tables_rest_required_fields(request_type=bigtable_table_admin.ListTablesRequest):
    transport_class = transports.BigtableTableAdminRestTransport
...
def test_list_tables_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        response = tuple(bigtable_table_admin.ListTablesResponse.to_json(x) for x in response)
...
def test_get_table_rest_required_fields(request_type=bigtable_table_admin.GetTableRequest):
    transport_class = transports.BigtableTableAdminRestTransport
...
def test_get_table_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2/{name=projects/*/instances/*/tables/*}" % client.transport._host, args[1])
...
def test_update_table_rest_required_fields(request_type=bigtable_table_admin.UpdateTableRequest):
    transport_class = transports.BigtableTableAdminRestTransport
...
def test_update_table_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("ignoreWarnings", "updateMask", )) & set(("table", "updateMask", )))
...
def test_update_table_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'table': {'name': 'projects/sample1/instances/sample2/tables/sample3'}}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2/{table.name=projects/*/instances/*/tables/*}" % client.transport._host, args[1])
...
def test_delete_table_rest_required_fields(request_type=bigtable_table_admin.DeleteTableRequest):
    transport_class = transports.BigtableTableAdminRestTransport
...
def test_undelete_table_rest_required_fields(request_type=bigtable_table_admin.UndeleteTableRequest):
    transport_class = transports.BigtableTableAdminRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).undelete_table._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_undelete_table_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2/{name=projects/*/instances/*/tables/*}:undelete" % client.transport._host, args[1])
...
def test_create_authorized_view_rest_required_fields(request_type=bigtable_table_admin.CreateAuthorizedViewRequest):
    transport_class = transports.BigtableTableAdminRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_authorized_view._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_authorized_view_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("authorizedViewId", )) & set(("parent", "authorizedViewId", "authorizedView", )))
...
def test_create_authorized_view_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2/{parent=projects/*/instances/*/tables/*}/authorizedViews" % client.transport._host, args[1])
...
def test_list_authorized_views_rest_required_fields(request_type=bigtable_table_admin.ListAuthorizedViewsRequest):
    transport_class = transports.BigtableTableAdminRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_authorized_views._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_authorized_views_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(bigtable_table_admin.ListAuthorizedViewsResponse.to_json(x) for x in response)
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode('UTF-8')
            return_val.status_code = 200
...
def test_get_authorized_view_rest_required_fields(request_type=bigtable_table_admin.GetAuthorizedViewRequest):
    transport_class = transports.BigtableTableAdminRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_authorized_view._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_authorized_view_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'name': 'projects/sample1/instances/sample2/tables/sample3/authorizedViews/sample4'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2/{name=projects/*/instances/*/tables/*/authorizedViews/*}" % client.transport._host, args[1])
...
def test_update_authorized_view_rest_required_fields(request_type=bigtable_table_admin.UpdateAuthorizedViewRequest):
    transport_class = transports.BigtableTableAdminRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_authorized_view._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_authorized_view_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("ignoreWarnings", "updateMask", )) & set(("authorizedView", )))
...
def test_update_authorized_view_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'authorized_view': {'name': 'projects/sample1/instances/sample2/tables/sample3/authorizedViews/sample4'}}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2/{authorized_view.name=projects/*/instances/*/tables/*/authorizedViews/*}" % client.transport._host, args[1])
...
def test_delete_authorized_view_rest_required_fields(request_type=bigtable_table_admin.DeleteAuthorizedViewRequest):
    transport_class = transports.BigtableTableAdminRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_authorized_view._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_modify_column_families_rest_required_fields(request_type=bigtable_table_admin.ModifyColumnFamiliesRequest):
    transport_class = transports.BigtableTableAdminRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).modify_column_families._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_modify_column_families_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("name", "modifications", )))
...
def test_modify_column_families_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2/{name=projects/*/instances/*/tables/*}:modifyColumnFamilies" % client.transport._host, args[1])
...
def test_drop_row_range_rest_required_fields(request_type=bigtable_table_admin.DropRowRangeRequest):
    transport_class = transports.BigtableTableAdminRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).drop_row_range._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_generate_consistency_token_rest_required_fields(request_type=bigtable_table_admin.GenerateConsistencyTokenRequest):
    transport_class = transports.BigtableTableAdminRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).generate_consistency_token._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        with mock.patch.object(path_template, 'transcode') as transcode:
            ...
            # Convert return value to protobuf type
            return_value = bigtable_table_admin.GenerateConsistencyTokenResponse.pb(return_value)
            json_return_value = json_format.MessageToJson(return_value)
...
def test_generate_consistency_token_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2/{name=projects/*/instances/*/tables/*}:generateConsistencyToken" % client.transport._host, args[1])
...
def test_check_consistency_rest_required_fields(request_type=bigtable_table_admin.CheckConsistencyRequest):
    transport_class = transports.BigtableTableAdminRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).check_consistency._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_check_consistency_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("name", "consistencyToken", )))
...
def test_check_consistency_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2/{name=projects/*/instances/*/tables/*}:checkConsistency" % client.transport._host, args[1])
...
def test_snapshot_table_rest_required_fields(request_type=bigtable_table_admin.SnapshotTableRequest):
    transport_class = transports.BigtableTableAdminRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).snapshot_table._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_snapshot_table_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("name", "cluster", "snapshotId", )))
...
def test_snapshot_table_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2/{name=projects/*/instances/*/tables/*}:snapshot" % client.transport._host, args[1])
...
def test_get_snapshot_rest_required_fields(request_type=bigtable_table_admin.GetSnapshotRequest):
    transport_class = transports.BigtableTableAdminRestTransport
...
def test_get_snapshot_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'name': 'projects/sample1/instances/sample2/clusters/sample3/snapshots/sample4'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2/{name=projects/*/instances/*/clusters/*/snapshots/*}" % client.transport._host, args[1])
...
def test_list_snapshots_rest_required_fields(request_type=bigtable_table_admin.ListSnapshotsRequest):
    transport_class = transports.BigtableTableAdminRestTransport
...
def test_list_snapshots_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2/{parent=projects/*/instances/*/clusters/*}/snapshots" % client.transport._host, args[1])
...
def test_list_snapshots_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(bigtable_table_admin.ListSnapshotsResponse.to_json(x) for x in response)
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode('UTF-8')
            return_val.status_code = 200
...
def test_delete_snapshot_rest_required_fields(request_type=bigtable_table_admin.DeleteSnapshotRequest):
    transport_class = transports.BigtableTableAdminRestTransport
...
def test_create_backup_rest_required_fields(request_type=bigtable_table_admin.CreateBackupRequest):
    transport_class = transports.BigtableTableAdminRestTransport
...
def test_create_backup_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("backupId", )) & set(("parent", "backupId", "backup", )))
...
def test_create_backup_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2/{parent=projects/*/instances/*/clusters/*}/backups" % client.transport._host, args[1])
...
def test_get_backup_rest_required_fields(request_type=bigtable_table_admin.GetBackupRequest):
    transport_class = transports.BigtableTableAdminRestTransport
...
def test_get_backup_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'name': 'projects/sample1/instances/sample2/clusters/sample3/backups/sample4'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2/{name=projects/*/instances/*/clusters/*/backups/*}" % client.transport._host, args[1])
...
def test_update_backup_rest_required_fields(request_type=bigtable_table_admin.UpdateBackupRequest):
    transport_class = transports.BigtableTableAdminRestTransport
...
def test_update_backup_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'backup': {'name': 'projects/sample1/instances/sample2/clusters/sample3/backups/sample4'}}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2/{backup.name=projects/*/instances/*/clusters/*/backups/*}" % client.transport._host, args[1])
...
def test_delete_backup_rest_required_fields(request_type=bigtable_table_admin.DeleteBackupRequest):
    transport_class = transports.BigtableTableAdminRestTransport
...
def test_list_backups_rest_required_fields(request_type=bigtable_table_admin.ListBackupsRequest):
    transport_class = transports.BigtableTableAdminRestTransport
...
def test_list_backups_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(bigtable_table_admin.ListBackupsResponse.to_json(x) for x in response)
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode('UTF-8')
            return_val.status_code = 200
...
def test_restore_table_rest_required_fields(request_type=bigtable_table_admin.RestoreTableRequest):
    transport_class = transports.BigtableTableAdminRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).restore_table._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_restore_table_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("parent", "tableId", )))
...
def test_copy_backup_rest_required_fields(request_type=bigtable_table_admin.CopyBackupRequest):
    transport_class = transports.BigtableTableAdminRestTransport
...
def test_copy_backup_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2/{parent=projects/*/instances/*/clusters/*}/backups:copy" % client.transport._host, args[1])
...
def test_get_iam_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'resource': 'projects/sample1/instances/sample2/tables/sample3'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2/{resource=projects/*/instances/*/tables/*}:getIamPolicy" % client.transport._host, args[1])
...
def test_set_iam_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2/{resource=projects/*/instances/*/tables/*}:setIamPolicy" % client.transport._host, args[1])
...
def test_test_iam_permissions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2/{resource=projects/*/instances/*/tables/*}:testIamPermissions" % client.transport._host, args[1])
...
def test_create_table_rest_bad_request(request_type=bigtable_table_admin.CreateTableRequest):
    client = BigtableTableAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_create_table_rest_interceptors(null_interceptor):
    transport = transports.BigtableTableAdminRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.BigtableTableAdminRestInterceptor(),
        )
    client = BigtableTableAdminClient(transport=transport)

    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.BigtableTableAdminRestInterceptor, "post_create_table") as post, \
        mock.patch.object(transports.BigtableTableAdminRestInterceptor, "post_create_table_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BigtableTableAdminRestInterceptor, "pre_create_table") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = bigtable_table_admin.CreateTableRequest.pb(bigtable_table_admin.CreateTableRequest())
...
def test_create_table_from_snapshot_rest_bad_request(request_type=bigtable_table_admin.CreateTableFromSnapshotRequest):
    client = BigtableTableAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_create_table_from_snapshot_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.BigtableTableAdminRestInterceptor, "post_create_table_from_snapshot") as post, \
        mock.patch.object(transports.BigtableTableAdminRestInterceptor, "post_create_table_from_snapshot_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BigtableTableAdminRestInterceptor, "pre_create_table_from_snapshot") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = bigtable_table_admin.CreateTableFromSnapshotRequest.pb(bigtable_table_admin.CreateTableFromSnapshotRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.create_table_from_snapshot(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_list_tables_rest_bad_request(request_type=bigtable_table_admin.ListTablesRequest):
    client = BigtableTableAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_tables_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.BigtableTableAdminRestInterceptor, "post_list_tables") as post, \
        mock.patch.object(transports.BigtableTableAdminRestInterceptor, "post_list_tables_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BigtableTableAdminRestInterceptor, "pre_list_tables") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = bigtable_table_admin.ListTablesRequest.pb(bigtable_table_admin.ListTablesRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = bigtable_table_admin.ListTablesResponse.to_json(bigtable_table_admin.ListTablesResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = bigtable_table_admin.ListTablesResponse(), metadata
...
def test_get_table_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.BigtableTableAdminRestInterceptor, "post_get_table") as post, \
        mock.patch.object(transports.BigtableTableAdminRestInterceptor, "post_get_table_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BigtableTableAdminRestInterceptor, "pre_get_table") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = bigtable_table_admin.GetTableRequest.pb(bigtable_table_admin.GetTableRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_update_table_rest_bad_request(request_type=bigtable_table_admin.UpdateTableRequest):
    client = BigtableTableAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    # send a request that will satisfy transcoding
    request_init = {'table': {'name': 'projects/sample1/instances/sample2/tables/sample3'}}
    request = request_type(**request_init)
...
def test_update_table_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.BigtableTableAdminRestInterceptor, "post_update_table") as post, \
        mock.patch.object(transports.BigtableTableAdminRestInterceptor, "post_update_table_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BigtableTableAdminRestInterceptor, "pre_update_table") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = bigtable_table_admin.UpdateTableRequest.pb(bigtable_table_admin.UpdateTableRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_delete_table_rest_bad_request(request_type=bigtable_table_admin.DeleteTableRequest):
    client = BigtableTableAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_table_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.BigtableTableAdminRestInterceptor, "pre_delete_table") as pre:
        pre.assert_not_called()
        pb_message = bigtable_table_admin.DeleteTableRequest.pb(bigtable_table_admin.DeleteTableRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_undelete_table_rest_bad_request(request_type=bigtable_table_admin.UndeleteTableRequest):
    client = BigtableTableAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_undelete_table_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.BigtableTableAdminRestInterceptor, "post_undelete_table") as post, \
        mock.patch.object(transports.BigtableTableAdminRestInterceptor, "post_undelete_table_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BigtableTableAdminRestInterceptor, "pre_undelete_table") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = bigtable_table_admin.UndeleteTableRequest.pb(bigtable_table_admin.UndeleteTableRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.undelete_table(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_create_authorized_view_rest_bad_request(request_type=bigtable_table_admin.CreateAuthorizedViewRequest):
    client = BigtableTableAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_create_authorized_view_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/instances/sample2/tables/sample3'}
    request_init["authorized_view"] = {'name': 'name_value', 'subset_view': {'row_prefixes': [b'row_prefixes_blob1', b'row_prefixes_blob2'], 'family_subsets': {}}, 'etag': 'etag_value', 'deletion_protection': True}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748

    # Determine if the message type is proto-plus or protobuf
    test_field = bigtable_table_admin.CreateAuthorizedViewRequest.meta.fields["authorized_view"]
...
def test_create_authorized_view_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.BigtableTableAdminRestInterceptor, "post_create_authorized_view") as post, \
        mock.patch.object(transports.BigtableTableAdminRestInterceptor, "post_create_authorized_view_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BigtableTableAdminRestInterceptor, "pre_create_authorized_view") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = bigtable_table_admin.CreateAuthorizedViewRequest.pb(bigtable_table_admin.CreateAuthorizedViewRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.create_authorized_view(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_list_authorized_views_rest_bad_request(request_type=bigtable_table_admin.ListAuthorizedViewsRequest):
    client = BigtableTableAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_authorized_views_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.BigtableTableAdminRestInterceptor, "post_list_authorized_views") as post, \
        mock.patch.object(transports.BigtableTableAdminRestInterceptor, "post_list_authorized_views_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BigtableTableAdminRestInterceptor, "pre_list_authorized_views") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = bigtable_table_admin.ListAuthorizedViewsRequest.pb(bigtable_table_admin.ListAuthorizedViewsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = bigtable_table_admin.ListAuthorizedViewsResponse.to_json(bigtable_table_admin.ListAuthorizedViewsResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = bigtable_table_admin.ListAuthorizedViewsResponse(), metadata

        client.list_authorized_views(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_authorized_view_rest_bad_request(request_type=bigtable_table_admin.GetAuthorizedViewRequest):
    client = BigtableTableAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    # send a request that will satisfy transcoding
    request_init = {'name': 'projects/sample1/instances/sample2/tables/sample3/authorizedViews/sample4'}
    request = request_type(**request_init)
...
def test_get_authorized_view_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.BigtableTableAdminRestInterceptor, "post_get_authorized_view") as post, \
        mock.patch.object(transports.BigtableTableAdminRestInterceptor, "post_get_authorized_view_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BigtableTableAdminRestInterceptor, "pre_get_authorized_view") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = bigtable_table_admin.GetAuthorizedViewRequest.pb(bigtable_table_admin.GetAuthorizedViewRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.get_authorized_view(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_update_authorized_view_rest_bad_request(request_type=bigtable_table_admin.UpdateAuthorizedViewRequest):
    client = BigtableTableAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    # send a request that will satisfy transcoding
    request_init = {'authorized_view': {'name': 'projects/sample1/instances/sample2/tables/sample3/authorizedViews/sample4'}}
    request = request_type(**request_init)
...
def test_update_authorized_view_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'authorized_view': {'name': 'projects/sample1/instances/sample2/tables/sample3/authorizedViews/sample4'}}
    request_init["authorized_view"] = {'name': 'projects/sample1/instances/sample2/tables/sample3/authorizedViews/sample4', 'subset_view': {'row_prefixes': [b'row_prefixes_blob1', b'row_prefixes_blob2'], 'family_subsets': {}}, 'etag': 'etag_value', 'deletion_protection': True}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748

    # Determine if the message type is proto-plus or protobuf
    test_field = bigtable_table_admin.UpdateAuthorizedViewRequest.meta.fields["authorized_view"]
...
def test_update_authorized_view_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.BigtableTableAdminRestInterceptor, "post_update_authorized_view") as post, \
        mock.patch.object(transports.BigtableTableAdminRestInterceptor, "post_update_authorized_view_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BigtableTableAdminRestInterceptor, "pre_update_authorized_view") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = bigtable_table_admin.UpdateAuthorizedViewRequest.pb(bigtable_table_admin.UpdateAuthorizedViewRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.update_authorized_view(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_delete_authorized_view_rest_bad_request(request_type=bigtable_table_admin.DeleteAuthorizedViewRequest):
    client = BigtableTableAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_authorized_view_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.BigtableTableAdminRestInterceptor, "pre_delete_authorized_view") as pre:
        pre.assert_not_called()
        pb_message = bigtable_table_admin.DeleteAuthorizedViewRequest.pb(bigtable_table_admin.DeleteAuthorizedViewRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.delete_authorized_view(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()


def test_modify_column_families_rest_bad_request(request_type=bigtable_table_admin.ModifyColumnFamiliesRequest):
    client = BigtableTableAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_modify_column_families_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.BigtableTableAdminRestInterceptor, "post_modify_column_families") as post, \
        mock.patch.object(transports.BigtableTableAdminRestInterceptor, "post_modify_column_families_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BigtableTableAdminRestInterceptor, "pre_modify_column_families") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = bigtable_table_admin.ModifyColumnFamiliesRequest.pb(bigtable_table_admin.ModifyColumnFamiliesRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.modify_column_families(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_drop_row_range_rest_bad_request(request_type=bigtable_table_admin.DropRowRangeRequest):
    client = BigtableTableAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_drop_row_range_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.BigtableTableAdminRestInterceptor, "pre_drop_row_range") as pre:
        pre.assert_not_called()
        pb_message = bigtable_table_admin.DropRowRangeRequest.pb(bigtable_table_admin.DropRowRangeRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.drop_row_range(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()


def test_generate_consistency_token_rest_bad_request(request_type=bigtable_table_admin.GenerateConsistencyTokenRequest):
    client = BigtableTableAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_generate_consistency_token_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.BigtableTableAdminRestInterceptor, "post_generate_consistency_token") as post, \
        mock.patch.object(transports.BigtableTableAdminRestInterceptor, "post_generate_consistency_token_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BigtableTableAdminRestInterceptor, "pre_generate_consistency_token") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = bigtable_table_admin.GenerateConsistencyTokenRequest.pb(bigtable_table_admin.GenerateConsistencyTokenRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = bigtable_table_admin.GenerateConsistencyTokenResponse.to_json(bigtable_table_admin.GenerateConsistencyTokenResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = bigtable_table_admin.GenerateConsistencyTokenResponse(), metadata

        client.generate_consistency_token(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_check_consistency_rest_bad_request(request_type=bigtable_table_admin.CheckConsistencyRequest):
    client = BigtableTableAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_check_consistency_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.BigtableTableAdminRestInterceptor, "post_check_consistency") as post, \
        mock.patch.object(transports.BigtableTableAdminRestInterceptor, "post_check_consistency_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BigtableTableAdminRestInterceptor, "pre_check_consistency") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = bigtable_table_admin.CheckConsistencyRequest.pb(bigtable_table_admin.CheckConsistencyRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = bigtable_table_admin.CheckConsistencyResponse.to_json(bigtable_table_admin.CheckConsistencyResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = bigtable_table_admin.CheckConsistencyResponse(), metadata

        client.check_consistency(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_snapshot_table_rest_bad_request(request_type=bigtable_table_admin.SnapshotTableRequest):
    client = BigtableTableAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_snapshot_table_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.BigtableTableAdminRestInterceptor, "post_snapshot_table") as post, \
        mock.patch.object(transports.BigtableTableAdminRestInterceptor, "post_snapshot_table_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BigtableTableAdminRestInterceptor, "pre_snapshot_table") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = bigtable_table_admin.SnapshotTableRequest.pb(bigtable_table_admin.SnapshotTableRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.snapshot_table(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_snapshot_rest_bad_request(request_type=bigtable_table_admin.GetSnapshotRequest):
    client = BigtableTableAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    # send a request that will satisfy transcoding
    request_init = {'name': 'projects/sample1/instances/sample2/clusters/sample3/snapshots/sample4'}
    request = request_type(**request_init)
...
def test_get_snapshot_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.BigtableTableAdminRestInterceptor, "post_get_snapshot") as post, \
        mock.patch.object(transports.BigtableTableAdminRestInterceptor, "post_get_snapshot_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BigtableTableAdminRestInterceptor, "pre_get_snapshot") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = bigtable_table_admin.GetSnapshotRequest.pb(bigtable_table_admin.GetSnapshotRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_list_snapshots_rest_bad_request(request_type=bigtable_table_admin.ListSnapshotsRequest):
    client = BigtableTableAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_snapshots_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.BigtableTableAdminRestInterceptor, "post_list_snapshots") as post, \
        mock.patch.object(transports.BigtableTableAdminRestInterceptor, "post_list_snapshots_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BigtableTableAdminRestInterceptor, "pre_list_snapshots") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = bigtable_table_admin.ListSnapshotsRequest.pb(bigtable_table_admin.ListSnapshotsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = bigtable_table_admin.ListSnapshotsResponse.to_json(bigtable_table_admin.ListSnapshotsResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = bigtable_table_admin.ListSnapshotsResponse(), metadata
...
def test_delete_snapshot_rest_bad_request(request_type=bigtable_table_admin.DeleteSnapshotRequest):
    client = BigtableTableAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_snapshot_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.BigtableTableAdminRestInterceptor, "pre_delete_snapshot") as pre:
        pre.assert_not_called()
        pb_message = bigtable_table_admin.DeleteSnapshotRequest.pb(bigtable_table_admin.DeleteSnapshotRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_create_backup_rest_bad_request(request_type=bigtable_table_admin.CreateBackupRequest):
    client = BigtableTableAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_create_backup_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.BigtableTableAdminRestInterceptor, "post_create_backup") as post, \
        mock.patch.object(transports.BigtableTableAdminRestInterceptor, "post_create_backup_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BigtableTableAdminRestInterceptor, "pre_create_backup") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = bigtable_table_admin.CreateBackupRequest.pb(bigtable_table_admin.CreateBackupRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_get_backup_rest_bad_request(request_type=bigtable_table_admin.GetBackupRequest):
    client = BigtableTableAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    # send a request that will satisfy transcoding
    request_init = {'name': 'projects/sample1/instances/sample2/clusters/sample3/backups/sample4'}
    request = request_type(**request_init)
...
def test_get_backup_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.BigtableTableAdminRestInterceptor, "post_get_backup") as post, \
        mock.patch.object(transports.BigtableTableAdminRestInterceptor, "post_get_backup_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BigtableTableAdminRestInterceptor, "pre_get_backup") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = bigtable_table_admin.GetBackupRequest.pb(bigtable_table_admin.GetBackupRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_update_backup_rest_bad_request(request_type=bigtable_table_admin.UpdateBackupRequest):
    client = BigtableTableAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    # send a request that will satisfy transcoding
    request_init = {'backup': {'name': 'projects/sample1/instances/sample2/clusters/sample3/backups/sample4'}}
    request = request_type(**request_init)
...
def test_update_backup_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'backup': {'name': 'projects/sample1/instances/sample2/clusters/sample3/backups/sample4'}}
    request_init["backup"] = {'name': 'projects/sample1/instances/sample2/clusters/sample3/backups/sample4', 'source_table': 'source_table_value', 'source_backup': 'source_backup_value', 'expire_time': {'seconds': 751, 'nanos': 543}, 'start_time': {}, 'end_time': {}, 'size_bytes': 1089, 'state': 1, 'encryption_info': {'encryption_type': 1, 'encryption_status': {'code': 411, 'message': 'message_value', 'details': [{'type_url': 'type.googleapis.com/google.protobuf.Duration', 'value': b'\x08\x0c\x10\xdb\x07'}]}, 'kms_key_version': 'kms_key_version_value'}, 'backup_type': 1, 'hot_to_standard_time': {}}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_update_backup_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.BigtableTableAdminRestInterceptor, "post_update_backup") as post, \
        mock.patch.object(transports.BigtableTableAdminRestInterceptor, "post_update_backup_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BigtableTableAdminRestInterceptor, "pre_update_backup") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = bigtable_table_admin.UpdateBackupRequest.pb(bigtable_table_admin.UpdateBackupRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_delete_backup_rest_bad_request(request_type=bigtable_table_admin.DeleteBackupRequest):
    client = BigtableTableAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_backup_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.BigtableTableAdminRestInterceptor, "pre_delete_backup") as pre:
        pre.assert_not_called()
        pb_message = bigtable_table_admin.DeleteBackupRequest.pb(bigtable_table_admin.DeleteBackupRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_list_backups_rest_bad_request(request_type=bigtable_table_admin.ListBackupsRequest):
    client = BigtableTableAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_backups_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.BigtableTableAdminRestInterceptor, "post_list_backups") as post, \
        mock.patch.object(transports.BigtableTableAdminRestInterceptor, "post_list_backups_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BigtableTableAdminRestInterceptor, "pre_list_backups") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = bigtable_table_admin.ListBackupsRequest.pb(bigtable_table_admin.ListBackupsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = bigtable_table_admin.ListBackupsResponse.to_json(bigtable_table_admin.ListBackupsResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = bigtable_table_admin.ListBackupsResponse(), metadata
...
def test_restore_table_rest_bad_request(request_type=bigtable_table_admin.RestoreTableRequest):
    client = BigtableTableAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_restore_table_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.BigtableTableAdminRestInterceptor, "post_restore_table") as post, \
        mock.patch.object(transports.BigtableTableAdminRestInterceptor, "post_restore_table_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BigtableTableAdminRestInterceptor, "pre_restore_table") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = bigtable_table_admin.RestoreTableRequest.pb(bigtable_table_admin.RestoreTableRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.restore_table(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_copy_backup_rest_bad_request(request_type=bigtable_table_admin.CopyBackupRequest):
    client = BigtableTableAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_copy_backup_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.BigtableTableAdminRestInterceptor, "post_copy_backup") as post, \
        mock.patch.object(transports.BigtableTableAdminRestInterceptor, "post_copy_backup_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BigtableTableAdminRestInterceptor, "pre_copy_backup") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = bigtable_table_admin.CopyBackupRequest.pb(bigtable_table_admin.CopyBackupRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_get_iam_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.BigtableTableAdminRestInterceptor, "post_get_iam_policy") as post, \
        mock.patch.object(transports.BigtableTableAdminRestInterceptor, "post_get_iam_policy_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BigtableTableAdminRestInterceptor, "pre_get_iam_policy") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_set_iam_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.BigtableTableAdminRestInterceptor, "post_set_iam_policy") as post, \
        mock.patch.object(transports.BigtableTableAdminRestInterceptor, "post_set_iam_policy_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BigtableTableAdminRestInterceptor, "pre_set_iam_policy") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_test_iam_permissions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.BigtableTableAdminRestInterceptor, "post_test_iam_permissions") as post, \
        mock.patch.object(transports.BigtableTableAdminRestInterceptor, "post_test_iam_permissions_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BigtableTableAdminRestInterceptor, "pre_test_iam_permissions") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_bigtable_table_admin_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.bigtable_admin_v2.services.bigtable_table_admin.transports.BigtableTableAdminTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_bigtable_table_admin_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.bigtable_admin_v2.services.bigtable_table_admin.transports.BigtableTableAdminTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.BigtableTableAdminTransport()
        adc.assert_called_once()
...
def test_authorized_view_path():
    ...
    expected = "projects/{project}/instances/{instance}/tables/{table}/authorizedViews/{authorized_view}".format(project=project, instance=instance, table=table, authorized_view=authorized_view, )
    actual = BigtableTableAdminClient.authorized_view_path(project, instance, table, authorized_view)
...
@pytest.mark.parametrize("client_class,transport_class", [
    ...
    (BigtableTableAdminAsyncClient, transports.BigtableTableAdminGrpcAsyncIOTransport),
])
