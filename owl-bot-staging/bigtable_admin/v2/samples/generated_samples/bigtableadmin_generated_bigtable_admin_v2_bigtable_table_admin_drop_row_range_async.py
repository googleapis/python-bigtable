...
# [START bigtableadmin_generated_bigtable_admin_v2_BigtableTableAdmin_DropRowRange_async]
...
async def sample_drop_row_range():
    ...
    # Make the request
    response = await client.drop_row_range(request=request)


# [END bigtableadmin_generated_bigtable_admin_v2_BigtableTableAdmin_DropRowRange_async]
