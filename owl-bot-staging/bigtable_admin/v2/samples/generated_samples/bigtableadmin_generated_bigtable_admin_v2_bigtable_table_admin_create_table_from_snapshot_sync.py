...
# [START bigtableadmin_generated_bigtable_admin_v2_BigtableTableAdmin_CreateTableFromSnapshot_sync]
...
# [END bigtableadmin_generated_bigtable_admin_v2_BigtableTableAdmin_CreateTableFromSnapshot_sync]
