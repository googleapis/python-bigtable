...
class BigtableGrpcAsyncIOTransport(BigtableTransport):
    ...
    def ping_and_warm(self) -> Callable[
            ...
            Awaitable[bigtable.PingAndWarmResponse]]:
    ...
    def generate_initial_change_stream_partitions(self) -> Callable[
        ...
        if 'generate_initial_change_stream_partitions' not in self._stubs:
            self._stubs['generate_initial_change_stream_partitions'] = self._logged_channel.unary_stream(
    ...
    def prepare_query(self) -> Callable[
            ...
            Awaitable[bigtable.PrepareQueryResponse]]:
