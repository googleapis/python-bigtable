...
class BigtableAsyncClient:
    ...
    parse_materialized_view_path = staticmethod(BigtableClient.parse_materialized_view_path)
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, BigtableTransport, Callable[..., BigtableTransport]]] = "grpc_asyncio",
    ...
    def generate_initial_change_stream_partitions(self,
            ...
            *,
            ...
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
            ) -> Awaitable[AsyncIterable[bigtable.GenerateInitialChangeStreamPartitionsResponse]]:
    ...
    def read_change_stream(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.read_change_stream]
    ...
    async def prepare_query(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.prepare_query]
    ...
    def execute_query(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.execute_query]
