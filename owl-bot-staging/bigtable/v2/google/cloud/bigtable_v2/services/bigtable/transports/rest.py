...
class BigtableRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_check_and_mutate_row(self, request: bigtable.CheckAndMutateRowRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[bigtable.CheckAndMutateRowRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_check_and_mutate_row_with_metadata(self, response: bigtable.CheckAndMutateRowResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[bigtable.CheckAndMutateRowResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for check_and_mutate_row
    ...
    def pre_execute_query(self, request: bigtable.ExecuteQueryRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[bigtable.ExecuteQueryRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_execute_query(self, response: rest_streaming.ResponseIterator) -> rest_streaming.ResponseIterator:
    ...
    def post_execute_query_with_metadata(self, response: rest_streaming.ResponseIterator, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[rest_streaming.ResponseIterator, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for execute_query
    ...
    def pre_generate_initial_change_stream_partitions(self, request: bigtable.GenerateInitialChangeStreamPartitionsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[bigtable.GenerateInitialChangeStreamPartitionsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_generate_initial_change_stream_partitions(self, response: rest_streaming.ResponseIterator) -> rest_streaming.ResponseIterator:
    ...
    def post_generate_initial_change_stream_partitions_with_metadata(self, response: rest_streaming.ResponseIterator, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[rest_streaming.ResponseIterator, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for generate_initial_change_stream_partitions
    ...
    def pre_mutate_row(self, request: bigtable.MutateRowRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[bigtable.MutateRowRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_mutate_row_with_metadata(self, response: bigtable.MutateRowResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[bigtable.MutateRowResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for mutate_row
    ...
    def pre_mutate_rows(self, request: bigtable.MutateRowsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[bigtable.MutateRowsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_mutate_rows_with_metadata(self, response: rest_streaming.ResponseIterator, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[rest_streaming.ResponseIterator, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for mutate_rows
    ...
    def pre_ping_and_warm(self, request: bigtable.PingAndWarmRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[bigtable.PingAndWarmRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_ping_and_warm_with_metadata(self, response: bigtable.PingAndWarmResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[bigtable.PingAndWarmResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for ping_and_warm
    ...
    def pre_prepare_query(self, request: bigtable.PrepareQueryRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[bigtable.PrepareQueryRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_prepare_query(self, response: bigtable.PrepareQueryResponse) -> bigtable.PrepareQueryResponse:
    ...
    def post_prepare_query_with_metadata(self, response: bigtable.PrepareQueryResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[bigtable.PrepareQueryResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for prepare_query
    ...
    def pre_read_change_stream(self, request: bigtable.ReadChangeStreamRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[bigtable.ReadChangeStreamRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_read_change_stream(self, response: rest_streaming.ResponseIterator) -> rest_streaming.ResponseIterator:
    ...
    def post_read_change_stream_with_metadata(self, response: rest_streaming.ResponseIterator, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[rest_streaming.ResponseIterator, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for read_change_stream
    ...
    def pre_read_modify_write_row(self, request: bigtable.ReadModifyWriteRowRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[bigtable.ReadModifyWriteRowRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_read_modify_write_row_with_metadata(self, response: bigtable.ReadModifyWriteRowResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[bigtable.ReadModifyWriteRowResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for read_modify_write_row
    ...
    def pre_read_rows(self, request: bigtable.ReadRowsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[bigtable.ReadRowsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_read_rows_with_metadata(self, response: rest_streaming.ResponseIterator, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[rest_streaming.ResponseIterator, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for read_rows
    ...
    def pre_sample_row_keys(self, request: bigtable.SampleRowKeysRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[bigtable.SampleRowKeysRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_sample_row_keys_with_metadata(self, response: rest_streaming.ResponseIterator, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[rest_streaming.ResponseIterator, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for sample_row_keys
...
class BigtableRestTransport(_BaseBigtableRestTransport):
    ...
    class _CheckAndMutateRow(_BaseBigtableRestTransport._BaseCheckAndMutateRow, BigtableRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options = _BaseBigtableRestTransport._BaseCheckAndMutateRow._get_http_options()

            request, metadata = self._interceptor.pre_check_and_mutate_row(request, metadata)
            transcoded_request = _BaseBigtableRestTransport._BaseCheckAndMutateRow._get_transcoded_request(http_options, request)

            body = _BaseBigtableRestTransport._BaseCheckAndMutateRow._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseBigtableRestTransport._BaseCheckAndMutateRow._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = BigtableRestTransport._CheckAndMutateRow._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            resp, _ = self._interceptor.post_check_and_mutate_row_with_metadata(resp, response_metadata)
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                try:
                    response_payload = bigtable.CheckAndMutateRowResponse.to_json(response)
                except:
    ...
    class _ExecuteQuery(_BaseBigtableRestTransport._BaseExecuteQuery, BigtableRestStub):
        ...
        def __call__(self,
            ...
            http_options = _BaseBigtableRestTransport._BaseExecuteQuery._get_http_options()

            request, metadata = self._interceptor.pre_execute_query(request, metadata)
            transcoded_request = _BaseBigtableRestTransport._BaseExecuteQuery._get_transcoded_request(http_options, request)

            body = _BaseBigtableRestTransport._BaseExecuteQuery._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseBigtableRestTransport._BaseExecuteQuery._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = BigtableRestTransport._ExecuteQuery._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            # Return the response
            resp = rest_streaming.ResponseIterator(response, bigtable.ExecuteQueryResponse)

            resp = self._interceptor.post_execute_query(resp)
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = self._interceptor.post_execute_query_with_metadata(resp, response_metadata)
            return resp

    class _GenerateInitialChangeStreamPartitions(_BaseBigtableRestTransport._BaseGenerateInitialChangeStreamPartitions, BigtableRestStub):
        def __hash__(self):
        ...
        stream partitions method over HTTP.
            ...
            request, metadata = self._interceptor.pre_generate_initial_change_stream_partitions(request, metadata)
            transcoded_request = _BaseBigtableRestTransport._BaseGenerateInitialChangeStreamPartitions._get_transcoded_request(http_options, request)

            body = _BaseBigtableRestTransport._BaseGenerateInitialChangeStreamPartitions._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseBigtableRestTransport._BaseGenerateInitialChangeStreamPartitions._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = BigtableRestTransport._GenerateInitialChangeStreamPartitions._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            # Return the response
            resp = rest_streaming.ResponseIterator(response, bigtable.GenerateInitialChangeStreamPartitionsResponse)

            resp = self._interceptor.post_generate_initial_change_stream_partitions(resp)
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = self._interceptor.post_generate_initial_change_stream_partitions_with_metadata(resp, response_metadata)
            return resp
    ...
    class _MutateRow(_BaseBigtableRestTransport._BaseMutateRow, BigtableRestStub):
        ...
        def __call__(self,
            ...
            transcoded_request = _BaseBigtableRestTransport._BaseMutateRow._get_transcoded_request(http_options, request)

            body = _BaseBigtableRestTransport._BaseMutateRow._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseBigtableRestTransport._BaseMutateRow._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = BigtableRestTransport._MutateRow._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = self._interceptor.post_mutate_row_with_metadata(resp, response_metadata)
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                try:
    ...
    class _MutateRows(_BaseBigtableRestTransport._BaseMutateRows, BigtableRestStub):
        ...
        def __call__(self,
            ...
            http_options = _BaseBigtableRestTransport._BaseMutateRows._get_http_options()

            request, metadata = self._interceptor.pre_mutate_rows(request, metadata)
            transcoded_request = _BaseBigtableRestTransport._BaseMutateRows._get_transcoded_request(http_options, request)

            body = _BaseBigtableRestTransport._BaseMutateRows._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseBigtableRestTransport._BaseMutateRows._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = BigtableRestTransport._MutateRows._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = self._interceptor.post_mutate_rows_with_metadata(resp, response_metadata)
            return resp
    ...
    class _PingAndWarm(_BaseBigtableRestTransport._BasePingAndWarm, BigtableRestStub):
        ...
        def __call__(self,
            ...
            http_options = _BaseBigtableRestTransport._BasePingAndWarm._get_http_options()

            request, metadata = self._interceptor.pre_ping_and_warm(request, metadata)
            transcoded_request = _BaseBigtableRestTransport._BasePingAndWarm._get_transcoded_request(http_options, request)

            body = _BaseBigtableRestTransport._BasePingAndWarm._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseBigtableRestTransport._BasePingAndWarm._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = BigtableRestTransport._PingAndWarm._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = self._interceptor.post_ping_and_warm_with_metadata(resp, response_metadata)
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                try:
    ...
    class _PrepareQuery(_BaseBigtableRestTransport._BasePrepareQuery, BigtableRestStub):
        ...
        def __call__(self,
            ...
            http_options = _BaseBigtableRestTransport._BasePrepareQuery._get_http_options()

            request, metadata = self._interceptor.pre_prepare_query(request, metadata)
            transcoded_request = _BaseBigtableRestTransport._BasePrepareQuery._get_transcoded_request(http_options, request)

            body = _BaseBigtableRestTransport._BasePrepareQuery._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseBigtableRestTransport._BasePrepareQuery._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = BigtableRestTransport._PrepareQuery._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = self._interceptor.post_prepare_query_with_metadata(resp, response_metadata)
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                try:
    ...
    class _ReadChangeStream(_BaseBigtableRestTransport._BaseReadChangeStream, BigtableRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options = _BaseBigtableRestTransport._BaseReadChangeStream._get_http_options()

            request, metadata = self._interceptor.pre_read_change_stream(request, metadata)
            transcoded_request = _BaseBigtableRestTransport._BaseReadChangeStream._get_transcoded_request(http_options, request)

            body = _BaseBigtableRestTransport._BaseReadChangeStream._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseBigtableRestTransport._BaseReadChangeStream._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = BigtableRestTransport._ReadChangeStream._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            # Return the response
            resp = rest_streaming.ResponseIterator(response, bigtable.ReadChangeStreamResponse)

            resp = self._interceptor.post_read_change_stream(resp)
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = self._interceptor.post_read_change_stream_with_metadata(resp, response_metadata)
            return resp

    class _ReadModifyWriteRow(_BaseBigtableRestTransport._BaseReadModifyWriteRow, BigtableRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options = _BaseBigtableRestTransport._BaseReadModifyWriteRow._get_http_options()

            request, metadata = self._interceptor.pre_read_modify_write_row(request, metadata)
            transcoded_request = _BaseBigtableRestTransport._BaseReadModifyWriteRow._get_transcoded_request(http_options, request)

            body = _BaseBigtableRestTransport._BaseReadModifyWriteRow._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseBigtableRestTransport._BaseReadModifyWriteRow._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = BigtableRestTransport._ReadModifyWriteRow._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = self._interceptor.post_read_modify_write_row_with_metadata(resp, response_metadata)
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                try:
                    response_payload = bigtable.ReadModifyWriteRowResponse.to_json(response)
                except:
                    response_payload = None
                http_response = {
                "payload": response_payload,
    ...
    class _ReadRows(_BaseBigtableRestTransport._BaseReadRows, BigtableRestStub):
        ...
        def __call__(self,
            ...
            transcoded_request = _BaseBigtableRestTransport._BaseReadRows._get_transcoded_request(http_options, request)

            body = _BaseBigtableRestTransport._BaseReadRows._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseBigtableRestTransport._BaseReadRows._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = BigtableRestTransport._ReadRows._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = self._interceptor.post_read_rows_with_metadata(resp, response_metadata)
            return resp

    class _SampleRowKeys(_BaseBigtableRestTransport._BaseSampleRowKeys, BigtableRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options = _BaseBigtableRestTransport._BaseSampleRowKeys._get_http_options()

            request, metadata = self._interceptor.pre_sample_row_keys(request, metadata)
            transcoded_request = _BaseBigtableRestTransport._BaseSampleRowKeys._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseBigtableRestTransport._BaseSampleRowKeys._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = BigtableRestTransport._SampleRowKeys._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = self._interceptor.post_sample_row_keys_with_metadata(resp, response_metadata)
            return resp
    ...
    @property
    def execute_query(self) -> Callable[
    ...
    @property
    def generate_initial_change_stream_partitions(self) -> Callable[
    ...
    @property
    def prepare_query(self) -> Callable[
    ...
    @property
    def read_change_stream(self) -> Callable[
