...
class ReadChangeStreamResponse(proto.Message):
    ...
    class DataChange(proto.Message):
        ...
        chunks: MutableSequence['ReadChangeStreamResponse.MutationChunk'] = proto.RepeatedField(
            proto.MESSAGE,
            number=6,
    ...
    class CloseStream(proto.Message):
        ...
        continuation_tokens: MutableSequence[data.StreamContinuationToken] = proto.RepeatedField(
            proto.MESSAGE,
            number=2,
            message=data.StreamContinuationToken,
        )
