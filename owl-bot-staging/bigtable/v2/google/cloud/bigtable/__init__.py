...
from google.cloud.bigtable_v2.types.request_stats import AllReadStats
from google.cloud.bigtable_v2.types.request_stats import ReadEfficiencyStats
from google.cloud.bigtable_v2.types.request_stats import ReadIteratorStats
