...
def test_read_rows_rest_required_fields(request_type=bigtable.ReadRowsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).read_rows._get_unset_required_fields(jsonified_request)
...
def test_read_rows_rest_unset_required_fields():
    transport = transports.BigtableRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_sample_row_keys_rest_required_fields(request_type=bigtable.SampleRowKeysRequest):
    transport_class = transports.BigtableRestTransport
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).sample_row_keys._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_mutate_row_rest_required_fields(request_type=bigtable.MutateRowRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).mutate_row._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_mutate_row_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("tableName", "rowKey", "mutations", )))
...
def test_mutate_rows_rest_required_fields(request_type=bigtable.MutateRowsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).mutate_rows._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_mutate_rows_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("tableName", "entries", )))
...
def test_check_and_mutate_row_rest_required_fields(request_type=bigtable.CheckAndMutateRowRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).check_and_mutate_row._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_check_and_mutate_row_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("tableName", "rowKey", )))
...
def test_ping_and_warm_rest_required_fields(request_type=bigtable.PingAndWarmRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).ping_and_warm._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_read_modify_write_row_rest_required_fields(request_type=bigtable.ReadModifyWriteRowRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).read_modify_write_row._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_read_modify_write_row_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("tableName", "rowKey", "rules", )))
...
def test_generate_initial_change_stream_partitions_rest_required_fields(request_type=bigtable.GenerateInitialChangeStreamPartitionsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).generate_initial_change_stream_partitions._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_read_change_stream_rest_required_fields(request_type=bigtable.ReadChangeStreamRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).read_change_stream._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
