...
def test_read_rows_rest_required_fields(request_type=bigtable.ReadRowsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).read_rows._get_unset_required_fields(jsonified_request)
...
def test_sample_row_keys_rest_required_fields(request_type=bigtable.SampleRowKeysRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).sample_row_keys._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
