...
async def test_read_rows_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        client._client._transport._wrapped_methods[client._client._transport.read_rows] = mock_object
...
def test_read_rows_routing_parameters():
    ...
    request = bigtable.ReadRowsRequest(**{"table_name": "projects/sample1/instances/sample2/tables/sample3"})
    ...
    # Any value that is part of the HTTP/1.1 URI should be sent as
    # a field header. Set these to a non-empty value.
    request = bigtable.ReadRowsRequest(**{"authorized_view_name": "projects/sample1/instances/sample2/tables/sample3/authorizedViews/sample4"})
...
async def test_sample_row_keys_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.sample_row_keys] = mock_object
...
def test_sample_row_keys_routing_parameters():
    ...
    # Any value that is part of the HTTP/1.1 URI should be sent as
    # a field header. Set these to a non-empty value.
    request = bigtable.SampleRowKeysRequest(**{"table_name": "projects/sample1/instances/sample2/tables/sample3"})
    ...
    # Any value that is part of the HTTP/1.1 URI should be sent as
    # a field header. Set these to a non-empty value.
    request = bigtable.SampleRowKeysRequest(**{"authorized_view_name": "projects/sample1/instances/sample2/tables/sample3/authorizedViews/sample4"})
...
async def test_mutate_row_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.mutate_row] = mock_object
...
def test_mutate_row_routing_parameters():
    ...
    # Any value that is part of the HTTP/1.1 URI should be sent as
    # a field header. Set these to a non-empty value.
    request = bigtable.MutateRowRequest(**{"table_name": "projects/sample1/instances/sample2/tables/sample3"})
    ...
    # Any value that is part of the HTTP/1.1 URI should be sent as
    # a field header. Set these to a non-empty value.
    request = bigtable.MutateRowRequest(**{"authorized_view_name": "projects/sample1/instances/sample2/tables/sample3/authorizedViews/sample4"})
...
async def test_mutate_rows_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.mutate_rows] = mock_object
...
def test_mutate_rows_routing_parameters():
    ...
    # Any value that is part of the HTTP/1.1 URI should be sent as
    # a field header. Set these to a non-empty value.
    request = bigtable.MutateRowsRequest(**{"table_name": "projects/sample1/instances/sample2/tables/sample3"})
    ...
    # Any value that is part of the HTTP/1.1 URI should be sent as
    # a field header. Set these to a non-empty value.
    request = bigtable.MutateRowsRequest(**{"authorized_view_name": "projects/sample1/instances/sample2/tables/sample3/authorizedViews/sample4"})
...
async def test_check_and_mutate_row_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.check_and_mutate_row] = mock_object
...
def test_check_and_mutate_row_routing_parameters():
    ...
    # Any value that is part of the HTTP/1.1 URI should be sent as
    # a field header. Set these to a non-empty value.
    request = bigtable.CheckAndMutateRowRequest(**{"table_name": "projects/sample1/instances/sample2/tables/sample3"})
    ...
    # Any value that is part of the HTTP/1.1 URI should be sent as
    # a field header. Set these to a non-empty value.
    request = bigtable.CheckAndMutateRowRequest(**{"authorized_view_name": "projects/sample1/instances/sample2/tables/sample3/authorizedViews/sample4"})
...
async def test_ping_and_warm_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.ping_and_warm] = mock_object
...
def test_ping_and_warm_routing_parameters():
    ...
    # Any value that is part of the HTTP/1.1 URI should be sent as
    # a field header. Set these to a non-empty value.
    request = bigtable.PingAndWarmRequest(**{"name": "projects/sample1/instances/sample2"})
...
async def test_read_modify_write_row_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.read_modify_write_row] = mock_object
...
def test_read_modify_write_row_routing_parameters():
    ...
    # Any value that is part of the HTTP/1.1 URI should be sent as
    # a field header. Set these to a non-empty value.
    request = bigtable.ReadModifyWriteRowRequest(**{"table_name": "projects/sample1/instances/sample2/tables/sample3"})
    ...
    # Any value that is part of the HTTP/1.1 URI should be sent as
    # a field header. Set these to a non-empty value.
    request = bigtable.ReadModifyWriteRowRequest(**{"authorized_view_name": "projects/sample1/instances/sample2/tables/sample3/authorizedViews/sample4"})
...
async def test_generate_initial_change_stream_partitions_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.generate_initial_change_stream_partitions] = mock_object
...
async def test_read_change_stream_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.read_change_stream] = mock_object
...
async def test_execute_query_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.execute_query] = mock_object
...
def test_execute_query_routing_parameters():
    ...
    # Any value that is part of the HTTP/1.1 URI should be sent as
    # a field header. Set these to a non-empty value.
    request = bigtable.ExecuteQueryRequest(**{"instance_name": "projects/sample1/instances/sample2"})
...
def test_read_rows_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value._content = bigtable.ReadRowsResponse.to_json(bigtable.ReadRowsResponse())
...
def test_read_rows_rest_bad_request(transport: str = 'rest', request_type=bigtable.ReadRowsRequest):
    client = BigtableClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_sample_row_keys_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = bigtable.SampleRowKeysResponse.to_json(bigtable.SampleRowKeysResponse())
        req.return_value._content = "[{}]".format(req.return_value._content)
...
def test_sample_row_keys_rest_bad_request(transport: str = 'rest', request_type=bigtable.SampleRowKeysRequest):
    client = BigtableClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_mutate_row_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = bigtable.MutateRowResponse.to_json(bigtable.MutateRowResponse())
...
def test_mutate_row_rest_bad_request(transport: str = 'rest', request_type=bigtable.MutateRowRequest):
    client = BigtableClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_mutate_rows_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = bigtable.MutateRowsResponse.to_json(bigtable.MutateRowsResponse())
        req.return_value._content = "[{}]".format(req.return_value._content)
...
def test_mutate_rows_rest_bad_request(transport: str = 'rest', request_type=bigtable.MutateRowsRequest):
    client = BigtableClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_check_and_mutate_row_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = bigtable.CheckAndMutateRowResponse.to_json(bigtable.CheckAndMutateRowResponse())
...
def test_check_and_mutate_row_rest_bad_request(transport: str = 'rest', request_type=bigtable.CheckAndMutateRowRequest):
    client = BigtableClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_ping_and_warm_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = bigtable.PingAndWarmResponse.to_json(bigtable.PingAndWarmResponse())
...
def test_ping_and_warm_rest_bad_request(transport: str = 'rest', request_type=bigtable.PingAndWarmRequest):
    client = BigtableClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_read_modify_write_row_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = bigtable.ReadModifyWriteRowResponse.to_json(bigtable.ReadModifyWriteRowResponse())
...
def test_read_modify_write_row_rest_bad_request(transport: str = 'rest', request_type=bigtable.ReadModifyWriteRowRequest):
    client = BigtableClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_generate_initial_change_stream_partitions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = bigtable.GenerateInitialChangeStreamPartitionsResponse.to_json(bigtable.GenerateInitialChangeStreamPartitionsResponse())
        req.return_value._content = "[{}]".format(req.return_value._content)
...
def test_generate_initial_change_stream_partitions_rest_bad_request(transport: str = 'rest', request_type=bigtable.GenerateInitialChangeStreamPartitionsRequest):
    client = BigtableClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_read_change_stream_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = bigtable.ReadChangeStreamResponse.to_json(bigtable.ReadChangeStreamResponse())
        req.return_value._content = "[{}]".format(req.return_value._content)
...
def test_read_change_stream_rest_bad_request(transport: str = 'rest', request_type=bigtable.ReadChangeStreamRequest):
    client = BigtableClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_execute_query_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = bigtable.ExecuteQueryResponse.to_json(bigtable.ExecuteQueryResponse())
        req.return_value._content = "[{}]".format(req.return_value._content)
...
def test_execute_query_rest_bad_request(transport: str = 'rest', request_type=bigtable.ExecuteQueryRequest):
    client = BigtableClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
