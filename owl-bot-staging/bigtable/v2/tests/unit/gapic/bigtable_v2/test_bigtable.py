...
def test_read_rows_routing_parameters_request_3_grpc():
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = iter([bigtable.ReadRowsResponse()])
        client.read_rows(request={"authorized_view_name": "projects/sample1/instances/sample2/tables/sample3/authorizedViews/sample4"})

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, kw = call.mock_calls[0]
        request_msg = bigtable.ReadRowsRequest(**{"authorized_view_name": "projects/sample1/instances/sample2/tables/sample3/authorizedViews/sample4"})

        assert args[0] == request_msg

        expected_headers = {'authorized_view_name': 'projects/sample1/instances/sample2/tables/sample3/authorizedViews/sample4'}
        assert gapic_v1.routing_header.to_grpc_metadata(expected_headers) in kw['metadata']
...
def test_sample_row_keys_routing_parameters_request_3_grpc():
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = iter([bigtable.SampleRowKeysResponse()])
        client.sample_row_keys(request={"authorized_view_name": "projects/sample1/instances/sample2/tables/sample3/authorizedViews/sample4"})

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, kw = call.mock_calls[0]
        request_msg = bigtable.SampleRowKeysRequest(**{"authorized_view_name": "projects/sample1/instances/sample2/tables/sample3/authorizedViews/sample4"})
...
def test_mutate_row_routing_parameters_request_3_grpc():
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = bigtable.MutateRowResponse()
        client.mutate_row(request={"authorized_view_name": "projects/sample1/instances/sample2/tables/sample3/authorizedViews/sample4"})

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, kw = call.mock_calls[0]
        request_msg = bigtable.MutateRowRequest(**{"authorized_view_name": "projects/sample1/instances/sample2/tables/sample3/authorizedViews/sample4"})
...
def test_mutate_rows_routing_parameters_request_3_grpc():
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = iter([bigtable.MutateRowsResponse()])
        client.mutate_rows(request={"authorized_view_name": "projects/sample1/instances/sample2/tables/sample3/authorizedViews/sample4"})

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, kw = call.mock_calls[0]
        request_msg = bigtable.MutateRowsRequest(**{"authorized_view_name": "projects/sample1/instances/sample2/tables/sample3/authorizedViews/sample4"})
...
def test_check_and_mutate_row_routing_parameters_request_3_grpc():
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = bigtable.CheckAndMutateRowResponse()
        client.check_and_mutate_row(request={"authorized_view_name": "projects/sample1/instances/sample2/tables/sample3/authorizedViews/sample4"})

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, kw = call.mock_calls[0]
        request_msg = bigtable.CheckAndMutateRowRequest(**{"authorized_view_name": "projects/sample1/instances/sample2/tables/sample3/authorizedViews/sample4"})
...
def test_read_modify_write_row_routing_parameters_request_3_grpc():
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = bigtable.ReadModifyWriteRowResponse()
        client.read_modify_write_row(request={"authorized_view_name": "projects/sample1/instances/sample2/tables/sample3/authorizedViews/sample4"})

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, kw = call.mock_calls[0]
        request_msg = bigtable.ReadModifyWriteRowRequest(**{"authorized_view_name": "projects/sample1/instances/sample2/tables/sample3/authorizedViews/sample4"})
...
async def test_read_rows_routing_parameters_request_3_grpc_asyncio():
    ...
    with mock.patch.object(
        ...
        call.return_value = mock.Mock(aio.UnaryStreamCall, autospec=True)
        call.return_value.read = mock.AsyncMock(side_effect=[bigtable.ReadRowsResponse()])
        await client.read_rows(request={"authorized_view_name": "projects/sample1/instances/sample2/tables/sample3/authorizedViews/sample4"})
...
async def test_sample_row_keys_routing_parameters_request_3_grpc_asyncio():
    ...
    with mock.patch.object(
        ...
        call.return_value = mock.Mock(aio.UnaryStreamCall, autospec=True)
        call.return_value.read = mock.AsyncMock(side_effect=[bigtable.SampleRowKeysResponse()])
        await client.sample_row_keys(request={"authorized_view_name": "projects/sample1/instances/sample2/tables/sample3/authorizedViews/sample4"})
...
async def test_mutate_row_routing_parameters_request_3_grpc_asyncio():
    ...
    with mock.patch.object(
        ...
        await client.mutate_row(request={"authorized_view_name": "projects/sample1/instances/sample2/tables/sample3/authorizedViews/sample4"})
...
async def test_mutate_rows_routing_parameters_request_3_grpc_asyncio():
    ...
    with mock.patch.object(
        ...
        call.return_value = mock.Mock(aio.UnaryStreamCall, autospec=True)
        call.return_value.read = mock.AsyncMock(side_effect=[bigtable.MutateRowsResponse()])
        await client.mutate_rows(request={"authorized_view_name": "projects/sample1/instances/sample2/tables/sample3/authorizedViews/sample4"})
...
async def test_check_and_mutate_row_routing_parameters_request_3_grpc_asyncio():
    ...
    with mock.patch.object(
        ...
        await client.check_and_mutate_row(request={"authorized_view_name": "projects/sample1/instances/sample2/tables/sample3/authorizedViews/sample4"})
...
async def test_read_modify_write_row_routing_parameters_request_3_grpc_asyncio():
    ...
    with mock.patch.object(
        ...
        await client.read_modify_write_row(request={"authorized_view_name": "projects/sample1/instances/sample2/tables/sample3/authorizedViews/sample4"})
