...
def test__read_environment_variables():
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert BigtableClient._read_environment_variables() == (False, "auto", "foo.com")
...
def test__get_client_cert_source():
    ...
    assert BigtableClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert BigtableClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch('google.auth.transport.mtls.has_default_client_cert_source', return_value=True):
        with mock.patch('google.auth.transport.mtls.default_client_cert_source', return_value=mock_default_cert_source):
            assert BigtableClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert BigtableClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source

@mock.patch.object(BigtableClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(BigtableClient))
@mock.patch.object(BigtableAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(BigtableAsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = BigtableClient._DEFAULT_UNIVERSE
    default_endpoint = BigtableClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = BigtableClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert BigtableClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert BigtableClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == BigtableClient.DEFAULT_MTLS_ENDPOINT
    assert BigtableClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert BigtableClient._get_api_endpoint(None, None, default_universe, "always") == BigtableClient.DEFAULT_MTLS_ENDPOINT
    assert BigtableClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == BigtableClient.DEFAULT_MTLS_ENDPOINT
    assert BigtableClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert BigtableClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        BigtableClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert BigtableClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert BigtableClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert BigtableClient._get_universe_domain(None, None) == BigtableClient._DEFAULT_UNIVERSE
...
def test_bigtable_client_service_account_always_use_jwt(transport_class, transport_name):
...
@pytest.mark.parametrize("client_class", [
    BigtableClient, BigtableAsyncClient
])
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    ...
    (BigtableAsyncClient, transports.BigtableGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
    (BigtableClient, transports.BigtableRestTransport, "rest", None),
])
def test_bigtable_client_client_options_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
...
def test_bigtable_client_create_channel_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
    # Check the case credentials file is provided.
    options = client_options.ClientOptions(
        credentials_file="credentials.json"
    )
...
@pytest.mark.asyncio
async def test_sample_row_keys_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = BigtableAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.sample_row_keys in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.sample_row_keys] = mock_rpc
...
async def test_mutate_row_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.mutate_row in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.mutate_row] = mock_rpc
...
@pytest.mark.asyncio
async def test_mutate_rows_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = BigtableAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.mutate_rows in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.mutate_rows] = mock_rpc
...
def test_check_and_mutate_row_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.check_and_mutate_row in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.check_and_mutate_row] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_check_and_mutate_row_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = BigtableAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.check_and_mutate_row in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.check_and_mutate_row] = mock_rpc
...
def test_ping_and_warm(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.ping_and_warm),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_ping_and_warm_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = BigtableAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.ping_and_warm in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.ping_and_warm] = mock_rpc
...
@pytest.mark.asyncio
async def test_ping_and_warm_async(transport: str = 'grpc_asyncio', request_type=bigtable.PingAndWarmRequest):
    client = BigtableAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(bigtable.PingAndWarmResponse(
        ))
...
def test_read_modify_write_row_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.read_modify_write_row in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.read_modify_write_row] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_read_modify_write_row_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = BigtableAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.read_modify_write_row in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.read_modify_write_row] = mock_rpc
...
def test_generate_initial_change_stream_partitions(request_type, transport: str = 'grpc'):
    client = BigtableClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.generate_initial_change_stream_partitions),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = iter([bigtable.GenerateInitialChangeStreamPartitionsResponse()])
...
def test_generate_initial_change_stream_partitions_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.generate_initial_change_stream_partitions in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.generate_initial_change_stream_partitions] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_generate_initial_change_stream_partitions_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = BigtableAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.generate_initial_change_stream_partitions in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.generate_initial_change_stream_partitions] = mock_rpc
...
@pytest.mark.asyncio
async def test_generate_initial_change_stream_partitions_async(transport: str = 'grpc_asyncio', request_type=bigtable.GenerateInitialChangeStreamPartitionsRequest):
    client = BigtableAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
        ...
        # Designate an appropriate return value for the call.
        call.return_value = mock.Mock(aio.UnaryStreamCall, autospec=True)
        call.return_value.read = mock.AsyncMock(side_effect=[bigtable.GenerateInitialChangeStreamPartitionsResponse()])
...
def test_read_change_stream(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.read_change_stream),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_read_change_stream_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.read_change_stream in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.read_change_stream] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_read_change_stream_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = BigtableAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.read_change_stream in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.read_change_stream] = mock_rpc
...
@pytest.mark.asyncio
async def test_read_change_stream_async(transport: str = 'grpc_asyncio', request_type=bigtable.ReadChangeStreamRequest):
    client = BigtableAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
        ...
        # Designate an appropriate return value for the call.
        call.return_value = mock.Mock(aio.UnaryStreamCall, autospec=True)
        call.return_value.read = mock.AsyncMock(side_effect=[bigtable.ReadChangeStreamResponse()])
...
def test_prepare_query(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.prepare_query),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_prepare_query_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = BigtableAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.prepare_query in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.prepare_query] = mock_rpc
...
@pytest.mark.asyncio
async def test_prepare_query_async(transport: str = 'grpc_asyncio', request_type=bigtable.PrepareQueryRequest):
    client = BigtableAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(bigtable.PrepareQueryResponse(
            prepared_query=b'prepared_query_blob',
        ))
...
def test_execute_query(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.execute_query),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_execute_query_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = BigtableAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.execute_query in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.execute_query] = mock_rpc
...
@pytest.mark.asyncio
async def test_execute_query_async(transport: str = 'grpc_asyncio', request_type=bigtable.ExecuteQueryRequest):
    client = BigtableAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
        ...
        # Designate an appropriate return value for the call.
        call.return_value = mock.Mock(aio.UnaryStreamCall, autospec=True)
        call.return_value.read = mock.AsyncMock(side_effect=[bigtable.ExecuteQueryResponse()])
...
def test_read_rows_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        sample_request = {'table_name': 'projects/sample1/instances/sample2/tables/sample3'}
        ...
        assert path_template.validate("%s/v2/{table_name=projects/*/instances/*/tables/*}:readRows" % client.transport._host, args[1])
...
def test_sample_row_keys_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2/{table_name=projects/*/instances/*/tables/*}:sampleRowKeys" % client.transport._host, args[1])
...
def test_mutate_row_rest_required_fields(request_type=bigtable.MutateRowRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).mutate_row._get_unset_required_fields(jsonified_request)
...
def test_mutate_row_rest_unset_required_fields():
    transport = transports.BigtableRestTransport(credentials=ga_credentials.AnonymousCredentials)

    unset_fields = transport.mutate_row._get_unset_required_fields({})
    assert set(unset_fields) == (set(()) & set(("rowKey", "mutations", )))
...
def test_mutate_row_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2/{table_name=projects/*/instances/*/tables/*}:mutateRow" % client.transport._host, args[1])
...
def test_mutate_rows_rest_required_fields(request_type=bigtable.MutateRowsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).mutate_rows._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_mutate_rows_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2/{table_name=projects/*/instances/*/tables/*}:mutateRows" % client.transport._host, args[1])
...
def test_check_and_mutate_row_rest_required_fields(request_type=bigtable.CheckAndMutateRowRequest):
    transport_class = transports.BigtableRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).check_and_mutate_row._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_check_and_mutate_row_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2/{table_name=projects/*/instances/*/tables/*}:checkAndMutateRow" % client.transport._host, args[1])
...
def test_ping_and_warm_rest_required_fields(request_type=bigtable.PingAndWarmRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).ping_and_warm._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_ping_and_warm_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2/{name=projects/*/instances/*}:ping" % client.transport._host, args[1])
...
def test_read_modify_write_row_rest_required_fields(request_type=bigtable.ReadModifyWriteRowRequest):
    transport_class = transports.BigtableRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).read_modify_write_row._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_read_modify_write_row_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("rowKey", "rules", )))
...
def test_read_modify_write_row_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2/{table_name=projects/*/instances/*/tables/*}:readModifyWriteRow" % client.transport._host, args[1])
...
def test_generate_initial_change_stream_partitions_rest_required_fields(request_type=bigtable.GenerateInitialChangeStreamPartitionsRequest):
    transport_class = transports.BigtableRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).generate_initial_change_stream_partitions._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        with mock.patch.object(path_template, 'transcode') as transcode:
            ...
            # Convert return value to protobuf type
            return_value = bigtable.GenerateInitialChangeStreamPartitionsResponse.pb(return_value)
            json_return_value = json_format.MessageToJson(return_value)
            json_return_value = "[{}]".format(json_return_value)
...
def test_generate_initial_change_stream_partitions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2/{table_name=projects/*/instances/*/tables/*}:generateInitialChangeStreamPartitions" % client.transport._host, args[1])


def test_generate_initial_change_stream_partitions_rest_flattened_error(transport: str = 'rest'):
    client = BigtableClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_read_change_stream_rest_required_fields(request_type=bigtable.ReadChangeStreamRequest):
    transport_class = transports.BigtableRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).read_change_stream._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_read_change_stream_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2/{table_name=projects/*/instances/*/tables/*}:readChangeStream" % client.transport._host, args[1])
...
def test_prepare_query_rest_required_fields(request_type=bigtable.PrepareQueryRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).prepare_query._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_prepare_query_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("instanceName", "query", "paramTypes", )))
...
def test_prepare_query_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2/{instance_name=projects/*/instances/*}:prepareQuery" % client.transport._host, args[1])
...
def test_execute_query_rest_required_fields(request_type=bigtable.ExecuteQueryRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).execute_query._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_execute_query_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("instanceName", "query", "params", )))
...
def test_execute_query_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2/{instance_name=projects/*/instances/*}:executeQuery" % client.transport._host, args[1])
...
def test_read_rows_routing_parameters_request_1_grpc():
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = iter([bigtable.ReadRowsResponse()])
        client.read_rows(request={"table_name": "projects/sample1/instances/sample2/tables/sample3"})

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, kw = call.mock_calls[0]
        request_msg = bigtable.ReadRowsRequest(**{"table_name": "projects/sample1/instances/sample2/tables/sample3"})

        assert args[0] == request_msg

        expected_headers = {'table_name': 'projects/sample1/instances/sample2/tables/sample3'}
...
def test_read_rows_routing_parameters_request_3_grpc():
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = iter([bigtable.ReadRowsResponse()])
        client.read_rows(request={"authorized_view_name": "projects/sample1/instances/sample2/tables/sample3/sample4"})

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, kw = call.mock_calls[0]
        request_msg = bigtable.ReadRowsRequest(**{"authorized_view_name": "projects/sample1/instances/sample2/tables/sample3/sample4"})
...
def test_read_rows_routing_parameters_request_4_grpc():
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = iter([bigtable.ReadRowsResponse()])
        client.read_rows(request={"materialized_view_name": "projects/sample1/instances/sample2/sample3"})

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, kw = call.mock_calls[0]
        request_msg = bigtable.ReadRowsRequest(**{"materialized_view_name": "projects/sample1/instances/sample2/sample3"})
...
def test_sample_row_keys_routing_parameters_request_1_grpc():
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = iter([bigtable.SampleRowKeysResponse()])
        client.sample_row_keys(request={"table_name": "projects/sample1/instances/sample2/tables/sample3"})

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, kw = call.mock_calls[0]
        request_msg = bigtable.SampleRowKeysRequest(**{"table_name": "projects/sample1/instances/sample2/tables/sample3"})
...
def test_sample_row_keys_routing_parameters_request_3_grpc():
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = iter([bigtable.SampleRowKeysResponse()])
        client.sample_row_keys(request={"authorized_view_name": "projects/sample1/instances/sample2/tables/sample3/sample4"})

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, kw = call.mock_calls[0]
        request_msg = bigtable.SampleRowKeysRequest(**{"authorized_view_name": "projects/sample1/instances/sample2/tables/sample3/sample4"})
...
def test_sample_row_keys_routing_parameters_request_4_grpc():
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = iter([bigtable.SampleRowKeysResponse()])
        client.sample_row_keys(request={"materialized_view_name": "projects/sample1/instances/sample2/sample3"})

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, kw = call.mock_calls[0]
        request_msg = bigtable.SampleRowKeysRequest(**{"materialized_view_name": "projects/sample1/instances/sample2/sample3"})
...
def test_mutate_row_routing_parameters_request_1_grpc():
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = bigtable.MutateRowResponse()
        client.mutate_row(request={"table_name": "projects/sample1/instances/sample2/tables/sample3"})

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, kw = call.mock_calls[0]
        request_msg = bigtable.MutateRowRequest(**{"table_name": "projects/sample1/instances/sample2/tables/sample3"})
...
def test_mutate_row_routing_parameters_request_3_grpc():
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = bigtable.MutateRowResponse()
        client.mutate_row(request={"authorized_view_name": "projects/sample1/instances/sample2/tables/sample3/sample4"})

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, kw = call.mock_calls[0]
        request_msg = bigtable.MutateRowRequest(**{"authorized_view_name": "projects/sample1/instances/sample2/tables/sample3/sample4"})
...
def test_mutate_rows_routing_parameters_request_1_grpc():
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = iter([bigtable.MutateRowsResponse()])
        client.mutate_rows(request={"table_name": "projects/sample1/instances/sample2/tables/sample3"})

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, kw = call.mock_calls[0]
        request_msg = bigtable.MutateRowsRequest(**{"table_name": "projects/sample1/instances/sample2/tables/sample3"})
...
def test_mutate_rows_routing_parameters_request_3_grpc():
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = iter([bigtable.MutateRowsResponse()])
        client.mutate_rows(request={"authorized_view_name": "projects/sample1/instances/sample2/tables/sample3/sample4"})

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, kw = call.mock_calls[0]
        request_msg = bigtable.MutateRowsRequest(**{"authorized_view_name": "projects/sample1/instances/sample2/tables/sample3/sample4"})
...
def test_check_and_mutate_row_routing_parameters_request_1_grpc():
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = bigtable.CheckAndMutateRowResponse()
        client.check_and_mutate_row(request={"table_name": "projects/sample1/instances/sample2/tables/sample3"})

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, kw = call.mock_calls[0]
        request_msg = bigtable.CheckAndMutateRowRequest(**{"table_name": "projects/sample1/instances/sample2/tables/sample3"})
...
def test_check_and_mutate_row_routing_parameters_request_3_grpc():
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = bigtable.CheckAndMutateRowResponse()
        client.check_and_mutate_row(request={"authorized_view_name": "projects/sample1/instances/sample2/tables/sample3/sample4"})

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, kw = call.mock_calls[0]
        request_msg = bigtable.CheckAndMutateRowRequest(**{"authorized_view_name": "projects/sample1/instances/sample2/tables/sample3/sample4"})
...
def test_ping_and_warm_routing_parameters_request_1_grpc():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, kw = call.mock_calls[0]
        request_msg = bigtable.PingAndWarmRequest(**{"name": "projects/sample1/instances/sample2"})
...
def test_read_modify_write_row_routing_parameters_request_1_grpc():
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = bigtable.ReadModifyWriteRowResponse()
        client.read_modify_write_row(request={"table_name": "projects/sample1/instances/sample2/tables/sample3"})

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, kw = call.mock_calls[0]
        request_msg = bigtable.ReadModifyWriteRowRequest(**{"table_name": "projects/sample1/instances/sample2/tables/sample3"})
...
def test_read_modify_write_row_routing_parameters_request_2_grpc():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, kw = call.mock_calls[0]
        request_msg = bigtable.ReadModifyWriteRowRequest(**{"app_profile_id": "sample1"})
...
def test_read_modify_write_row_routing_parameters_request_3_grpc():
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = bigtable.ReadModifyWriteRowResponse()
        client.read_modify_write_row(request={"authorized_view_name": "projects/sample1/instances/sample2/tables/sample3/sample4"})

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, kw = call.mock_calls[0]
        request_msg = bigtable.ReadModifyWriteRowRequest(**{"authorized_view_name": "projects/sample1/instances/sample2/tables/sample3/sample4"})
...
def test_prepare_query_routing_parameters_request_1_grpc():
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = bigtable.PrepareQueryResponse()
        client.prepare_query(request={"instance_name": "projects/sample1/instances/sample2"})

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, kw = call.mock_calls[0]
        request_msg = bigtable.PrepareQueryRequest(**{"instance_name": "projects/sample1/instances/sample2"})
...
def test_execute_query_routing_parameters_request_1_grpc():
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = iter([bigtable.ExecuteQueryResponse()])
        client.execute_query(request={"instance_name": "projects/sample1/instances/sample2"})

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, kw = call.mock_calls[0]
        request_msg = bigtable.ExecuteQueryRequest(**{"instance_name": "projects/sample1/instances/sample2"})
...
async def test_read_rows_routing_parameters_request_1_grpc_asyncio():
    ...
    with mock.patch.object(
        ...
        call.return_value = mock.Mock(aio.UnaryStreamCall, autospec=True)
        call.return_value.read = mock.AsyncMock(side_effect=[bigtable.ReadRowsResponse()])
        await client.read_rows(request={"table_name": "projects/sample1/instances/sample2/tables/sample3"})
...
async def test_read_rows_routing_parameters_request_3_grpc_asyncio():
    ...
    with mock.patch.object(
        ...
        call.return_value = mock.Mock(aio.UnaryStreamCall, autospec=True)
        call.return_value.read = mock.AsyncMock(side_effect=[bigtable.ReadRowsResponse()])
        await client.read_rows(request={"authorized_view_name": "projects/sample1/instances/sample2/tables/sample3/sample4"})
...
async def test_read_rows_routing_parameters_request_4_grpc_asyncio():
    ...
    with mock.patch.object(
        ...
        call.return_value = mock.Mock(aio.UnaryStreamCall, autospec=True)
        call.return_value.read = mock.AsyncMock(side_effect=[bigtable.ReadRowsResponse()])
        await client.read_rows(request={"materialized_view_name": "projects/sample1/instances/sample2/sample3"})
...
async def test_sample_row_keys_routing_parameters_request_1_grpc_asyncio():
    ...
    with mock.patch.object(
        ...
        call.return_value = mock.Mock(aio.UnaryStreamCall, autospec=True)
        call.return_value.read = mock.AsyncMock(side_effect=[bigtable.SampleRowKeysResponse()])
        await client.sample_row_keys(request={"table_name": "projects/sample1/instances/sample2/tables/sample3"})
...
async def test_sample_row_keys_routing_parameters_request_3_grpc_asyncio():
    ...
    with mock.patch.object(
        ...
        call.return_value = mock.Mock(aio.UnaryStreamCall, autospec=True)
        call.return_value.read = mock.AsyncMock(side_effect=[bigtable.SampleRowKeysResponse()])
        await client.sample_row_keys(request={"authorized_view_name": "projects/sample1/instances/sample2/tables/sample3/sample4"})
...
async def test_sample_row_keys_routing_parameters_request_4_grpc_asyncio():
    ...
    with mock.patch.object(
        ...
        call.return_value = mock.Mock(aio.UnaryStreamCall, autospec=True)
        call.return_value.read = mock.AsyncMock(side_effect=[bigtable.SampleRowKeysResponse()])
        await client.sample_row_keys(request={"materialized_view_name": "projects/sample1/instances/sample2/sample3"})
...
async def test_mutate_row_routing_parameters_request_1_grpc_asyncio():
    ...
    with mock.patch.object(
        ...
        await client.mutate_row(request={"table_name": "projects/sample1/instances/sample2/tables/sample3"})
...
async def test_mutate_row_routing_parameters_request_3_grpc_asyncio():
    ...
    with mock.patch.object(
        ...
        await client.mutate_row(request={"authorized_view_name": "projects/sample1/instances/sample2/tables/sample3/sample4"})
...
async def test_mutate_rows_routing_parameters_request_1_grpc_asyncio():
    ...
    with mock.patch.object(
        ...
        call.return_value = mock.Mock(aio.UnaryStreamCall, autospec=True)
        call.return_value.read = mock.AsyncMock(side_effect=[bigtable.MutateRowsResponse()])
        await client.mutate_rows(request={"table_name": "projects/sample1/instances/sample2/tables/sample3"})
...
async def test_mutate_rows_routing_parameters_request_3_grpc_asyncio():
    ...
    with mock.patch.object(
        ...
        call.return_value = mock.Mock(aio.UnaryStreamCall, autospec=True)
        call.return_value.read = mock.AsyncMock(side_effect=[bigtable.MutateRowsResponse()])
        await client.mutate_rows(request={"authorized_view_name": "projects/sample1/instances/sample2/tables/sample3/sample4"})
...
async def test_check_and_mutate_row_routing_parameters_request_1_grpc_asyncio():
    ...
    with mock.patch.object(
        ...
        await client.check_and_mutate_row(request={"table_name": "projects/sample1/instances/sample2/tables/sample3"})
...
async def test_check_and_mutate_row_routing_parameters_request_3_grpc_asyncio():
    ...
    with mock.patch.object(
        ...
        await client.check_and_mutate_row(request={"authorized_view_name": "projects/sample1/instances/sample2/tables/sample3/sample4"})
...
async def test_ping_and_warm_routing_parameters_request_1_grpc_asyncio():
    ...
    with mock.patch.object(
        ...
        await client.ping_and_warm(request={"name": "projects/sample1/instances/sample2"})
...
async def test_read_modify_write_row_routing_parameters_request_1_grpc_asyncio():
    ...
    with mock.patch.object(
        ...
        await client.read_modify_write_row(request={"table_name": "projects/sample1/instances/sample2/tables/sample3"})
...
async def test_read_modify_write_row_routing_parameters_request_3_grpc_asyncio():
    ...
    with mock.patch.object(
        ...
        await client.read_modify_write_row(request={"authorized_view_name": "projects/sample1/instances/sample2/tables/sample3/sample4"})
...
async def test_prepare_query_routing_parameters_request_1_grpc_asyncio():
    ...
    with mock.patch.object(
        ...
        await client.prepare_query(request={"instance_name": "projects/sample1/instances/sample2"})
...
async def test_execute_query_routing_parameters_request_1_grpc_asyncio():
    ...
    with mock.patch.object(
        ...
        call.return_value = mock.Mock(aio.UnaryStreamCall, autospec=True)
        call.return_value.read = mock.AsyncMock(side_effect=[bigtable.ExecuteQueryResponse()])
        await client.execute_query(request={"instance_name": "projects/sample1/instances/sample2"})
...
def test_read_rows_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.BigtableRestInterceptor, "post_read_rows_with_metadata") as post_with_metadata, \
        ...
        client.read_rows(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_sample_row_keys_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.BigtableRestInterceptor, "post_sample_row_keys") as post, \
        mock.patch.object(transports.BigtableRestInterceptor, "post_sample_row_keys_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BigtableRestInterceptor, "pre_sample_row_keys") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = bigtable.SampleRowKeysResponse.to_json(bigtable.SampleRowKeysResponse())
        req.return_value.iter_content = mock.Mock(return_value=iter(return_value))
        ...
        client.sample_row_keys(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_mutate_row_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.BigtableRestInterceptor, "post_mutate_row") as post, \
        mock.patch.object(transports.BigtableRestInterceptor, "post_mutate_row_with_metadata") as post_with_metadata, \
        ...
        client.mutate_row(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_mutate_rows_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.BigtableRestInterceptor, "post_mutate_rows") as post, \
        mock.patch.object(transports.BigtableRestInterceptor, "post_mutate_rows_with_metadata") as post_with_metadata, \
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = bigtable.MutateRowsResponse.to_json(bigtable.MutateRowsResponse())
        req.return_value.iter_content = mock.Mock(return_value=iter(return_value))
        ...
        client.mutate_rows(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_check_and_mutate_row_rest_bad_request(request_type=bigtable.CheckAndMutateRowRequest):
    client = BigtableClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_check_and_mutate_row_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.BigtableRestInterceptor, "post_check_and_mutate_row") as post, \
        mock.patch.object(transports.BigtableRestInterceptor, "post_check_and_mutate_row_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BigtableRestInterceptor, "pre_check_and_mutate_row") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = bigtable.CheckAndMutateRowRequest.pb(bigtable.CheckAndMutateRowRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = bigtable.CheckAndMutateRowResponse.to_json(bigtable.CheckAndMutateRowResponse())
        req.return_value.content = return_value
        ...
        client.check_and_mutate_row(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_ping_and_warm_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.BigtableRestInterceptor, "post_ping_and_warm") as post, \
        mock.patch.object(transports.BigtableRestInterceptor, "post_ping_and_warm_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BigtableRestInterceptor, "pre_ping_and_warm") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = bigtable.PingAndWarmResponse.to_json(bigtable.PingAndWarmResponse())
        req.return_value.content = return_value
        ...
        client.ping_and_warm(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_read_modify_write_row_rest_bad_request(request_type=bigtable.ReadModifyWriteRowRequest):
    client = BigtableClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_read_modify_write_row_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.BigtableRestInterceptor, "post_read_modify_write_row") as post, \
        mock.patch.object(transports.BigtableRestInterceptor, "post_read_modify_write_row_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BigtableRestInterceptor, "pre_read_modify_write_row") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = bigtable.ReadModifyWriteRowRequest.pb(bigtable.ReadModifyWriteRowRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = bigtable.ReadModifyWriteRowResponse.to_json(bigtable.ReadModifyWriteRowResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = bigtable.ReadModifyWriteRowResponse(), metadata

        client.read_modify_write_row(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_generate_initial_change_stream_partitions_rest_bad_request(request_type=bigtable.GenerateInitialChangeStreamPartitionsRequest):
    client = BigtableClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_generate_initial_change_stream_partitions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.BigtableRestInterceptor, "post_generate_initial_change_stream_partitions") as post, \
        mock.patch.object(transports.BigtableRestInterceptor, "post_generate_initial_change_stream_partitions_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BigtableRestInterceptor, "pre_generate_initial_change_stream_partitions") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = bigtable.GenerateInitialChangeStreamPartitionsRequest.pb(bigtable.GenerateInitialChangeStreamPartitionsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = bigtable.GenerateInitialChangeStreamPartitionsResponse.to_json(bigtable.GenerateInitialChangeStreamPartitionsResponse())
        req.return_value.iter_content = mock.Mock(return_value=iter(return_value))
        ...
        post_with_metadata.return_value = bigtable.GenerateInitialChangeStreamPartitionsResponse(), metadata

        client.generate_initial_change_stream_partitions(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_read_change_stream_rest_bad_request(request_type=bigtable.ReadChangeStreamRequest):
    client = BigtableClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_read_change_stream_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.BigtableRestInterceptor, "post_read_change_stream") as post, \
        mock.patch.object(transports.BigtableRestInterceptor, "post_read_change_stream_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BigtableRestInterceptor, "pre_read_change_stream") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = bigtable.ReadChangeStreamRequest.pb(bigtable.ReadChangeStreamRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = bigtable.ReadChangeStreamResponse.to_json(bigtable.ReadChangeStreamResponse())
        req.return_value.iter_content = mock.Mock(return_value=iter(return_value))
        ...
        client.read_change_stream(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_prepare_query_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.BigtableRestInterceptor, "post_prepare_query") as post, \
        mock.patch.object(transports.BigtableRestInterceptor, "post_prepare_query_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BigtableRestInterceptor, "pre_prepare_query") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = bigtable.PrepareQueryResponse.to_json(bigtable.PrepareQueryResponse())
        req.return_value.content = return_value
        ...
        client.prepare_query(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_execute_query_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.BigtableRestInterceptor, "post_execute_query") as post, \
        mock.patch.object(transports.BigtableRestInterceptor, "post_execute_query_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BigtableRestInterceptor, "pre_execute_query") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = bigtable.ExecuteQueryResponse.to_json(bigtable.ExecuteQueryResponse())
        req.return_value.iter_content = mock.Mock(return_value=iter(return_value))
        ...
        client.execute_query(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_bigtable_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.bigtable_v2.services.bigtable.transports.BigtableTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_bigtable_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.bigtable_v2.services.bigtable.transports.BigtableTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.BigtableTransport()
        adc.assert_called_once()
...
def test_bigtable_transport_auth_adc(transport_class):
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc:
        ...
        adc.assert_called_once_with(
            scopes=["1", "2"],
            default_scopes=(                'https://www.googleapis.com/auth/bigtable.data',                'https://www.googleapis.com/auth/bigtable.data.readonly',                'https://www.googleapis.com/auth/cloud-bigtable.data',                'https://www.googleapis.com/auth/cloud-bigtable.data.readonly',                'https://www.googleapis.com/auth/cloud-platform',                'https://www.googleapis.com/auth/cloud-platform.read-only',),
            quota_project_id="octopus",
        )
...
def test_authorized_view_path():
    ...
    actual = BigtableClient.authorized_view_path(project, instance, table, authorized_view)
