...
```
gh repo clone googleapis/python-bigtable
cd python-bigtable/samples/vertex-vector-search/workflows
```
...
<code>[sample-batch-input.json](https://github.com/googleapis/python-bigtable/samples/blob/main/vertex-vector-search/workflows/sample-batch-input.json)</code>
